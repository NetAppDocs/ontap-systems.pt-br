...
summary: Antes de desligar o nó com problemas e verificar o status das chaves de criptografia integradas, você deve verificar o status do nó com problemas, desativar a devolução automática e verificar qual versão do ONTAP o sistema está executando. O sistema AFF A700 suporta apenas procedimentos manuais de recuperação de mídia de inicialização. 
---
= Verifique o suporte à criptografia na sua mídia de inicialização no seu sistema AFF A700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Para garantir a segurança dos dados no seu sistema de armazenamento, você precisa verificar o suporte e o status da chave de criptografia na sua mídia de inicialização. O sistema AFF A700 suporta apenas procedimentos manuais de recuperação de mídia de inicialização. A recuperação automática de mídia de inicialização não é suportada.
