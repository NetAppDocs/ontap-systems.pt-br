...
summary: Restaure a criptografia na mídia de inicialização de substituição. O sistema AFF A700 suporta apenas procedimentos manuais de recuperação da mídia de inicialização. 
---
= Restaure a criptografia na mídia de inicialização do seu sistema AFF A700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
