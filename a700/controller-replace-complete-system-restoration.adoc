...
summary: Para restaurar o funcionamento completo do seu sistema AFF A700, reconecte os cabos de armazenamento, restaure a configuração de criptografia de armazenamento NetApp, se necessário, e instale as licenças para o novo controlador. 
---
= Conclua a substituição do controlador do seu sistema AFF A700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Conclua a substituição do controlador do seu sistema AFF A700 reconectando os cabos de armazenamento, restaurando a configuração de criptografia de armazenamento NetApp (se necessário) e instalando as licenças para o novo controlador.
