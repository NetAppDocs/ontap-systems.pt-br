...
---
= Reconecte os cabos do sistema e reatribua os discos no seu AFF A700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Conclua a substituição do controlador do seu sistema AFF A700 reconectando o armazenamento, restaurando NetApp Storage Encryption (se necessário) e instalando as licenças para o novo controlador.
...
O procedimento usado depende da configuração de redundância do seu controlador.

[role="tabbed-block"]
====
.Opção 1: par HA
--
=== Verifique a alteração do ID do sistema em um sistema HA
...
--
.Opção 2: MetroCluster de dois nós
--
=== Reatribuir manualmente o ID do sistema em sistemas em uma configuração MetroCluster de dois nós
