...
summary: Para encerrar o nó prejudicado, é necessário determinar o status do nó e, se necessário, assumir o nó para que o nó íntegro continue fornecendo dados do storage de nós prejudicado. 
---
= Desligue o controlador defeituoso do seu sistema AFF A700 antes de substituí-lo
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Desligue o controlador com defeito no seu sistema AFF A700 antes de substituí-lo, utilizando o procedimento adequado para sua configuração.
