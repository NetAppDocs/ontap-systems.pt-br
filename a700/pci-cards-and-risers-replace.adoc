...
---
= Substitua um módulo de E/S em seu sistema AFF A700 ou FAS9000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua um módulo de E/S em seu sistema AFF A700 ou FAS9000 desconectando os cabos, removendo a placa riser, substituindo o módulo e reconectando os cabos.
