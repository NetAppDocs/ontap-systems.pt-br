...
---
= Substitua o módulo USB LED no seu sistema AFF A700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua o módulo LED USB no seu AFF A700 para restaurar o LED indicador de status e a funcionalidade USB.
