...
---
= Substitua o chassi no seu sistema AFF A700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua o chassi do seu sistema AFF A700 transferindo as fontes de alimentação, ventoinhas e módulos controladores do chassi com problema para o chassi de substituição.
