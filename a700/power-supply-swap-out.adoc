...
---
= Substitua a fonte de alimentação com o sistema AFF A700 em funcionamento.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Troque a quente a fonte de alimentação no seu sistema AFF A700 para manter o fornecimento contínuo de energia ao sistema.
