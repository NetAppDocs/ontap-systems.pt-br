...
---
= Substitua o módulo DCPM no seu sistema AFF A700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua o módulo DCPM no seu sistema AFF A700 para restaurar o gerenciamento de energia adequado para a NVRAM10.
