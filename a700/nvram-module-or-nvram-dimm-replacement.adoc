...
summary: 'O módulo NVRAM consiste no NVRAM10 e DIMMs e até dois módulos de cache flash SSD NVMe (módulos de cache ou cache) por módulo NVRAM.' 
---
= Substitua o módulo NVRAM ou os DIMMs NVRAM no seu sistema AFF A700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua o módulo NVRAM ou os DIMMs NVRAM no seu AFF A700 para restaurar a funcionalidade adequada do NVRAM e o desempenho do sistema.
