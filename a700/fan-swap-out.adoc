...
---
= Troque a ventoinha do seu sistema AFF A700 com o sistema em funcionamento.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua a ventoinha do seu AFF A700 sem interromper o funcionamento, mantendo o fluxo de ar e o resfriamento adequados do sistema.
