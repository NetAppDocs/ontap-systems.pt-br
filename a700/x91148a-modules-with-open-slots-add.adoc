...
---
= Adicione um módulo X91148A ao seu sistema AFF A700 usando um slot disponível
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Adicione um módulo X91148A ao seu sistema AFF A700 usando um slot disponível no chassi.
