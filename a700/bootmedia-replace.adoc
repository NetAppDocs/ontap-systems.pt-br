...
summary: Substitua a mídia de inicialização com defeito em um módulo controlador AFF A700 . O sistema AFF A700 suporta apenas procedimentos manuais de recuperação de mídia de inicialização. A recuperação automática de mídia de inicialização não é suportada. 
---
= Substitua a mídia de inicialização no seu sistema AFF A700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
