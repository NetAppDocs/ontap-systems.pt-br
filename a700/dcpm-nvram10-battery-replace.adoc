...
summary: Para substituir com o equipamento em funcionamento o módulo de alimentação do controlador de desestágio, que contém a bateria NVRAM10, localize o módulo DCPM com defeito, remova-o do chassi e instale o módulo DCPM de substituição. 
---
= Substitua a quente um módulo de alimentação do controlador de de-stage (DCPM) no seu sistema AFF A700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Faça a troca a quente de um módulo de alimentação do controlador de desestágio (DCPM) em seu sistema AFF A700 para substituir o módulo com defeito sem interromper o serviço.
