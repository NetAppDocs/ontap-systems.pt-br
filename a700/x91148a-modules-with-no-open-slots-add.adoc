...
---
= Adicione um módulo de armazenamento X91148A ao seu sistema AFF A700 quando todos os slots estiverem ocupados
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Adicione um módulo de armazenamento X91148A ao seu sistema AFF A700 quando todos os slots estiverem ocupados, substituindo um módulo existente.
