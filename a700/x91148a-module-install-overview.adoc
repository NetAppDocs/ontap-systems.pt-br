...
---
= Saiba como adicionar um módulo X91148A ao seu sistema AFF A700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Saiba como adicionar um módulo X91148A ao seu AFF A700, seja substituindo uma placa de rede ou um adaptador de armazenamento, ou adicionando o módulo a um slot vazio do chassi.
