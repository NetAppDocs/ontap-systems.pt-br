...
---
= Instale seu sistema de storage AFF A700 usando passos rápidos
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Instale seu sistema de storage AFF A700 usando instruções gráficas rápidas, desde a montagem em rack e cabeamento até a inicialização do sistema.
