...
---
= Desligue o controlador do seu sistema de storage AFF C400 durante o processo de recuperação de inicialização manual
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Desligue o controlador com defeito no seu sistema de storage AFF C400 após concluir as verificações de criptografia e antes de substituir a mídia de inicialização.
