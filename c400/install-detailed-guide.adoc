...
---
= Instale e configure seu sistema de storage AFF C400 usando o guia detalhado
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Instale e configure seu sistema de storage AFF C400 utilizando o guia detalhado, que fornece instruções passo a passo, desde a montagem em racks e cabeamento até a inicialização do sistema.
