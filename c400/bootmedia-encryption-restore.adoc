...
summary: Restaure a encriptação no suporte de arranque de substituição. 
---
= Restaure a criptografia na mídia de inicialização do seu sistema de storage AFF C400 após o processo de recuperação manual de inicialização
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Restaure a criptografia na mídia de inicialização de substituição do seu sistema de storage AFF C400 para garantir o acesso seguro aos dados e o funcionamento adequado do sistema.
