...
---
= Reative os agregados em uma configuração de dois nós MetroCluster no seu sistema de storage AFF C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Após concluir a substituição da mídia de inicialização no seu sistema de storage AFF C400 em uma configuração MetroCluster de dois nós, execute a operação de reversão MetroCluster para restaurar a configuração ao seu estado operacional normal.
