...
---
= Conclua a substituição do chassi do seu sistema de storage AFF C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Conclua a substituição do chassi do seu sistema de storage AFF C400 verificando o estado de HA do chassi e devolvendo o componente com defeito para a NetApp.
