...
summary: 'A substituição de uma fonte de alimentação envolve desconetar a fonte de alimentação de destino (PSU) da fonte de alimentação, desconetar o cabo de alimentação, remover a fonte de alimentação antiga e instalar a fonte de alimentação de substituição e conectá-la novamente à fonte de alimentação.' 
---
= Substitua a fonte de alimentação com hot-swap no seu sistema de storage AFF C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua a quente a fonte de alimentação no seu sistema de storage AFF C400 para manter o fornecimento contínuo de energia sem interromper o serviço.
