...
---
= Saiba mais sobre como substituir o chassi do seu sistema de storage AFF C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Saiba mais sobre a substituição do chassi no seu sistema de storage AFF C400. O procedimento de substituição do chassi move todos os componentes do chassi com problema para o chassi de substituição e é um processo que causa interrupções.
