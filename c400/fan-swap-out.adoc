...
---
= Substitua o módulo de ventoinha a quente no seu sistema de storage AFF C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua o módulo de ventoinha no seu sistema de storage AFF C400 sem interromper o funcionamento para manter o fluxo de ar e o resfriamento adequados do sistema.
