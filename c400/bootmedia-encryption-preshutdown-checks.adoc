...
---
= Verifique o suporte à criptografia na sua mídia de inicialização no seu sistema de storage AFF C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Verifique o suporte à criptografia na sua mídia de inicialização no seu sistema de storage AFF C400 antes de desligar o controlador com falha. Isso inclui verificar a compatibilidade da versão do ONTAP com NetApp Volume Encryption (NVE) e confirmar a configuração do gerenciador de chaves.
