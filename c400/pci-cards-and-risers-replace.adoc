...
---
= Substitua uma placa PCIe ou mezzanine em seu sistema de storage AFF C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua uma placa PCIe ou mezzanine em seu sistema de storage AFF C400 desconectando os cabos e os módulos SFP/QSFP das placas, substituindo a placa com defeito e reconectando os cabos.
...
NOTE: Aperte completamente os parafusos de fixação da placa mezzanine. Se estiverem soltos, as portas e0e a e0h podem não ser detectadas, o LED pode piscar continuamente e os registros podem mostrar um erro de "cabo não suportado".
