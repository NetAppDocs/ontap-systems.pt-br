...
---
= Substitua a bateria NVDIMM no seu sistema de storage AFF C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua a bateria NVDIMM no seu sistema de storage AFF C400 removendo o módulo controlador, substituindo a bateria e reinstalando o módulo controlador.
