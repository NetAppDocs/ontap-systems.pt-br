...
---
= Substitua o hardware do chassi no seu sistema de storage AFF C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua o hardware do chassi no seu sistema de storage AFF C400 movendo as ventoinhas, as unidades de disco e os módulos controladores do chassi com problema para o chassi de substituição.
