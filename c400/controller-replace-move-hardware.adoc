...
summary: Substitua o controlador no seu sistema AFF C400 quando uma falha de hardware assim o exigir. Remova o controlador com defeito, transfira seus componentes para o controlador de substituição, instale o novo controlador e reinicialize-o. 
---
= Substitua o controlador do seu sistema de storage AFF C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua o controlador no seu sistema AFF C400 quando uma falha de hardware assim o exigir. Remova o controlador com defeito, transfira seus componentes para o controlador de substituição, instale o novo controlador e reinicialize-o.
...
.O que se segue?
Após substituir o controlador AFF C400 defeituoso, você precisa link:controller-replace-system-config-restore-and-verify.html["restaure a configuração do sistema"].
