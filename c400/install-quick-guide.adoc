...
---
= Instale e configure seu sistema de storage AFF C400 usando o guia rápido
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Instale e configure seu sistema de storage AFF C400 usando o guia rápido, que fornece instruções gráficas desde a montagem em racks e cabeamento até a inicialização do sistema.
