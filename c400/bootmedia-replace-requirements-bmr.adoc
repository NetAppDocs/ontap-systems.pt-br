...
summary: Antes de substituir a mídia de inicialização no seu sistema AFF C400, certifique-se de atender aos requisitos necessários para uma substituição bem-sucedida. 
---
= Analise os requisitos para recuperação automática de mídia de inicialização no seu sistema de storage AFF C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
