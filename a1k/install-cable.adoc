...
---
= Conecte seu hardware AFF A1K por cabos para conectividade de rede e storage
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: Não utilize as portas e1b e e7b para conexões de rede do host. Use um cartão host separado.
