...
[role="lead"]
Talvez seja necessário executar procedimentos de manutenção no hardware. Os procedimentos específicos para a manutenção dos componentes do sistema AFF A1K estão nesta seção.

Os procedimentos nesta seção pressupõem que o sistema AFF A1K já foi implantado como um nó de storage no ambiente ONTAP.
