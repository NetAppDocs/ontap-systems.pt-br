...
---
= Conclua a substituição do chassi do seu sistema AFF A1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Reinicialize o controlador, verifique a integridade do sistema e devolva a unidade com falha para NetApp para concluir a etapa final da substituição do chassi do seu sistema AFF A1K.
...
Após reinicializar os controladores, inicialize o ONTAP, devolva os controladores e verifique a integridade do sistema.
