...
summary: Substitua o controlador do seu sistema AFF A1K quando uma falha de hardware exigir isso. O processo de substituição envolve remover o controlador danificado, mover os componentes para o controlador de substituição, instalar o controlador de substituição e reiniciá-lo. 
---
= Substitua o controlador no seu sistema AFF A1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua o controlador no seu sistema AFF A1K quando uma falha de hardware assim o exigir. O processo de substituição envolve remover o controlador com problema, transferir os componentes para o controlador de substituição, instalar o controlador de substituição e reiniciá-lo.
