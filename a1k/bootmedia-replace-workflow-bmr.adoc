...
---
= Fluxo de trabalho de substituição da mídia de inicialização AFF A1K usando o processo automatizado de recuperação de inicialização
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
