...
summary: 'Substitua uma fonte de alimentação CA ou CC (PSU) em seu sistema AFF A1K quando ele falhar ou se tornar defeituoso, garantindo que seu sistema continue recebendo a energia necessária para uma operação estável. O processo de substituição envolve desconetar a PSU de destino da fonte de alimentação, desconetar o cabo de alimentação, remover a PSU defeituosa e instalar a PSU de substituição e, em seguida, conectá-la novamente à fonte de alimentação.' 
---
...
[role="lead"]
Substitua uma fonte de alimentação CA ou CC (PSU) em seu sistema AFF A1K quando ele falhar ou se tornar defeituoso, garantindo que seu sistema continue recebendo a energia necessária para uma operação estável. O processo de substituição envolve desconetar a PSU de destino da fonte de alimentação, desconetar o cabo de alimentação, remover a PSU defeituosa e instalar a PSU de substituição e, em seguida, conectá-la novamente à fonte de alimentação.
