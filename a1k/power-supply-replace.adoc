...
summary: Substitua a unidade de fonte de alimentação CA ou CC do seu AFF A1K quando ela falhar ou apresentar defeito, garantindo que seu sistema continue recebendo a energia necessária para uma operação estável. O processo de substituição envolve desconectar a fonte de alimentação defeituosa da fonte de energia, desconectar o cabo de alimentação, substituir a fonte de alimentação defeituosa e, em seguida, reconectá-la à fonte de energia. 
---
= Substitua a fonte de alimentação com substituição a quente no seu sistema AFF A1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
