...
.O que se segue?
Depois de analisar os requisitos para substituir o controlador AFF A1K, é necessário link:controller-replace-shutdown.html["desligue o controlador desativado"].
