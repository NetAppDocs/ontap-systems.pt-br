...
summary: Desligue o controlador desativado no sistema de armazenamento AFF A1K para evitar a perda de dados e garantir a estabilidade do sistema ao substituir a Mídia de inicialização. 
---
= Desligue o controlador do seu sistema AFF A1K durante o processo de recuperação automática de inicialização
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
