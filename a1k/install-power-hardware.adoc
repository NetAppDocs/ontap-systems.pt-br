...
---
= Ligue o seu sistema de storage AFF A1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.O que se segue?
Depois de ligar seu sistema de armazenamento AFF A1K , você https://docs.netapp.com/us-en/ontap/software_setup/workflow-summary.html["configure seu cluster"] .
