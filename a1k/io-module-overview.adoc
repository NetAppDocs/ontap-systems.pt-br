...
---
= Saiba mais sobre como adicionar e substituir módulos de E/S no seu sistema AFF A1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Os slots de e/S no controlador AFF A1K estão numerados de 1 a 11, como mostrado na ilustração a seguir.
