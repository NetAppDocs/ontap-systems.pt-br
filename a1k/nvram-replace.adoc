...
summary: Substitua o NVRAM no seu sistema AFF A1K quando a memória não volátil ficar com defeito ou necessitar de uma atualização. 
---
= Substitua a NVRAM no seu sistema AFF A1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua o NVRAM no seu sistema AFF A1K quando a memória não volátil ficar com defeito ou necessitar de uma atualização. O processo de substituição envolve desligar o controlador prejudicado, substituir o módulo NVRAM ou o DIMM NVRAM, reatribuir os discos e devolver a peça com falha ao NetApp.
...
Depois de substituir a FRU, você deve reinicializar o módulo controlador conectando os cabos de alimentação novamente à PSU.
