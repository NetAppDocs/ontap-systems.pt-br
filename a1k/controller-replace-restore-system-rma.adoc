...
summary: Para concluir a substituição do controlador do seu AFF A1K, restaure a configuração de criptografia de storage NetApp, confirme se as interfaces lógicas estão reportando às suas portas iniciais, execute uma verificação de integridade do cluster e devolva a peça com defeito para a NetApp. 
---
= Conclua a substituição do controlador do seu sistema AFF A1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
