...
summary: Conclua a configuração e a configuração usando a descoberta de cluster apenas com uma conexão com o switch e o laptop, ou conetando-se diretamente a um controlador no sistema de armazenamento e, em seguida, conetando-se ao switch de gerenciamento. 
---
= Configuração e configuração completas do sistema de armazenamento - AFF A1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Depois de ativar o sistema de armazenamento AFF A1K, você estará pronto para descobrir a rede de cluster e configurar um cluster ONTAP.
