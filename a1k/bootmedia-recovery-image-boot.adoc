...
---
= Inicie a imagem de recuperação - AFF A1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Depois de instalar o novo dispositivo multimédia de arranque no seu sistema AFF A1K, pode iniciar a imagem de recuperação a partir de uma unidade USB e restaurar a configuração a partir do nó do parceiro.
