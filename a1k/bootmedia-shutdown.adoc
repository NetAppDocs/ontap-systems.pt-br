...
[role="lead"]
Desligue o controlador desativado no sistema de armazenamento AFF A1K para evitar a perda de dados e garantir a estabilidade do sistema ao substituir a Mídia de inicialização.
