...
summary: Substitua uma fonte de alimentação no seu sistema AFF A700s desconectando a fonte de alimentação desejada da fonte de energia, retirando o cabo de força, removendo a fonte antiga, instalando a fonte de alimentação de reposição e, em seguida, reconectando-a à fonte de energia. 
---
= Substitua a fonte de alimentação com o sistema AFF A700s em funcionamento.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua a fonte de alimentação do seu sistema AFF A700s com o sistema em funcionamento, desconectando, removendo e substituindo a unidade com falha e, em seguida, reconectando-a à fonte de alimentação.
