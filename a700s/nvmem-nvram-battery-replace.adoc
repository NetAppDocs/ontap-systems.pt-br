...
---
= Substitua a bateria NVRAM no seu sistema AFF A700s
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua a bateria NVRAM do seu sistema AFF A700s removendo o módulo controlador, substituindo a bateria e reinstalando o módulo controlador.
