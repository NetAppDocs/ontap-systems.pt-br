...
summary: Para restaurar o funcionamento completo do seu sistema AFF A700s, restaure a configuração de criptografia de armazenamento NetApp, se necessário, instale as licenças para o novo controlador e devolva a peça com defeito para a NetApp. 
---
= Conclua a substituição do controlador do seu sistema AFF A700s
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Conclua a substituição do controlador do seu sistema AFF A700s restaurando a configuração de criptografia de armazenamento NetApp (se necessário), instalando as licenças para o novo controlador e devolvendo a peça com falha para a NetApp.
