...
---
= Desligue o controlador defeituoso do seu sistema AFF A700s antes de substituí-lo
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Desligue o controlador com defeito no seu sistema AFF A700s antes da substituição, assumindo o controle e interrompendo-o até o prompt LOADER.
