...
---
= Substitua o módulo NVRAM e os DIMMs NVRAM no seu sistema AFF A700s
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua o módulo NVRAM e os DIMMs NVRAM no seu sistema AFF A700s removendo o riser NVRAM, substituindo a unidade com falha e reinstalando o riser.
