...
---
= Restaure e verifique a configuração do controlador no seu sistema AFF A700s
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Restaure e verifique a configuração do controlador no seu sistema AFF A700s após concluir a substituição do hardware e inicializar no modo de manutenção.
