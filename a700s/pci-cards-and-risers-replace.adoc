...
---
= Substitua uma placa PCIe no seu sistema AFF A700s
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua uma placa PCIe no seu sistema AFF A700s desconectando os cabos, removendo a placa riser, substituindo a placa e reconectando os cabos.
