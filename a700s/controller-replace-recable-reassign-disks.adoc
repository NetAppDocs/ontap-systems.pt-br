...
---
= Reconecte os cabos do sistema e reatribua os discos no seu AFF A700s
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Conclua a substituição da controladora do seu sistema AFF A700s recabeando o storage, restaurando a configuração do NetApp Storage Encryption (se necessário) e instalando as licenças para a nova controladora.
