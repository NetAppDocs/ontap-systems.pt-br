...
---
= Substitua o chassi no seu sistema AFF A700s
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua o chassi do seu sistema AFF A700s transferindo as fontes de alimentação, os discos rígidos e os módulos controladores do chassi com problema para o chassi de substituição.
...
Depois de instalar o módulo do controlador no novo chassis, inicie-o.
