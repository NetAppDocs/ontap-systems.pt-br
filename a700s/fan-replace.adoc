...
---
= Substitua uma ventoinha no seu sistema AFF A700s
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua a ventoinha do seu sistema AFF A700s removendo o módulo de ventoinha com falha e instalando o de reposição.
