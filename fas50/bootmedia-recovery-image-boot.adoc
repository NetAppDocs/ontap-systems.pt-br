...
summary: Depois de instalar o novo dispositivo multimédia de arranque no seu sistema FAS50, pode iniciar a imagem de recuperação a partir de uma unidade USB e restaurar a configuração a partir do nó do parceiro. 
---
= Inicie a imagem de recuperação - FAS50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Depois de instalar o novo dispositivo multimédia de arranque no seu sistema FAS50, pode iniciar a imagem de recuperação a partir de uma unidade USB e restaurar a configuração a partir do nó do parceiro.
