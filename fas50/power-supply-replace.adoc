...
summary: Substitua a fonte de alimentação CA ou CC do seu sistema de storage FAS50 quando ela falhar ou apresentar defeito, garantindo que o sistema continue recebendo a energia necessária para uma operação estável. O processo de substituição envolve desconectar a fonte de alimentação com defeito da fonte de energia, desconectar o cabo de força, substituir a fonte de alimentação com defeito e, em seguida, reconectá-la à fonte de energia. 
---
