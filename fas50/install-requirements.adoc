...
Uma estante DS460C pode pesar até 260,4 lbs (118,1 kg). Para levantar a estante, você pode precisar de até cinco pessoas ou de um elevador hidráulico. Mantenha todos os componentes na estante (tanto na parte frontal quanto na traseira) para evitar o desbalanceamento do peso da estante.
