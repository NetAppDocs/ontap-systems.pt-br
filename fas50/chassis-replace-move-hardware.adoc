...
summary: Substitua o chassi do sistema de storage FAS50 quando uma falha de hardware exigir isso. O processo de substituição envolve a remoção dos controladores, remoção de quaisquer módulos de cache e espaços em branco da unidade, instalação do chassi de substituição e reinstalação dos componentes do chassi. 
---
