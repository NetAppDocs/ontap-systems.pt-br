...
[role="lead"]
Adicione um módulo de e/S ao seu sistema FAS50 para melhorar a conetividade de rede e expandir a capacidade do seu sistema de lidar com o tráfego de dados.

Você pode adicionar um módulo de e/S aos seus sistemas de armazenamento FAS50 quando houver slots disponíveis ou quando todos os slots estiverem totalmente preenchidos.
