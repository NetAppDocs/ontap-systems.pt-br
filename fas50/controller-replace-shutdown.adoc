...
summary: Desligue o controlador desativado no seu sistema de armazenamento FAS50 para evitar a perda de dados e garantir a estabilidade do sistema ao substituir o controlador. 
---
= Desligue o controlador desativado - FAS50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Desligue o controlador desativado no seu sistema de armazenamento FAS50 para evitar a perda de dados e garantir a estabilidade do sistema ao substituir o controlador.
