...
summary: Substitua o controlador no seu sistema de armazenamento FAS50 quando uma falha de hardware exigir isso.  O processo de substituição envolve remover o controlador danificado, mover os componentes para o controlador de substituição, instalar o controlador de substituição e reiniciá-lo. 
---
...
[role="lead"]
Substitua o controlador no seu sistema de armazenamento FAS50 quando uma falha de hardware exigir isso.  O processo de substituição envolve remover o controlador danificado, mover os componentes para o controlador de substituição, instalar o controlador de substituição e reiniciá-lo.
