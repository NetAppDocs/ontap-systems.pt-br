...
summary: Depois de ativar o sistema de armazenamento FAS50, você estará pronto para descobrir a rede de cluster e configurar um cluster ONTAP. 
---
= Configuração e configuração completas do sistema de armazenamento - FAS50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Depois de ativar o sistema de armazenamento FAS50, você estará pronto para descobrir a rede de cluster e configurar um cluster ONTAP.
