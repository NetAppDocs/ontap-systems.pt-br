...
summary: Você pode realizar a substituição a quente de um módulo de E/S Ethernet em seu sistema de storage FAS50 caso um módulo apresente falha e seu sistema de storage atenda a todos os requisitos de versão do ONTAP. 
---
= Substituição a quente de um módulo de E/S - FAS50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Você pode realizar a substituição a quente de um módulo de E/S Ethernet em seu sistema de storage FAS50 caso um módulo apresente falha e seu sistema de storage atenda a todos os requisitos de versão do ONTAP.
