...
sidebar: sidebar 
summary: Especificações principais para o grupo de plataforma FAS50 
---
...
[role="lead"]
A seguir estão especificações selecionadas para o sistema de armazenamento FAS50 em um único par de alta disponibilidade.  Visite o NetApp Hardware Universe (HWU) para obter as especificações completas deste sistema de armazenamento.
...
* Tipo: NAS; Pares HA: 4; Capacidade bruta: 42,2 PB / 37,5 PiB; Memória máxima: 512 GB
* Tipo: SAN; Pares HA: 4; Capacidade bruta: 42,2 PB / 37,5 PiB; Memória máxima: 512 GB
* Tipo: Par HA; Capacidade bruta: 10,6 PB / 9,4 PiB; Memória máxima: 128.0000
