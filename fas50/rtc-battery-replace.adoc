...
summary: Substitua a bateria do relógio de tempo real, geralmente conhecida como bateria tipo moeda, em seu sistema de storage FAS50 para garantir que os serviços e aplicativos que dependem da sincronização precisa de tempo permaneçam operacionais. 
---
...
[role="lead"]
Substitua a bateria do relógio em tempo real (RTC), comumente conhecida como bateria de célula tipo moeda, no seu sistema de armazenamento FAS50 para garantir que os serviços e aplicativos que dependem da sincronização de tempo precisa permaneçam operacionais.
