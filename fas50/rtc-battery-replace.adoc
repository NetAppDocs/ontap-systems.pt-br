...
summary: 'Substitua a bateria do relógio em tempo real (RTC), comumente conhecida como bateria de célula tipo moeda, no seu sistema de armazenamento FAS50 para garantir que os serviços e aplicativos que dependem da sincronização de tempo precisa permaneçam operacionais.' 
---
