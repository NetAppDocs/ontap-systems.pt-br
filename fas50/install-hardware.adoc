...
summary: Depois de se preparar para instalar o sistema de storage FAS50, instale o hardware do sistema de storage. Primeiro, instale os kits de trilho. Em seguida, instale e proteja seu sistema de armazenamento em um gabinete ou rack de telecomunicações. 
---
= Instale o material de fixação - FAS50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Depois de se preparar para instalar o sistema de storage FAS50, instale o hardware do sistema de storage. Primeiro, instale os kits de trilho. Em seguida, instale e proteja seu sistema de armazenamento em um gabinete ou rack de telecomunicações.
