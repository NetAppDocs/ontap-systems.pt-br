...
summary: Restaure a criptografia na mídia de inicialização de substituição do seu sistema de armazenamento FAS50 para garantir a proteção contínua dos dados. O processo de substituição envolve a verificação da disponibilidade da chave, a reaplicação das configurações de criptografia e a confirmação do acesso seguro aos seus dados. 
---
= Restaurar chaves de criptografia após recuperação de inicialização manual - FAS50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Restaure a criptografia na mídia de inicialização de substituição do seu sistema de armazenamento FAS50 para garantir a proteção contínua dos dados. O processo de substituição envolve a verificação da disponibilidade da chave, a reaplicação das configurações de criptografia e a confirmação do acesso seguro aos seus dados.
