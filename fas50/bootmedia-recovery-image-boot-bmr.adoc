...
summary: Depois de instalar o novo dispositivo de mídia de inicialização no seu sistema de armazenamento FAS50, você pode iniciar o processo automatizado de recuperação de mídia de inicialização para restaurar a configuração do nó parceiro. 
---
= Recuperação automatizada de mídia de inicialização do nó parceiro - FAS50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
