...
summary: 'Retorne o controle dos recursos de armazenamento ao controlador de substituição para que seu sistema FAS50 possa retomar a operação normal.  O procedimento de devolução varia de acordo com o tipo de criptografia usado pelo seu sistema: sem criptografia, criptografia Onboard Key Manager OKM ou criptografia External Key Manager EKM.' 
---
