...
summary: Desligue os controladores no seu sistema de armazenamento ASA C30 para evitar perda de dados e garantir a estabilidade do sistema ao substituir o chassi. 
---
= Desligue seus controladores ASA C30 para substituir o chassi
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Desligue os controladores no seu sistema de armazenamento ASA C30 para evitar perda de dados e garantir a estabilidade do sistema ao substituir o chassi.
