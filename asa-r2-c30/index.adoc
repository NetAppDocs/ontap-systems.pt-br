...
summary: Para os sistemas de armazenamento ASA C30, é possível executar procedimentos de manutenção nos seguintes componentes. 
---
= Mantenha o hardware do ASA C30
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Para os sistemas de armazenamento ASA C30, é possível executar procedimentos de manutenção nos seguintes componentes.
