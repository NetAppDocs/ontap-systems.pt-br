...
summary: 'Devolva o controle dos recursos de armazenamento ao controlador substituto para que seu sistema de armazenamento ASA C30 possa retomar a operação normal. O procedimento de devolução varia de acordo com o tipo de criptografia usado pelo seu sistema: sem criptografia, criptografia do Gerenciador de Chaves Integrado (OKM) ou criptografia do Gerenciador de Chaves Externo (EKM).' 
---
= Devolver o controlador - ASA C30
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
