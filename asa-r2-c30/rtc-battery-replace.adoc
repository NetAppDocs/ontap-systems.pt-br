...
summary: Substitua a bateria do relógio de tempo real, comumente conhecida como bateria tipo moeda, em seu sistema de storage ASA C30 para garantir que os serviços e aplicativos que dependem da sincronização precisa de tempo permaneçam operacionais. 
---
= Substitua a bateria do relógio em tempo real do seu ASA C30
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua a bateria do relógio em tempo real (RTC), comumente conhecida como bateria de célula tipo moeda, no seu sistema de armazenamento ASA C30 para garantir que os serviços e aplicativos que dependem da sincronização de tempo precisa permaneçam operacionais.
