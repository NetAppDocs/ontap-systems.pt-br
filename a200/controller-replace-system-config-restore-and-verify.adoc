...
---
= Restaure e verifique a configuração do controlador no seu sistema AFF A200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Restaure e verifique a configuração do controlador no seu sistema AFF A200 após concluir a substituição do hardware e inicializar no modo de manutenção.
