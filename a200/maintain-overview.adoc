...
summary: Mantenha o hardware AFF A200 
---
= Saiba mais sobre a manutenção do seu sistema de storage AFF A200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Para o sistema de armazenamento AFF A200, pode executar procedimentos de manutenção nos seguintes componentes.
