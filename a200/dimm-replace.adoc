...
---
= Substitua um módulo DIMM no seu sistema AFF A200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua um DIMM no seu AFF A200 quando o sistema de storage apresentar um número excessivo de erros ECC corrigíveis ou um erro ECC incorrigível, o que normalmente é causado pela falha de um único DIMM.
