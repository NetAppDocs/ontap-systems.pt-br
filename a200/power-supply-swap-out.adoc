...
---
= Substitua a fonte de alimentação com o sistema AFF A200 em funcionamento.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua a fonte de alimentação do seu AFF A200 em funcionamento desligando, desconectando e removendo a unidade com defeito e, em seguida, instalando e reconectando a unidade de substituição.
...
+
Se você tiver um sistema AFF A200, uma aba de plástico dentro do slot agora vazio é liberada para cobrir a abertura e manter o fluxo de ar e o resfriamento.
