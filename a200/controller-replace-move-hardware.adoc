...
---
= Substitua o controlador no seu sistema AFF A200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua o controlador do seu sistema AFF A200 removendo o controlador com problema, transferindo os componentes FRU para o módulo de controlador de substituição, instalando-o no chassi e inicializando no modo de manutenção.
...
IMPORTANT: Durante o processo de inicialização, você pode ver os seguintes prompts:
