...
---
= Substitua o chassi no seu sistema AFF A200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua o chassi do seu sistema AFF A200 transferindo as fontes de alimentação, os discos rígidos e os módulos controladores do chassi com problema para o chassi de substituição.
...
Mova a fonte de alimentação do chassi antigo para o chassi de substituição.
