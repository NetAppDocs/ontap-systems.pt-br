...
---
= Conclua a substituição do controlador do seu sistema AFF A200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Conclua a substituição do controlador do seu sistema AFF A200 restaurando a configuração de criptografia de armazenamento NetApp (se necessário), instalando as licenças para o novo controlador e devolvendo a peça com falha para a NetApp.
