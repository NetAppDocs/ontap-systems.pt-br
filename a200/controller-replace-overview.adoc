...
---
= Verifique os requisitos antes de substituir o controlador no seu sistema AFF A200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Antes de substituir o controlador no seu AFF A200, verifique os pré-requisitos para o procedimento de substituição e selecione o correto para a sua versão do ONTAP.
