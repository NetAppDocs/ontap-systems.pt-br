...
summary: Substitua o controlador no seu sistema de storage ASA A400 desligando o controlador com defeito, removendo e substituindo o controlador, restaurando a configuração do sistema e devolvendo o controle dos recursos de storage ao controlador de substituição. 
---
= Fluxo de trabalho de substituição do controlador - ASA A400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua o controlador no seu sistema de storage ASA A400 desligando o controlador com defeito, removendo e substituindo o controlador, restaurando a configuração do sistema e devolvendo o controle dos recursos de storage ao controlador de substituição.
