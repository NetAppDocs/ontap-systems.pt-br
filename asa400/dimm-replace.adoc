...
summary: 'Você deve substituir um módulo DIMM no controlador quando o sistema registrar um número crescente de códigos de correção de erros corrigíveis (ECC) para evitar o pânico do sistema.' 
---
= Substitua um módulo DIMM no seu sistema ASA A400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
