...
summary: Após verificar as variáveis de ambiente, você deve concluir as etapas específicas para sistemas que possuem Onboard Key Manager OKM, NetApp Storage Encryption NSE ou NetApp Volume Encryption NVE ativados. 
---
= Restaure a criptografia na mídia de inicialização do seu sistema ASA A400 após o processo de recuperação manual de inicialização
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
