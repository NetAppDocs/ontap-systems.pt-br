...
summary: Devolva o controle dos recursos de storage ao controlador de substituição para que seu sistema ASA A400 possa retomar a operação normal. 
---
= Devolva o controlador no seu sistema ASA A400 para retomar as operações normais
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Devolva o controle dos recursos de storage ao controlador de substituição para que seu sistema ASA A400 possa retomar a operação normal.
