...
summary: Estas etapas detalhadas orientam você na instalação do seu sistema ASA A400, incluindo a preparação para a instalação, a instalação do hardware, o cabeamento dos controladores e a conclusão da configuração. 
---
= Instale seu sistema de storage ASA A400 com instruções detalhadas
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Estas etapas detalhadas orientam você na instalação do seu sistema ASA A400, incluindo a preparação para a instalação, a instalação do hardware, o cabeamento dos controladores e a conclusão da configuração.
...
image:../media/oie_cable_fiber_lc_connector.png["Conetor de fibra LC"]
 a| 
Cabos FC de 16 Gb ou GbE de 25 Gb para placas mezzanine (dependendo do pedido)
