...
summary: 'Conclua a substituição do controlador do seu sistema ASA A400. Instale as licenças para o controlador de substituição, confirme se as interfaces lógicas (LIFs) estão reportando às suas portas de origem e execute uma verificação de integridade. Por fim, devolva a peça com defeito para NetApp.' 
---
= Conclua a substituição do controlador do seu sistema ASA A400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Conclua a substituição do controlador do seu sistema ASA A400. Instale as licenças para o controlador de substituição, confirme se as interfaces lógicas (LIFs) estão reportando às suas portas de origem e execute uma verificação de integridade. Por fim, devolva a peça com defeito para NetApp.
