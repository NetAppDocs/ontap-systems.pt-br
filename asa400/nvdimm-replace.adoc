...
summary: Você deve substituir o NVDIMM no módulo controlador quando o sistema registrar que a vida útil da flash está quase no fim ou que o NVDIMM identificado não está saudável em geral, para evitar pânico do sistema. 
---
= Substitua um NVDIMM no seu sistema ASA A400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
