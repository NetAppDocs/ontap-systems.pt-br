...
---
= Instale e configure seu sistema de storage AFF C250 usando o guia detalhado
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Passos
. Conecte as portas de interconexão de cluster e0c a e0c e e0d a e0d com os cabos de interconexão de cluster de 25 GbE.
+
...
--
.Opção 2: conecte o cabo a uma rede de dados ou de host de 25 GbE
--
