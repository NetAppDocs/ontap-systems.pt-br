...
---
= Recableie seu sistema de storage AFF C250 e reatribua os discos
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Após concluir a restauração e verificar a configuração do sistema AFF C250, você precisa reconectar o sistema e reatribuir os discos.
