...
summary: Para concluir a substituição do controlador do seu sistema AFF C250 e garantir o pleno funcionamento, você deve restaurar a configuração de NetApp Storage Encryption, instalar as licenças para o novo controlador e devolver a peça com defeito para a NetApp. 
---
= Conclua a substituição do controlador do seu sistema de storage AFF C250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Para concluir a substituição do controlador do seu sistema AFF C250 e garantir o pleno funcionamento, você deve restaurar a configuração de NetApp Storage Encryption (se necessário), instalar as licenças para o novo controlador e devolver a peça com defeito para a NetApp, conforme descrito nas instruções de RMA fornecidas com o kit.
