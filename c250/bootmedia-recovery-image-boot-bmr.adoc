...
summary: Após instalar o novo dispositivo de mídia de inicialização no seu AFF C250, você pode iniciar o processo automatizado de recuperação da mídia de inicialização para restaurar a configuração do nó parceiro. 
---
= Restaure a imagem de inicialização no seu sistema de storage AFF C250 usando o processo automatizado de recuperação de inicialização
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
