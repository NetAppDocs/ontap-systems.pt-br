...
---
= Substitua o chassi do seu sistema de storage AFF C250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua o chassi do seu sistema AFF C250 quando uma falha de hardware exigir. O processo de substituição envolve remover os controladores e as fontes de alimentação (PSUs), remover as unidades de disco, instalar o chassi de substituição e reinstalar os componentes do chassi.
...
.O que se segue?
Após substituir o chassi AFF C250 e reinstalar os componentes, você precisa link:chassis-replace-complete-system-restore-rma.html["complete a substituição do chassis"]
