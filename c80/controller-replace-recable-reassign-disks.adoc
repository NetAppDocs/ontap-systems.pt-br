...
. Recupere e verifique a senha global do cluster a partir do controlador íntegro.
+
.. Execute o seguinte comando para recuperar a senha de todo o cluster:
+
`security key-manager onboard show-backup`

.. Verifique a senha de todo o cluster usando o seguinte comando:
+
