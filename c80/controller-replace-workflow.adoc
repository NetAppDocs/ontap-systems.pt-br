...
summary: Comece com a substituição do controlador no sistema de armazenamento AFF C80, desligando o controlador desativado, removendo e substituindo o controlador, restaurando a configuração do sistema e retornando o controle dos recursos de armazenamento ao controlador de substituição. 
---
= Fluxo de trabalho de substituição do controlador - AFF C80
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Comece com a substituição do controlador no sistema de armazenamento AFF C80, desligando o controlador desativado, removendo e substituindo o controlador, restaurando a configuração do sistema e retornando o controle dos recursos de armazenamento ao controlador de substituição.
