...
.Antes de começar
* Certifique-se de que tem a peça de substituição disponível. Tem de substituir o componente com falha por um componente de substituição que recebeu do fornecedor.
...
== Etapa 3: Substitua os DIMMs do NVRAM
