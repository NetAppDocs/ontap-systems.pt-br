...
---
= Prepare-se para instalar seu sistema de storage AFF C80
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.O que se segue?
Depois de se preparar para instalar seu hardware AFF C80, você link:install-hardware.html["Instale o hardware do seu sistema de storage AFF C80"].
