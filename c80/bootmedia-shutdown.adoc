...
summary: Desligue o controlador desativado no sistema de armazenamento AFF C80 para evitar a perda de dados e garantir a estabilidade do sistema ao substituir a Mídia de inicialização. 
---
...
[role="lead"]
Desligue o controlador desativado no sistema de armazenamento AFF C80 para evitar a perda de dados e garantir a estabilidade do sistema ao substituir a Mídia de inicialização.
