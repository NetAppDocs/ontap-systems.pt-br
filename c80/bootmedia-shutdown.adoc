...
summary: Desligue o controlador danificado no seu sistema de armazenamento AFF C80 para evitar perda de dados e manter a estabilidade do sistema durante o processo de recuperação de mídia de inicialização manual. 
---
= Desligue o controlador do seu AFF C80 sistema de storage durante o processo de recuperação de inicialização manual
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
