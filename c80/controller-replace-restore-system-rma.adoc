...
summary: Verifique se as interfaces lógicas estão relatando para sua porta inicial, execute uma verificação de integridade do cluster e devolva a peça com falha ao NetApp para concluir a etapa final no fluxo de trabalho de substituição do controlador AFF C80. 
---
...
[role="lead"]
Verifique se as interfaces lógicas estão relatando para sua porta inicial, execute uma verificação de integridade do cluster e devolva a peça com falha ao NetApp para concluir a etapa final no fluxo de trabalho de substituição do controlador AFF C80.
