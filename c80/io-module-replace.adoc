...
[role="lead"]
Substitua um módulo de e/S no seu sistema AFF C80 quando o módulo falhar ou precisar de uma atualização para suportar desempenho superior ou recursos adicionais.
