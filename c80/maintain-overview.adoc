...
---
= Manter os sistemas de storage AFF C80
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Os procedimentos de manutenção presumem que os sistemas AFF C80 já foram implantados como um nó de storage no ambiente ONTAP.
