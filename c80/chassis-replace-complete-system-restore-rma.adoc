...
summary: Reinicie os controladores, verifique a integridade do sistema e devolva a peça com falha ao NetApp para concluir a etapa final do fluxo de trabalho de substituição do chassi do AFF C80. 
---
...
[role="lead"]
Reinicie os controladores, verifique a integridade do sistema e devolva a peça com falha ao NetApp para concluir a etapa final do fluxo de trabalho de substituição do chassi do AFF C80.
