...
summary: Se a Mídia de inicialização do sistema AFF C80 estiver corrompida, você poderá inicializar a imagem de recuperação de uma unidade USB, restaurar a configuração do nó do parceiro e verificar as variáveis de ambiente 
---
= Inicie a imagem de recuperação - AFF C80
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Se a Mídia de inicialização do sistema AFF C80 estiver corrompida, você poderá inicializar a imagem de recuperação de uma unidade USB, restaurar a configuração do nó do parceiro e verificar as variáveis de ambiente.
