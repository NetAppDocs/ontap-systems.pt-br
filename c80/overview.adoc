...
sidebar: sidebar 
summary: Especificações principais para o grupo de plataforma C80 
---
...
[role="lead"]
A seguir estão especificações selecionadas para o sistema de armazenamento AFF C80 em um único par de alta disponibilidade.  Visite o NetApp Hardware Universe (HWU) para obter as especificações completas deste sistema de armazenamento.
...
* Tipo: NAS; Pares HA: 12; Capacidade bruta: 176,8 PB / 157,0 PiB; Memória máxima: 6144 GB
* Tipo: SAN; Pares HA: 6; Capacidade bruta: 88,4 PB / 78,5 PiB; Memória máxima: 3072 GB
* Tipo: Par HA; Capacidade bruta: 14,7 PB / 13,1 PiB; Memória máxima: 512.0000
...
* SMB 3.0
* SMB 3.1
* SMB 3.1.1 == Especificações do ambiente do sistema Nenhum dado de ambiente disponível.
