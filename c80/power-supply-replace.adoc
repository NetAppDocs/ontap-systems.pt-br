...
summary: Substitua a fonte de alimentação CA ou CC do seu AFF C80 quando ela falhar ou apresentar defeito, garantindo que o sistema continue recebendo a energia necessária para uma operação estável. O processo de substituição envolve desconectar a fonte de alimentação defeituosa da fonte de energia, desconectar o cabo de alimentação, substituir a unidade defeituosa e, em seguida, reconectá-la à fonte de energia. 
---
= Substitua a fonte de alimentação com seu sistema de storage AFF C80
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
