...
summary: 'Substitua uma fonte de alimentação CA ou CC (PSU) no seu sistema AFF C80 quando falhar ou ficar com defeito, garantindo que o seu sistema continua a receber a energia necessária para uma operação estável.' 
---
