...
summary: Substitua o chassi do sistema AFF C80 quando uma falha ou atualização de hardware exigir isso. Esse processo envolve desligar o sistema, remover o chassi existente, instalar o novo e reconfigurar os componentes para garantir o funcionamento correto do sistema. 
---
...
[role="lead"]
Substitua o chassi do sistema AFF C80 quando uma falha ou atualização de hardware exigir isso. Esse processo envolve desligar o sistema, remover o chassi existente, instalar o novo e reconfigurar os componentes para garantir o funcionamento correto do sistema.
