...
summary: Para garantir a segurança dos dados no seu sistema de armazenamento AFF C80, você precisa verificar o suporte e o status da chave de criptografia na sua mídia de inicialização. Verifique se a sua versão do ONTAP é compatível com o NetApp Volume Encryption e, antes de desligar o controlador, verifique se o gerenciador de chaves está ativo. 
---
= Verifique o suporte à criptografia na sua mídia de inicialização no seu sistema de storage AFF C80
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
