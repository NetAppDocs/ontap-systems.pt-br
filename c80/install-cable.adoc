...
---
= Conecte seu hardware AFF C80 por cabos para conectividade de rede e storage
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Sobre esta tarefa
O sistema de storage AFF C80 suporta shelves NS224 com o módulo NSM100 ou NSM100B. As principais diferenças entre os módulos são:
