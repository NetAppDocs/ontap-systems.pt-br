...
summary: Antes de substituir a mídia de inicialização no seu sistema de armazenamento AFF C80, certifique-se de atender aos requisitos necessários para uma substituição bem-sucedida. 
---
= Analise os requisitos para recuperação automática de mídia de inicialização no seu AFF C80 sistema de storage
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
