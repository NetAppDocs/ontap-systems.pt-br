...
summary: Desligue o controlador do sistema de armazenamento AFF C80 para evitar a perda de dados e garantir a estabilidade do sistema ao substituir o chassis. 
---
= Desligue seu controlador AFF C80 para substituir o chassi
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Desligue o controlador do sistema de armazenamento AFF C80 para evitar a perda de dados e garantir a estabilidade do sistema ao substituir o chassis.
