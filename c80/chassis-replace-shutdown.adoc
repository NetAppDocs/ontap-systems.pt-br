...
summary: Desligue os controladores do sistema de storage AFF C80 quando precisar substituir o chassi. Antes de realizar a manutenção ou a substituição de componentes, é fundamental desligar o controlador de forma segura para evitar a perda de dados e garantir a estabilidade do sistema. 
---
...
[role="lead"]
Desligue os controladores do sistema de storage AFF C80 quando precisar substituir o chassi. Antes de realizar a manutenção ou a substituição de componentes, é fundamental desligar o controlador de forma segura para evitar a perda de dados e garantir a estabilidade do sistema.
