...
summary: Substitua um módulo de ventoinha com defeito ou danificado em seu sistema afx 2k para manter o resfriamento adequado e evitar problemas de desempenho do sistema. As ventoinhas são com substituição a quente e podem ser trocadas sem desligar o sistema. 
---
= Substituir uma ventoinha - AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
