...
summary: Substitua um módulo de ventoinha com defeito ou com falha no seu sistema AFX 2K para manter o resfriamento adequado e evitar problemas de desempenho do sistema. As ventoinhas são com substituição a quente e podem ser trocadas sem desligar o sistema. 
---
= Troque a ventoinha do seu sistema de storage AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua um módulo de ventoinha com defeito ou com falha no seu sistema AFX 2K para manter o resfriamento adequado e evitar problemas de desempenho do sistema. As ventoinhas são com substituição a quente e podem ser trocadas sem desligar o sistema. Este procedimento inclui identificar a ventoinha com defeito usando as mensagens de erro do console e os indicadores LED, remover o painel, trocar o módulo da ventoinha e devolver a peça com defeito para a NetApp.
