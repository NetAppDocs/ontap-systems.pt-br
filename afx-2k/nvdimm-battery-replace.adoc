...
summary: Substitua a bateria NV do seu sistema de storage AFX 2K quando ela começar a perder carga ou falhar, pois é responsável por preservar os dados críticos do sistema durante quedas de energia. O processo de substituição envolve desligar o controlador com defeito, remover o módulo do controlador, substituir a bateria NV, reinstalar o módulo do controlador e devolver a peça com defeito para NetApp. 
---
= Substitua a bateria NV no seu sistema de storage AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua a bateria NV do seu sistema de storage AFX 2K quando ela começar a perder carga ou falhar, pois é responsável por preservar os dados críticos do sistema durante quedas de energia. O processo de substituição envolve desligar o controlador com defeito, remover o módulo do controlador, substituir a bateria NV, reinstalar o módulo do controlador e devolver a peça com defeito para NetApp.

.Sobre esta tarefa
Este procedimento se aplica à substituição de uma bateria NV com falha para o módulo NVRAM nos slots 4 e 5 do controlador AFX 2K. Para obter informações sobre como substituir a bateria NV para o módulo NVRAM12-EX nos slots 6 e 7 do controlador AFX 2K, consulte link:nv12l-replace.html#step-2-replace-the-nvram12-ex-module-nvram-dimm-or-nvram-battery["Substitua a bateria NV para o NVRAM12-EX"].
