...
.Sobre esta tarefa
Este procedimento se aplica à substituição de uma bateria NV com falha para o módulo NVRAM nos slots 4 e 5 do controlador AFX 2K. Para obter informações sobre como substituir a bateria NV para o módulo NVRAM12-EX nos slots 6 e 7 do controlador AFX 2K, consulte link:../install-setup/nv12l-replace.html#step-2-replace-the-nvram12-ex-module-nvram-dimm-or-nvram-battery["Substitua a bateria NV para o NVRAM12-EX"].
