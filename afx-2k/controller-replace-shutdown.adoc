...
summary: Desligue o controlador do seu sistema de storage AFX 2K quando ele apresentar problemas. Antes de realizar manutenção ou substituição de componentes, é fundamental desligar o controlador com segurança para evitar perda de dados e garantir a estabilidade do sistema. 
---
= Desligue o controlador defeituoso do seu sistema de storage AFX 2K antes de substituí-lo.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Desligue o controlador com defeito no seu sistema de storage AFX 2K para evitar perda de dados e garantir a estabilidade do sistema ao substituir o controlador.
