...
summary: Reinicie o controlador, verifique a integridade do sistema e devolva a peça com defeito para NetApp para concluir a etapa final do procedimento de substituição do chassi AFX 2K. 
---
= Conclua a substituição do chassi do seu sistema de storage AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Reinicie o controlador, verifique a integridade do sistema e devolva a peça com defeito para NetApp para concluir a etapa final do procedimento de substituição do chassi AFX 2K.
