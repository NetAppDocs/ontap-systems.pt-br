...
summary: Substitua a bateria do relógio em tempo real do seu sistema de storage AFX 2K para garantir que os serviços e aplicativos que dependem da sincronização precisa do tempo permaneçam operacionais. 
---
= Substitua a bateria do relógio em tempo real do seu sistema de storage AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua a bateria do relógio de tempo real (RTC), comumente conhecida como bateria tipo moeda, em seu sistema de storage AFX 2K para garantir que os serviços e aplicativos que dependem da sincronização precisa de tempo permaneçam operacionais.
