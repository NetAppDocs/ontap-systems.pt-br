...
summary: Após instalar o novo dispositivo de mídia de inicialização no seu sistema de storage AFX 2K, você pode iniciar o processo automatizado de recuperação da mídia de inicialização para restaurar a configuração do nó parceiro. 
---
= Inicialize a imagem de recuperação no seu sistema de storage AFX 2K usando o processo de recuperação de inicialização automatizado
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Após instalar o novo dispositivo de mídia de inicialização no seu sistema de storage AFX 2K, você pode iniciar o processo automatizado de recuperação da mídia de inicialização para restaurar a configuração do nó parceiro.
