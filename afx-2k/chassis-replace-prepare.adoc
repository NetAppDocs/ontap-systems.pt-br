...
summary: Prepare-se para substituir o chassi com problema no seu sistema de storage AFX 2K, identificando o chassi com problema, verificando os componentes de substituição e etiquetando os cabos e módulos de controlador. 
---
= Prepare-se para substituir seu chassi AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Prepare-se para substituir o chassi com problema no seu sistema de storage AFX 2K, identificando o chassi com problema, verificando os componentes de substituição e etiquetando os cabos e o módulo controlador.
...
.O que se segue?
Depois de se preparar para substituir o hardware do chassi do seu AFX 2K, você precisa link:chassis-replace-shutdown.html["desligue o controlador"].
