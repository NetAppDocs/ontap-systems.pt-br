...
summary: Substitua a NVRAM do seu sistema de storage AFX 2K quando a memória não volátil apresentar defeito ou precisar de atualização. 
---
= Substitua a NVRAM no seu sistema de storage AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua a NVRAM do seu sistema de storage AFX 2K quando a memória não volátil apresentar defeito ou precisar de atualização. O processo de substituição envolve desligar o controlador com defeito, substituir o módulo NVRAM ou o DIMM NVRAM e devolver a peça com defeito para a NetApp.
...
+
image::../media/drw_afx_2k_nvram_remove_replace_ieops-2881.svg[Remova o módulo NVRAM12 e os DIMMs]
...
+
image::../media/drw_afx_2k_nvram_remove_replace_ieops-2881.svg[Remova o módulo NVRAM 12 e DIMMs]
...
NOTE: O ID do sistema de substituição só é necessário para a substituição do módulo NVRAM e não para a substituição do DIMM NVRAM.
...
+
.. A partir do controlador saudável, devolva o armazenamento do controlador substituído: `_storage failover giveback -ofnode impaired_node_name_`
+
