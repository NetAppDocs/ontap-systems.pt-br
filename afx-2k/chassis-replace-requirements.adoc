...
summary: Antes de substituir o chassi do seu sistema de storage afx 2k, certifique-se de que atende aos requisitos necessários para uma substituição bem-sucedida. Isso inclui verificar se todos os outros componentes do sistema estão funcionando corretamente, se você possui as credenciais de administrador local para ONTAP, o chassi de substituição correto e as ferramentas necessárias. 
---
= Requisitos para substituição do chassi - AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Antes de substituir o chassi do seu sistema de storage AFX 2K, certifique-se de que atende aos requisitos necessários para uma substituição bem-sucedida. Isso inclui verificar se todos os outros componentes do sistema estão funcionando corretamente, se você possui as credenciais de administrador local do ONTAP, o chassi de substituição correto e as ferramentas necessárias.
