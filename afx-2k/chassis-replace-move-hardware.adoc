...
summary: Substitua o chassi do seu sistema de storage AFX 2K quando uma falha de hardware exigir. O processo de substituição envolve remover o controlador da parte frontal do chassi, remover as fontes de alimentação, NVRAM12, módulos de I/O e tampas, e o módulo de gerenciamento do sistema, depois instalar o chassi de substituição e reinstalar os componentes do chassi. 
---
= Substitua o chassi do seu sistema de storage AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua o chassi do seu sistema de storage AFX 2K quando uma falha de hardware exigir. O processo de substituição envolve remover o controlador, as placas de E/S, o módulo NVRAM12, o módulo de gerenciamento do sistema e as fontes de alimentação (PSUs), instalar o chassi de substituição e reinstalar os componentes do chassi.
...
+
image::../media/drw_afx_2k_psu_remove_replace_ieops-2882.svg[Remover ou substituir a PSU]
...
== Etapa 2: Remova as placas de E/S, NVRAM12, NVRAM12-EX e o módulo de gerenciamento do sistema

. Retire o módulo de e/S alvo do chassis:
+
image:../media/drw_afx_2k_io_remove_replace_ieops-2878.svg["Remova o módulo de e/S."]
...
+
image::../media/drw_nvram1_remove_only_ieops-2574.svg[Remova o módulo NVRAM12]
...
. Remova o módulo NVRAM12-EX:
+
.. Segure a alça do módulo e pressione o botão da trava de bloqueio.
.. Retire o módulo NVRAM12-EX do chassi enquanto segura a parte inferior do módulo com a outra mão.
+
...
|===
 ...
 a| 
image:../media/icon_round_1.png["Legenda número 1"]
| Alça e botão de came NVRAM12-EX 
|===
...
+
image::../media/drw_afx_2k_sys_mgmt_remove_replace_ieops-2880.svg[Gerenciamento do Sistema remover]
...
.O que se segue?
Após substituir o chassi AFX 2K com defeito e reinstalar seus componentes, conclua o link:chassis-replace-complete-system-restore-rma.html["substituição do chassi"].
