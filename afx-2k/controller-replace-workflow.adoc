...
summary: Comece a substituir o controlador no seu sistema de storage afx 2k desligando o controlador com defeito, removendo e substituindo o controlador, reconfigurando as configurações do sistema e verificando as operações do sistema. 
---
= Fluxo de trabalho de substituição de controlador - AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Comece a substituir o controlador no seu sistema de storage AFX 2K desligando o controlador com defeito, removendo e substituindo o controlador, restaurando a configuração do sistema e verificando as operações do sistema.
