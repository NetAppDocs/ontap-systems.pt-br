...
summary: Substitua o módulo de gerenciamento do sistema em seu sistema de storage AFX 2K quando ele apresentar defeito ou seu firmware estiver corrompido. O processo de substituição envolve desligar o controlador, substituir o módulo de gerenciamento do sistema com defeito, reiniciar o controlador, atualizar as chaves de licença e devolver a peça com defeito para NetApp. 
---
= Substitua o módulo de gerenciamento do sistema no seu sistema de storage AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua o módulo de gerenciamento do sistema em seu sistema de storage AFX 2K quando ele apresentar defeito ou seu firmware estiver corrompido. O processo de substituição envolve desligar o controlador, substituir o módulo de gerenciamento do sistema com defeito, reiniciar o controlador, atualizar as chaves de licença e devolver a peça com defeito para NetApp.
