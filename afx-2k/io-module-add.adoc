...
summary: Adicione um módulo de E/S ao seu sistema de storage AFX 2K para melhorar a conectividade de rede e expandir a capacidade do seu sistema de lidar com o tráfego de dados. 
---
= Adicione um módulo de E/S ao seu sistema de storage AFX 2K para melhorar a conectividade de rede
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Adicione um módulo de E/S ao seu sistema de storage AFX 2K para melhorar a conectividade de rede e expandir a capacidade do seu sistema de lidar com o tráfego de dados.

Você pode adicionar um módulo de E/S ao seu sistema de storage AFX 2K quando houver slots vazios disponíveis ou quando todos os slots estiverem totalmente ocupados.
