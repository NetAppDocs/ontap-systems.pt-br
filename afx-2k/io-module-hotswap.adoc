...
summary: Você pode realizar a substituição a quente de um módulo de E/S Ethernet em seu sistema de storage afx 2k se um módulo falhar e seu sistema de storage atender a todos os requisitos de versão do ONTAP. 
---
= Substituição a quente de um módulo de E/S - AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
