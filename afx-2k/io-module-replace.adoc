...
summary: Substitua um módulo de E/S em seu sistema de storage AFX 2K quando o módulo falhar ou precisar de uma atualização para suportar maior desempenho ou recursos adicionais. O processo de substituição envolve desligar o controlador, substituir o módulo de E/S com defeito, reiniciar o controlador e devolver a peça com defeito para NetApp. 
---
= Substitua um módulo de E/S em seu sistema de storage AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua um módulo de E/S em seu sistema de storage AFX 2K quando o módulo falhar. O processo de substituição envolve desligar o controlador, substituir o módulo de E/S com defeito, reiniciar o controlador e devolver a peça com defeito para NetApp.
...
NOTE: A ilustração a seguir mostra a remoção de um módulo de E/S vertical. Normalmente, você removerá apenas um módulo de E/S.
