...
summary: Substitua o controlador do seu sistema de storage AFX 2K quando uma falha de hardware exigir. O processo de substituição envolve remover o controlador com problema, transferir os componentes para o controlador de substituição, instalar o controlador de substituição e reiniciá-lo. 
---
= Substitua o controlador no seu sistema de storage AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua o controlador do seu sistema de storage AFX 2K quando uma falha de hardware exigir. O processo de substituição envolve remover o controlador com problema, transferir os componentes para o controlador de substituição, instalar o controlador de substituição e reiniciá-lo.
...
.O que se segue?
Após substituir o controlador AFX 2K defeituoso, link:controller-replace-system-config-restore-and-verify.html["restaurar as configurações do sistema"].
