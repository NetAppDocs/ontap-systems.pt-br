...
* link:https://review.docs.netapp.com/us-en/ontap-systems-switches/cluster/index.html["Comutadores de cluster"^]
* link:https://review.docs.netapp.com/us-en/ontap-systems-switches/storage/index.html["Interruptores de armazenamento"^]
* link:https://docs.netapp.com/us-en/ontap-systems-switches/switch-cisco-9336c-fx2-shared/install-9336c-shared.html["Switches compartilhados"^]
...
[role="quick-margin-list"]
* link:aff-aseries/index.html["Sistemas AFF A-Series"]
* link:aff-cseries/index.html["Sistemas AFF C-Series"]
...
[role="quick-margin-list"]
* Para implantações ONTAP , consulte https://docs.netapp.com/us-en/ontap/task_configure_ontap.html["Configurar o ONTAP"^] .
* Para ONTAP com implantações MetroCluster , consulte https://docs.netapp.com/us-en/ontap-metrocluster/["Configure o MetroCluster com o ONTAP"^] .
