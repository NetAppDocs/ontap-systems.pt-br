...
summary: Especificações principais do AFF A50 
---
...
[role="lead"]
A seguir estão especificações selecionadas para o sistema de armazenamento AFF A50 em um único par de alta disponibilidade.  Visite o NetApp Hardware Universe (HWU) para obter as especificações completas deste sistema de armazenamento.



== Especificações do AFF A50 em resumo
...
* Tipo: NAS; Pares HA: 12; Capacidade bruta: 48,5 PB / 43,0 PiB; Memória máxima: 3072 GB
* Tipo: SAN; Pares HA: 6; Capacidade bruta: 24,2 PB / 21,5 PiB; Memória máxima: 1536 GB
* Tipo: Par HA; Capacidade bruta: 4,0 PB / 3,6 PiB; Memória máxima: 256.0000
