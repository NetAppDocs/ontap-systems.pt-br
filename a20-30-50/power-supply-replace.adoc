...
summary: Substitua uma unidade de fonte de alimentação CA ou CC no seu sistema de storage AFF A20, AFF A30 ou AFF A50 quando ela falhar ou apresentar defeito, garantindo que seu sistema continue recebendo a energia necessária para uma operação estável. O processo de substituição envolve desconectar a fonte de alimentação defeituosa da fonte de energia, desconectar o cabo de força, substituir a fonte de alimentação defeituosa e, em seguida, reconectá-la à fonte de energia. 
---
= Substitua a fonte de alimentação com substituição a quente no seu sistema AFF A20, AFF A30 ou AFF A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
