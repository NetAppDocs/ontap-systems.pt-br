...
.O que se segue?
Depois de substituir o controlador AFF A20, AFF A30 ou AFF A50 com problemas, é necessário link:controller-replace-system-config-restore-and-verify.html["restaure a configuração do sistema"].
