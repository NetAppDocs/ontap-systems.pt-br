...
summary: Verifique os requisitos do sistema de storage AFF A20, AFF A30 ou AFF A50. 
---
= Verifique os requisitos para a instalação do seu AFF A20, AFF A30 ou AFF A50 sistema de storage
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
