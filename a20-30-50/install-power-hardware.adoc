...
** O visor da ID da prateleira na parte frontal do chassis do sistema não se acende. O ID interno do compartimento do sistema é fixado em 00.


. Fixe os cabos de alimentação usando o dispositivo de fixação em cada fonte de alimentação. :a20-30-50!:
