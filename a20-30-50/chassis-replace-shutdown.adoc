...
summary: Desligue os controladores do sistema de storage AFF A20, AFF A30 ou AFF A50 para evitar a perda de dados e garantir a estabilidade do sistema ao substituir o chassi. 
---
= Desligue os controladores para substituir o chassi - AFF A20, AFF A30 e AFF A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Desligue os controladores do sistema de storage AFF A20, AFF A30 ou AFF A50 para evitar a perda de dados e garantir a estabilidade do sistema ao substituir o chassi.
