...
summary: Devolva o controle dos recursos de storage ao controlador de substituição para que seu AFF A20, AFF A30 ou AFF A50 sistema de storage possa retomar a operação normal. O procedimento de devolução varia dependendo se o seu sistema não usa criptografia, criptografia com Onboard Key Manager ou criptografia com External Key Manager. 
---
= Devolva o controlador no seu sistema AFF A20, AFF A30 ou AFF A50 para retomar as operações normais
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Retorne o controle dos recursos de armazenamento ao controlador de substituição para que seu sistema de armazenamento AFF A20, AFF A30 ou AFF A50 possa retomar a operação normal.  O procedimento de devolução varia de acordo com o tipo de criptografia usado pelo seu sistema: sem criptografia, criptografia Onboard Key Manager (OKM) ou criptografia External Key Manager (EKM).
