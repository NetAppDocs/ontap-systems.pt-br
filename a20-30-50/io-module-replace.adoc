...
[role="lead"]
Substitua um módulo de E/S em seu AFF A20, AFF A30 ou AFF A50 sistema de storage quando o módulo apresentar defeito ou precisar de uma atualização para oferecer maior desempenho ou recursos adicionais.

O processo de substituição envolve desligar o controlador, substituir o módulo de E/S com defeito, reiniciar o controlador e devolver a peça com defeito para a NetApp.
