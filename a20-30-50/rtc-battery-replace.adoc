...
summary: Substitua a bateria do relógio em tempo real, geralmente conhecida como bateria tipo moeda, em seu sistema de storage AFF A20, AFF A30 ou AFF A50 para garantir que os serviços e aplicativos que dependem da sincronização precisa de tempo permaneçam operacionais. 
---
= Substitua a bateria do relógio em tempo real do seu sistema AFF A20, AFF A30 ou AFF A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
