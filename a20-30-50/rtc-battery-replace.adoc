...
summary: 'Substitua a bateria de relógio em tempo real (RTC), comumente conhecida como bateria de célula tipo moeda, em seu sistema AFF A20, AFF A30 ou AFF A50 para garantir que os serviços e aplicativos que dependem de sincronização precisa de tempo permaneçam operacionais.' 
---
...
[role="lead"]
Substitua a bateria de relógio em tempo real (RTC), comumente conhecida como bateria de célula tipo moeda, em seu sistema AFF A20, AFF A30 ou AFF A50 para garantir que os serviços e aplicativos que dependem de sincronização precisa de tempo permaneçam operacionais.
