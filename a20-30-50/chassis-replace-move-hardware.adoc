...
summary: 'Substitua o chassi do sistema AFF A20, AFF A30 ou AFF A50 quando for necessária uma falha de hardware. O processo de substituição envolve a remoção do controlador e das unidades de fonte de alimentação (PSUs), a remoção das unidades do chassi prejudicado, a instalação do chassi de substituição e a reinstalação dos componentes do chassi.' 
---
...
Mova as unidades, quaisquer lacunas de unidade, controladores e moldura do chassi prejudicado para o chassi de substituição (do mesmo modelo) e, em seguida, substitua o chassi prejudicado dentro do rack de equipamentos ou gabinete do sistema.
...
.O que se segue?
Depois de substituir o chassi AFF A20, AFF A30 ou AFF A50 com problemas e reinstalar os componentes nele, é necessário link:chassis-replace-complete-system-restore-rma.html["complete a substituição do chassis"].
