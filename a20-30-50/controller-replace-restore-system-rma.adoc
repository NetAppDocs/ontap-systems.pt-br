...
summary: Para concluir a substituição do controlador do seu AFF A20, AFF A30 ou AFF A50 sistema de storage, restaure a configuração de criptografia de storage NetApp e instale as licenças necessárias no novo controlador. Confirme se as interfaces lógicas estão relatando para suas portas iniciais e execute uma verificação de integridade do cluster. Registre o número de série do novo controlador e devolva a peça com defeito para a NetApp. 
---
= Conclua a substituição do controlador do seu sistema AFF A20, AFF A30 ou AFF A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Para concluir a substituição do controlador do seu sistema de armazenamento AFF A20, AFF A30 ou AFF A50, primeiro restaure a configuração do NetApp Storage Encryption (se necessário) e instale as licenças necessárias no novo controlador.  Em seguida, confirme se as interfaces lógicas (LIFs) estão reportando às suas portas iniciais e execute uma verificação de integridade do cluster.  Por fim, registre o número de série do novo controlador e devolva a peça com defeito para a NetApp.
