...
summary: Depois de instalar o hardware do sistema de storage AFF A20, AFF A30 ou AFF A50, faça o cabeamento das controladoras à rede e às gavetas. 
---
= Conecte seu hardware AFF A20, AFF A30 ou AFF A50 por cabo para conectividade de rede e storage
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:../media/drw_isi_a20_switched_2p_25gbe_cabling_ieops-2019.svg["Diagrama de cabeamento de cluster comutado a20 usando um módulo de E/S de 25 GbE"]
...
.AFF A20, AFF A30 ou AFF A50 com um módulo de E/S de 4 portas 10/25 GbE
...
.AFF A20, AFF A30 ou AFF A50 com um módulo de E/S FC de 4 portas 64 Gb/s
