...
[role="lead"]
Mantenha o hardware dos sistemas de storage AFF A20, AFF A30 ou AFF A50 para garantir confiabilidade a longo prazo e desempenho ideal. Execute tarefas de manutenção regulares, como a substituição de componentes defeituosos, pois isso ajuda a evitar tempo de inatividade e perda de dados.

Os procedimentos de manutenção presumem que os sistemas AFF A20, AFF A30 e AFF A50 já foram implantados como nós de storage no ambiente ONTAP.
