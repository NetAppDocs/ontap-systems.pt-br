...
[role="lead"]
Restaure a criptografia na Mídia de inicialização de substituição no sistema AFF A20, AFF A30 ou AFF A50 para garantir a proteção contínua dos dados. O processo de substituição envolve verificar a disponibilidade das chaves, reaplicar as configurações de criptografia e confirmar o acesso seguro aos seus dados.
