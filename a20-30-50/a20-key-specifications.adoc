...
summary: Especificações principais do AFF A20 
---
...
[role="lead"]
A seguir estão especificações selecionadas para o sistema de armazenamento AFF A20 em um único par de alta disponibilidade.  Visite o NetApp Hardware Universe (HWU) para obter as especificações completas deste sistema de armazenamento.



== Especificações do AFF A20 em resumo
...
* Tipo: NAS; Pares HA: 3; Capacidade bruta: 12,1 PB / 10,8 PiB; Memória máxima: 384 GB
* Tipo: SAN; Pares HA: 3; Capacidade bruta: 12,1 PB / 10,8 PiB; Memória máxima: 384 GB
