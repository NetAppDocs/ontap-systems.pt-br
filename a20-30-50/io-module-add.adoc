...
---
= Adicione um módulo de E/S ao seu sistema AFF A20, AFF A30 ou AFF A50 para melhorar a conectividade de rede
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Adicione um módulo de E/S ao seu sistema de armazenamento AFF A20, AFF A30 ou AFF A50 para melhorar a conectividade de rede e expandir a capacidade do seu sistema de lidar com o tráfego de dados.

O processo de adição envolve desligar um controlador, adicionar o novo módulo de E/S, reiniciar o controlador, desligar o outro controlador, adicionar o novo módulo de E/S, e reiniciar o controlador.

.Sobre esta tarefa
* Você pode adicionar um módulo de E/S aos seus sistemas de storage quando houver slots disponíveis ou quando todos os slots estiverem totalmente ocupados.
