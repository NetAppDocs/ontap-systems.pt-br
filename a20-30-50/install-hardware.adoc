...
summary: Depois de se preparar para instalar o sistema de storage AFF A20, AFF A30 ou AFF A50, instale o hardware no sistema de storage. Primeiro, instale os kits de trilho. Em seguida, instale e proteja seu sistema de armazenamento em um gabinete ou rack de telecomunicações. 
---
= Instale seu hardware AFF A20, AFF A30 ou AFF A50 em um gabinete ou rack
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
