...
---
= Inicie a imagem de recuperação - AFF A20, AFF A30 e AFF A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead lead"]
Depois de instalar o novo dispositivo multimédia de arranque no sistema AFF A20, AFF A30 ou AFF A50, pode iniciar a imagem de recuperação a partir de uma unidade USB e restaurar a configuração a partir do nó de parceiro.
