...
summary: Inicialize o sistema FAS2700 a partir da imagem de recuperação do ONTAP na unidade USB para restaurar a mídia de inicialização. O sistema FAS2700 suporta apenas procedimentos manuais de recuperação de mídia de inicialização. A recuperação automática de mídia de inicialização não é suportada. 
---
= Inicie a imagem de recuperação - FAS2700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
