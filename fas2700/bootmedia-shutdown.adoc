...
summary: Você pode desligar ou assumir o controle do controlador com defeito usando procedimentos diferentes, dependendo da configuração de hardware do sistema de armazenamento. O sistema FAS2700 suporta apenas procedimentos manuais de recuperação de mídia de inicialização. 
---
= Desligue o controlador desativado - FAS2700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Desligue ou assuma o controle do controlador com defeito usando o procedimento apropriado para sua configuração. O sistema FAS2700 suporta apenas procedimentos manuais de recuperação de mídia de inicialização. A recuperação automática de mídia de inicialização não é suportada.
