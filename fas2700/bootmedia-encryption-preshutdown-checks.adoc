...
summary: Verifique o suporte e o status da chave de criptografia antes de desligar o controlador com defeito em um sistema FAS2700. O sistema FAS2700 suporta apenas procedimentos manuais de recuperação de mídia de inicialização. A recuperação automática de mídia de inicialização não é suportada. 
---
= Verificar suporte e status da chave de criptografia - FAS2700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
