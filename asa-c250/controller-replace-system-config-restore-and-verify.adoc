...
---
= Restaure e verifique a configuração do controlador no seu sistema ASA C250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Após concluir a substituição do hardware e inicializar o seu sistema ASA C250 no modo de manutenção, você precisa verificar a configuração de baixo nível do controlador de substituição e reconfigurar as definições do sistema conforme necessário.
