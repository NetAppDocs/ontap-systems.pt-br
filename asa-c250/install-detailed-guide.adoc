...
summary: Esta seção fornece instruções detalhadas passo a passo para a instalação de um sistema ASA C250. 
---
= Instale seu sistema de storage ASA C250 usando passos detalhados
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Esta seção fornece instruções detalhadas passo a passo para a instalação de um sistema ASA C250.
