...
---
= Desligue seus controladores ASA C250 para substituir o chassi
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Desligue os controladores no seu sistema de storage AFF ASA C250 para evitar perda de dados e garantir a estabilidade do sistema ao substituir o chassi.
...
.O que se segue?
Depois de desligar o controlador, você precisa link:chassis-replace-move-hardware.html["Mover o hardware para o novo chassi"]
