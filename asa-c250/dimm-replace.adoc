...
summary: Substitua um DIMM no módulo de controlador ASA C250 quando o sistema registrar um número crescente de códigos de correção de erros corrigíveis ou erros ECC incorrigíveis. A não substituição de um DIMM defeituoso pode causar um pânico no sistema. 
---
= Substitua um DIMM no seu ASA C250 para corrigir erros de memória
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
