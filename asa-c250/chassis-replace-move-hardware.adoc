...
summary: Substitua o chassi do seu sistema ASA C250 quando uma falha de hardware exigir. O processo de substituição envolve remover os controladores e as fontes de alimentação, remover as unidades de disco, instalar o chassi de substituição e reinstalar os componentes do chassi. 
---
= Substitua o chassi no seu sistema ASA C250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua o chassi do seu sistema ASA C250 quando uma falha de hardware exigir. O processo de substituição envolve a remoção dos controladores e das fontes de alimentação (PSUs), a remoção das unidades de disco, a instalação do chassi de substituição e a reinstalação dos componentes do chassi.
...
.O que se segue?
Após substituir o chassi ASA C250 e reinstalar os componentes, você precisa link:chassis-replace-complete-system-restore-rma.html["complete a substituição do chassis"]
