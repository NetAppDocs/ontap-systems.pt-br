...
---
= Instale e configure seu sistema de storage ASA C250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* link:../asa-c250/install-quick-guide.html["Passos rápidos"]
+
Um PDF imprimível de instruções passo a passo com links em direto para conteúdo adicional.

* link:../asa-c250/install-videos.html["Passos de vídeo"]
+
Instruções passo a passo em vídeo.

* link:../asa-c250/install-detailed-guide.html["Passos detalhados"]
+
