...
---
= Reconecte os cabos do sistema e reatribua os discos no seu ASA C250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Após concluir a restauração e verificar a configuração do sistema ASA C250, você precisa reconectar o sistema e reatribuir os discos.
