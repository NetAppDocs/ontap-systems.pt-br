...
summary: Substitua a fonte de alimentação no seu sistema ASA C250 desconectando a fonte de alimentação de destino da fonte de energia, retirando o cabo de alimentação, removendo a unidade antiga, instalando a unidade de substituição e, em seguida, reconectando-a à fonte de energia. 
---
= Substitua a fonte de alimentação com o sistema ASA C250 em funcionamento.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
