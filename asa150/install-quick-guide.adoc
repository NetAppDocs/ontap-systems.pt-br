...
summary: Estas etapas rápidas fornecem instruções gráficas para a instalação do seu ASA A150, desde a montagem no rack e a passagem de cabos até a inicialização do sistema. 
---
= Instale seu sistema de storage ASA A150 em etapas rápidas
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
