...
summary: Use os vídeos a seguir para saber como montar e fazer o cabeamento do sistema e executar a configuração inicial do sistema. 
---
= Instale seu sistema de storage ASA A150 com instruções em vídeo
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
