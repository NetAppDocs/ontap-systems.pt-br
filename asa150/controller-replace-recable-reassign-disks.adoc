...
summary: Devolva o controle dos recursos de storage ao controlador de substituição para que seu sistema ASA A150 possa retomar a operação normal. 
---
= Devolva o controlador no seu sistema ASA A150 para retomar as operações normais
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
