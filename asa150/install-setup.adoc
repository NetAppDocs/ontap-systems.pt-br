...
---
= Escolha como instalar seu sistema de storage ASA A150
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Escolha o formato que preferir para instalar seu sistema de storage ASA A150: instruções detalhadas passo a passo, guia gráfico rápido ou instruções em vídeo.
