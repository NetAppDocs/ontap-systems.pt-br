...
summary: Estas etapas detalhadas orientam você na instalação do seu ASA A150, incluindo a preparação para a instalação, a instalação do hardware, o cabeamento dos controladores e a conclusão da configuração. 
---
= Instale seu sistema de storage ASA A150 com etapas detalhadas
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
