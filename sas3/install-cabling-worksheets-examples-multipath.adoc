...
summary: Você pode usar as planilhas e exemplos de cabeamento do controlador para o stack para conectar seu par de HA como uma configuração de multipath HA. 
---
= Planilhas de cabeamento para configurações multipath de par de HA DS212C, DS224C ou DS460C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Isso se aplica a prateleiras com módulos IOM12, IOM12B ou IOM12C.
