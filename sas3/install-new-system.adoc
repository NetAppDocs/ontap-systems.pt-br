...
summary: Se o seu novo sistema não veio instalado em um gabinete, você deve instalar e cabear as gavetas de discos em um rack. 
---
= Instale e conecte uma shelf DS212C, DS224C ou DS460C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Sobre esta tarefa
* Os gabinetes de discos com módulos IOM12, IOM12B ou IOM12C são enviados com os IDs dos gabinetes predefinidos como 00.
+
...
* Se você não configurar o sistema para usar a atribuição automática de propriedade de disco durante a instalação e configuração do sistema, será necessário atribuir a propriedade do disco manualmente.
