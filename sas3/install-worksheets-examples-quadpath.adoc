...
---
= Planilha de cabeamento para uma configuração de par de HA com quatro caminhos usando DS212C, DS224C ou DS460C e duas HBAs SAS de quatro portas
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Você pode usar a planilha de cabeamento do controlador para o stack e o exemplo de cabeamento preenchidos para conectar uma configuração de par de HA com quatro caminhos que possui dois HBAs SAS de quatro portas. Isso se aplica a shelves com módulos IOM12, IOM12B ou IOM12C.
