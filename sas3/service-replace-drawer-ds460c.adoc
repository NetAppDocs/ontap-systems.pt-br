...
summary: 'Ao substituir uma gaveta de disco em uma prateleira, você pode interromper todo o sistema de storage (par de HA) ou manter o par de HA em funcionamento.' 
---
= Substitua a gaveta da unidade DS460C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Sobre esta tarefa
* Este procedimento aplica-se a racks com gavetas de unidades DCM e/ou gavetas de unidades DCM2 ou DCM3. (Os racks também terão dois módulos IOM12, dois módulos IOM12B ou dois módulos IOM12C.)
+
...
[NOTE]
====
Ao substituir uma gaveta de unidade com falha por uma gaveta de unidade DCM2 ou DCM3 mais recente, certifique-se de que o software ONTAP e o firmware do módulo IOM12, IOM12B ou IOM12C estejam executando as versões mínimas necessárias para suportar gavetas DCM2 ou DCM3.

A atualização de firmware (FW) do IOM12, IOM12B ou IOM12C pode ser feita antes ou depois da substituição da gaveta da unidade. Este procedimento orienta você a atualizar o firmware como parte da preparação para o procedimento de substituição da gaveta.
...
. Se o seu shelf tiver uma combinação de módulos IOM12, IOM12B ou IOM12C com qualquer número de gavetas de unidades DCM3, seu sistema deve estar executando as seguintes versões mínimas do ONTAP:
+
** ONTAP 9.17.1RC1
** ONTAP 9.16.1P3
** ONTAP 9.15.1P11
