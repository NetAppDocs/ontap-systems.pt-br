...
---
= Troque a quente uma unidade de disco em um shelf DS212C ou DS224C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Você pode substituir a quente uma unidade com falha em um shelf de discos DS224C ou DS212C com módulos IOM12, IOM12B ou IOM12C.
