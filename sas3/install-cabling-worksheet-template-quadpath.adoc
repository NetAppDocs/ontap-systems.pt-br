...
summary: Defina os pares de portas SAS do controlador que você pode usar para conectar os controladores a conjuntos de gavetas de discos para conectividade de quatro caminhos em um par de HA ou em uma configuração de controlador único. 
---
= Planilha de cabeamento para conectividade quad-path DS212C, DS224C ou DS460C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Você pode usar uma planilha de cabeamento para definir os pares de portas SAS do controlador que você pode usar para conectar os controladores a conjuntos de gavetas de discos com módulos IOM12, IOM12B ou IOM12C, para obter conectividade de quatro caminhos em um par de HA ou em uma configuração de controlador único. Você também pode usar a planilha preenchida para orientar você no cabeamento das conexões de quatro caminhos para sua configuração.
