...
---
= Monitore os LEDs da prateleira DS212C, DS224C ou DS460C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Âmbar sólido
 a| 
Ocorreu um erro na função de uma ou mais FRUs: a gaveta de discos, as unidades de disco, os módulos IOM12, IOM12B, IOM12C ou as fontes de alimentação.
...
O LED de localização no painel de controle do operador e nos módulos IOM12, IOM12B ou IOM12C acende quando esta função de LED é ativada. Os LEDs de localização desligam-se automaticamente após 30 minutos.
...
== LEDs do módulo IOM12, IOM12B ou IOM12C

Os LEDs nos módulos IOM12, IOM12B ou IOM12C indicam se o módulo está funcionando normalmente, se está pronto para tráfego de E/S e se há algum problema com o hardware.

A tabela a seguir descreve os LEDs dos módulos IOM12, IOM12B ou IOM12C associados à função do módulo e à função de cada porta SAS no módulo.

O módulo IOM12, IOM12B ou IOM12C é utilizado nos shelves de disco DS460C, DS224C e DS212C.
...
Âmbar sólido
 a| 
Função do módulo IOM12, IOM12B ou IOM12C: ocorreu um erro na função do módulo IOM12, IOM12B ou IOM12C.
...
Azul sólido
 a| 
O administrador do sistema ativou essa função de LED para auxiliar na localização física da gaveta de discos com o módulo IOM12, IOM12B ou IOM12C com falha.
...
image::../media/drw_iom12.gif[Módulo IOM12,828px,147px]

Os IOM12B módulos distinguem-se por uma faixa azul e uma etiqueta "IOM12B":

image::../media/iom12b.png[Módulo IOM12B,828px,147px]
