...
summary: Se um módulo de ventoinha falhar em um compartimento de unidades DS460C, você deve substituí-lo o mais rápido possível para garantir que o compartimento tenha resfriamento adequado. 
---
= Substitua o módulo de ventoinha do DS460C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
