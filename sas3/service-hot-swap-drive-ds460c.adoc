...
---
= Troque a quente uma unidade de disco em um shelf DS460C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Você pode substituir a quente uma unidade de disco com falha em um shelf de discos DS460C com módulos IOM12, IOM12B ou IOM12C.
