...
summary: 'Retorne o controle dos recursos de armazenamento ao controlador de substituição para que seu sistema de armazenamento AFF C30 ou AFF C60 possa retomar a operação normal.  O procedimento de devolução varia de acordo com o tipo de criptografia usado pelo seu sistema: sem criptografia, criptografia OKM do Onboard Key Manager ou criptografia EKM do External Key Manager.' 
---
= Devolva o controlador no seu sistema de storage AFF C30 ou AFF C60 para retomar as operações normais
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Retorne o controle dos recursos de armazenamento ao controlador de substituição para que seu sistema de armazenamento AFF C30 ou AFF C60 possa retomar a operação normal.  O procedimento de devolução varia de acordo com o tipo de criptografia usado pelo seu sistema: sem criptografia, criptografia Onboard Key Manager (OKM) ou criptografia External Key Manager (EKM).
