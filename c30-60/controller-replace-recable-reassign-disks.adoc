...
summary: Retorne o controle dos recursos de storage ao controlador de substituição para que seu sistema AFF C30 ou AFF C60 possa retomar a operação normal. 
---
= Recable e devolver o controlador - AFF C30 e AFF C60
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Retorne o controle dos recursos de storage ao controlador de substituição para que seu sistema AFF C30 ou AFF C60 possa retomar a operação normal. O procedimento de devolução varia de acordo com o tipo de encriptação utilizado pelo seu sistema: sem encriptação, encriptação OKM (Onboard Key Manager) ou encriptação EKM (External Key Manager).
