...
summary: Faça a manutenção do hardware do seu sistema de armazenamento AFF C30 ou AFF C60 para garantir confiabilidade a longo prazo e desempenho ideal. Realize tarefas de manutenção regulares, como a substituição de componentes defeituosos, pois isso ajuda a evitar tempo de inatividade e perda de dados. 
---
= Saiba mais sobre a manutenção do seu AFF C30 ou AFF C60 sistema de storage
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Faça a manutenção do hardware do seu sistema de armazenamento AFF C30 ou AFF C60 para garantir confiabilidade a longo prazo e desempenho ideal. Realize tarefas de manutenção regulares, como a substituição de componentes defeituosos, pois isso ajuda a evitar tempo de inatividade e perda de dados.

Os procedimentos nesta seção pressupõem que o sistema de armazenamento AFF C30 ou AFF C60 já foi implantado como um nó de armazenamento no ambiente ONTAP .
