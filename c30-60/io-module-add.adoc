...
summary: Adicione um módulo de E/S ao seu sistema de armazenamento AFF C30 ou AFF C60 para melhorar a conectividade de rede e expandir a capacidade do seu sistema de lidar com o tráfego de dados. 
---
= Adicione um módulo de e/S - AFF C30 e AFF C60
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Adicione um módulo de E/S ao seu sistema de armazenamento AFF C30 ou AFF C60 para melhorar a conectividade de rede e expandir a capacidade do seu sistema de lidar com o tráfego de dados.
