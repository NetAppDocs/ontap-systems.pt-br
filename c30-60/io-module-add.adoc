...
summary: Adicione um módulo de E/S ao seu sistema de storage AFF C30 ou AFF C60 para melhorar a conectividade de rede e expandir a capacidade do seu sistema de lidar com o tráfego de dados. 
---
= Adicione um módulo de E/S ao seu sistema de storage AFF C30 ou AFF C60 para melhorar a conectividade de rede
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Adicione um módulo de E/S ao seu AFF C30 ou AFF C60 sistema de storage para melhorar a conectividade de rede e expandir a capacidade do seu sistema de lidar com tráfego de dados. Você pode usar este procedimento para adicionar um módulo de E/S a um controlador em operação, como uma atualização planejada, ou a um controlador com problemas durante a manutenção.

Você pode adicionar um módulo de e/S aos sistemas de armazenamento AFF C30 e AFF C60 quando houver slots disponíveis ou quando todos os slots estiverem totalmente preenchidos.

.Sobre esta tarefa
Você pode executar este procedimento em qualquer um dos controladores do par de HA, independentemente de o controlador estar operacional ou com falha. Como um módulo de E/S não pode ser adicionado a um controlador em execução, o controlador de destino deve ser desligado antes da instalação do módulo. O parceiro do par de HA assume as operações de storage durante o procedimento para que os dados permaneçam disponíveis para os clientes.

* Se o controlador de destino estiver *operacional* (adição planejada), siga os passos de desligamento conforme descrito, tratando o controlador de destino como o controlador "com defeito" nesse conteúdo.
* Se o controlador de destino estiver *com defeito*, siga os passos de desligamento conforme descrito.
...
== Passo 1: Desligue o módulo controlador de destino

Assuma o controle e desligue o módulo controlador de destino para que seu par de HA continue fornecendo dados enquanto você adiciona o módulo de E/S. As etapas mencionadas referem-se ao controlador que está sendo desligado como o controlador "com problemas"; as mesmas etapas se aplicam tanto se você estiver assumindo o controle de um controlador operacional para uma adição planejada quanto se estiver desligando um controlador que já está com problemas.
