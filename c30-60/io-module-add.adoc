...
summary: Adicione um módulo de e/S ao seu sistema AFF C30 ou AFF C60 para melhorar a conetividade de rede e expandir a capacidade do seu sistema de lidar com o tráfego de dados. 
---
...
[role="lead"]
Adicione um módulo de e/S ao seu sistema AFF C30 ou AFF C60 para melhorar a conetividade de rede e expandir a capacidade do seu sistema de lidar com o tráfego de dados.
