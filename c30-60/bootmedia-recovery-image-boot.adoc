...
summary: Depois de instalar o novo dispositivo multimédia de arranque no seu sistema AFF C30 ou AFF C60, pode iniciar a imagem de recuperação a partir de uma unidade USB e restaurar a configuração a partir do nó do parceiro. 
---
= Inicie a imagem de recuperação - AFF C30 e AFF C60
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Depois de instalar o novo dispositivo multimédia de arranque no seu sistema AFF C30 ou AFF C60, pode iniciar a imagem de recuperação a partir de uma unidade USB e restaurar a configuração a partir do nó do parceiro.
