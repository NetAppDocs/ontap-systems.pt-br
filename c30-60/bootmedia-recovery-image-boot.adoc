...
summary: Depois de instalar o novo dispositivo de mídia de inicialização no seu sistema AFF C30 ou AFF C60, você pode inicializar a imagem de recuperação manualmente a partir de uma unidade USB para restaurar a configuração do nó parceiro. 
---
