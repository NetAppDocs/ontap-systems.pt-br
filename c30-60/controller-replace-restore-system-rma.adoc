...
[role="lead"]
Para restaurar o sistema de armazenamento para a operação completa, você deve verificar os LIfs, verificar a integridade do cluster e retornar a peça com falha ao NetApp.
