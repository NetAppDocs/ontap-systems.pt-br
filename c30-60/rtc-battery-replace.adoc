...
summary: 'Substitua a bateria de relógio em tempo real (RTC), comumente conhecida como bateria de célula tipo moeda, em seu sistema AFF C30 ou AFF C60 para garantir que os serviços e aplicativos que dependem de sincronização precisa de tempo permaneçam operacionais.' 
---
...
[role="lead"]
Substitua a bateria de relógio em tempo real (RTC), comumente conhecida como bateria de célula tipo moeda, em seu sistema AFF C30 ou AFF C60 para garantir que os serviços e aplicativos que dependem de sincronização precisa de tempo permaneçam operacionais.
