...
=====
.AFF C30 com um módulo de e/S de 10/25 GbE de 2 portas
[%collapsible]
=====
Ligue os controladores uns aos outros para criar as ligações do cluster do ONTAP.
...
====
.AFF C30 ou AFF C60 com um módulo de e/S de 10/25 GbE de 2 portas
[%collapsible]
====
.Passos
. Faça o cabo das conexões de rede do host.
...
====
.AFF C30 com um módulo de 10/25 GbE de 2 portas
[%collapsible]
====
.Passos
. Faça o cabo das conexões de rede do host.
