...
summary: Substitua uma fonte de alimentação CA ou CC no seu sistema AFF C30 ou AFF C60 quando falhar ou ficar com defeito, garantindo que o sistema continua a receber a energia necessária para uma operação estável. 
---
