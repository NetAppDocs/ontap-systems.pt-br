...
. Se você desativou a atribuição automática de unidades anteriormente neste procedimento, atribua manualmente a propriedade da unidade e, em seguida, reative a atribuição automática de unidades, se necessário:
+
