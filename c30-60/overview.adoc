...
summary: Especificações principais dos sistemas de storage AFF C30 e AFF C60 em um único par de alta disponibilidade 
---
= Especificações principais para AFF C30 e AFF C60
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
A seguir estão algumas especificações selecionadas para os sistemas de storage AFF C30 e AFF C60 em um único par de alta disponibilidade. Visite  https://hwu.netapp.com["NetApp Hardware Universe"^] para ver as especificações completas desses sistemas de storage.
