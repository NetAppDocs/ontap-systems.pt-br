...
summary: Especificações principais do AFF C60 
---
...
[role="lead"]
A seguir estão especificações selecionadas para o sistema de armazenamento AFF C60 em um único par de alta disponibilidade.  Visite o NetApp Hardware Universe (HWU) para obter as especificações completas deste sistema de armazenamento.



== Especificações do AFF C60 em resumo
...
* Tipo: NAS; Pares HA: 4; Capacidade bruta: 29,5 PB / 26,2 PiB; Memória máxima: 512 GB
* Tipo: SAN; Pares HA: 4; Capacidade bruta: 29,5 PB / 26,2 PiB; Memória máxima: 512 GB
* Tipo: Par HA; Capacidade bruta: 7,4 PB / 6,5 PiB; Memória máxima: 128.0000
