...
summary: Você pode realizar a substituição a quente de um módulo de E/S Ethernet em seu sistema de storage AFF C30 ou AFF C60 caso um módulo apresente falha e seu sistema de storage atenda a todos os requisitos de versão do ONTAP. 
---
= Troque um módulo de E/S a quente no seu sistema de storage AFF C30 ou AFF C60
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
