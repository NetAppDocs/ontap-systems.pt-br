...
summary: Substitua o chassi do sistema AFF C30 ou AFF C60 quando uma falha de hardware o exigir. O processo de substituição envolve a remoção do controlador e das unidades de fonte de alimentação, remoção das unidades do chassi prejudicado, instalação do chassi de substituição e reinstalação dos componentes do chassi. 
---
