...
summary: Restaure a criptografia na mídia de inicialização de substituição do seu sistema de armazenamento AFF C30 ou AFF C60 para garantir a proteção contínua dos dados. O processo de substituição envolve a verificação da disponibilidade da chave, a reaplicação das configurações de criptografia e a confirmação do acesso seguro aos seus dados. 
---
= Restaure a criptografia na mídia de inicialização do seu sistema de storage AFF C30 ou AFF C60 após o processo de recuperação manual de inicialização
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Restaure a criptografia na mídia de inicialização de substituição do seu sistema de armazenamento AFF C30 ou AFF C60 para garantir a proteção contínua dos dados. O processo de substituição envolve a verificação da disponibilidade da chave, a reaplicação das configurações de criptografia e a confirmação do acesso seguro aos seus dados.
