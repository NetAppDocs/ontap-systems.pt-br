...
---
= Desligar controlador desativado - AFF C30 e AFF C60
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Desligue o controlador desativado no sistema de armazenamento AFF C30 ou AFF C60 para evitar a perda de dados e garantir a estabilidade do sistema ao substituir o suporte de arranque.
