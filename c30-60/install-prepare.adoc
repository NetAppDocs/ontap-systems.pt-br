...
summary: Prepare-se para instalar o sistema de armazenamento AFF C30 ou AFF C60, preparando o local, desembalando as caixas e comparando o conteúdo das caixas com o boletim de embalagem e registrando o sistema de armazenamento para acessar os benefícios de suporte. 
---
= Prepare-se para instalar seu sistema de storage AFF C30 e AFF C60
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
