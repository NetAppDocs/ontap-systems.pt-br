...
summary: Substitua o controlador no seu sistema de armazenamento AFF C30 ou AFF C60 quando uma falha de hardware exigir isso.  O processo de substituição envolve remover o controlador danificado, mover os componentes para o controlador de substituição, instalar o controlador de substituição e reiniciá-lo. 
---
= Substitua o controlador no seu sistema de storage AFF C30 ou AFF C60
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua o controlador no seu sistema de armazenamento AFF C30 ou AFF C60 quando uma falha de hardware exigir isso.  O processo de substituição envolve remover o controlador danificado, mover os componentes para o controlador de substituição, instalar o controlador de substituição e reiniciá-lo.
...
CAUTION: Antes de fechar a tampa do controlador danificado, certifique-se de que as linguetas de ejeção em todos os slots DIMM vazios estejam totalmente encaixadas na posição travada.
