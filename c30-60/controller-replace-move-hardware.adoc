...
.O que se segue?
Depois de substituir o controlador AFF C30 ou AFF C60 com problemas, é necessário link:controller-replace-system-config-restore-and-verify.html["restaure a configuração do sistema"].
