...
[role="lead"]
Para instalar e configurar o sistema de storage AFF C30 ou AFF C60, leia os requisitos e considerações de instalação, prepare o local, instale e faça o cabeamento dos componentes de hardware, ligue o sistema de storage e configure o cluster ONTAP.
