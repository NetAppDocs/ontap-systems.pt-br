...
summary: Desligue os controladores do sistema de storage AFF C30 ou AFF C60 para evitar a perda de dados e garantir a estabilidade do sistema ao substituir o chassi. 
---
= Desligue seus controladores AFF C30 ou AFF C60 para substituir o chassi
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Desligue os controladores do sistema de storage AFF C30 ou AFF C60 para evitar a perda de dados e garantir a estabilidade do sistema ao substituir o chassi.
