...
---
= Manter o hardware AFF C30 e AFF C60
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Para os sistemas de storage AFF C30 ou AFF C60, você pode executar procedimentos de manutenção nos seguintes componentes.
