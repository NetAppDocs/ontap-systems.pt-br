...
summary: Especificações principais do FAS8700 
---
= Especificações principais do FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
A seguir estão especificações selecionadas para o sistema de armazenamento FAS8700 em um único par de alta disponibilidade.  Visite o NetApp Hardware Universe (HWU) para obter as especificações completas deste sistema de armazenamento.



== Especificações do FAS8700 em resumo

* Configuração da plataforma: Par de HA de chassi único FAS8700 , pacote Ethernet
...
* Tipo: NAS; Pares HA: 12; Capacidade bruta: 180,0 PB / 159,9 PiB; Memória máxima: 6144 GB
* Tipo: SAN; Pares HA: 6; Capacidade bruta: 90,0 PB / 79,9 PiB; Memória máxima: 3072 GB
* Tipo: Par HA; Capacidade bruta: 15,0 PB / 13,3 PiB; Memória máxima: 512.0000
...
* Potência típica: 5430 BTU/h
* Pior cenário de potência: 5796 BTU/h
