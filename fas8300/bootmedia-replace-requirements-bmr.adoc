...
summary: Antes de substituir a mídia de inicialização no seu sistema FAS8300 ou FAS8700 , certifique-se de atender aos requisitos necessários para uma substituição bem-sucedida. 
---
= Requisitos para recuperação automatizada de mídia de inicialização - FAS8300 e FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
