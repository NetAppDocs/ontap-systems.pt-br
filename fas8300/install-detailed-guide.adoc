...
---
= Guia detalhado - FAS8300 e FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image::../media/drw_fas8300_TNSC_network_cabling.png[Diagrama de cabeamento de cluster sem switch de dois nós]
...
+
image::../media/drw_fas8300_switched_network_cabling.png[Diagrama de cabeamento de rede comutada de cluster]
...
=== Opção 1: Faça o cabeamento das controladoras para gavetas de unidade SAS
...
+
image::../media/drw_fas8300_three-ds224c_shelves.png[Diagrama de cabeamento de três compartimentos de DS224C U.]
