...
summary: Você deve substituir o módulo de armazenamento em cache no módulo controlador quando o seu sistema registrar uma única mensagem AutoSupport indicando que o módulo ficou offline. 
---
