...
summary: Você deve substituir um DIMM no controlador quando seu sistema de storage encontrar erros como códigos de correção de erros corrigíveis em excesso ou erros incorrigíveis, normalmente causados por uma única falha de DIMM que impede o sistema de storage de inicializar o ONTAP. 
---
