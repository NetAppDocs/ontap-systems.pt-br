...
summary: Devolva o controle dos recursos de storage ao controlador de substituição para que seu sistema FAS8300 e FAS8700 possa retomar a operação normal. 
---
= Devolva o controlador - FAS8300 e FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Devolva o controle dos recursos de storage ao controlador de substituição para que seu sistema FAS8300 e FAS8700 possa retomar a operação normal.
