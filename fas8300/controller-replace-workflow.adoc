...
summary: Substitua o controlador do seu FAS8300 ou FAS8700 sistema de storage desligando o controlador com defeito, removendo e substituindo o controlador, restaurando a configuração do sistema e devolvendo o controle dos recursos de storage ao controlador de substituição. 
---
= Fluxo de trabalho de substituição do controlador - FAS8300 e FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua o controlador do seu FAS8300 ou FAS8700 sistema de storage desligando o controlador com defeito, removendo e substituindo o controlador, restaurando a configuração do sistema e devolvendo o controle dos recursos de storage ao controlador de substituição.
