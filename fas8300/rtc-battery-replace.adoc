...
---
= Substitua a bateria do relógio em tempo real - FAS8300 e FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
== Passo 4: Reinstale o módulo do controlador e defina a hora/data após a substituição da bateria do RTC
