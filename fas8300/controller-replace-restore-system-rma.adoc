...
summary: 'Conclua a substituição do controlador para o seu sistema FAS8300 e FAS8700. Instale as licenças para o controlador de substituição, confirme se as interfaces lógicas (LIFs) estão reportando às suas portas de origem e execute uma verificação de integridade. Por fim, devolva a peça com defeito para a NetApp.' 
---
= Substituição completa do controlador - FAS8300 e FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Conclua a substituição do controlador para o seu sistema FAS8300 e FAS8700. Instale as licenças para o controlador de substituição, confirme se as interfaces lógicas (LIFs) estão reportando às suas portas de origem e execute uma verificação de integridade. Por fim, devolva a peça com defeito para a NetApp.
