...
summary: Desligue o controlador do seu FAS8300 e FAS8700 sistema de storage para evitar perda de dados e garantir a estabilidade do sistema ao substituir o controlador. 
---
...
[role="lead"]
Desligue o controlador do seu FAS8300 e FAS8700 sistema de storage para evitar perda de dados e garantir a estabilidade do sistema ao substituir o controlador.
...
====
.O que se segue?
Após desligar o controlador FAS8300 e FAS8700, você precisa link:controller-replace-move-hardware.html["substitua o controlador"].
