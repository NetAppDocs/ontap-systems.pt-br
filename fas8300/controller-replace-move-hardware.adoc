...
summary: Substitua o controlador no seu sistema FAS8300 ou FAS8700 quando uma falha de hardware assim o exigir. Remova o controlador com defeito, transfira seus componentes para o controlador de substituição, instale o novo controlador e reinicialize-o. 
---
= Substitua o controlador - FAS8300 e FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua o controlador no seu sistema FAS8300 ou FAS8700 quando uma falha de hardware assim o exigir. Remova o controlador com defeito, transfira seus componentes para o controlador de substituição, instale o novo controlador e reinicialize-o.
...
Transfira as fontes de alimentação para o módulo controlador de substituição.
...
Transfira a bateria NVDIMM para o módulo controlador de substituição.
...
Transfira a mídia de inicialização para o módulo controlador de substituição.
...
Transfira os risers PCIe e a placa mezzanine para o módulo controlador de substituição.
...
== Etapa 6: Mova o módulo de cache

Mova o módulo de cache para o módulo controlador de substituição.
...
.O que se segue?
Após substituir o controlador FAS8300 ou FAS8700 com defeito, você precisa link:controller-replace-system-config-restore-and-verify.html["restaure a configuração do sistema"].
