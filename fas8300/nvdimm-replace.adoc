...
summary: Você deve substituir o NVDIMM no módulo controlador quando o sistema registrar que a vida útil da flash está quase no fim ou que o NVDIMM identificado não está saudável em geral. 
---
= Substitua um NVDIMM - FAS8300 e FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Para substituir o NVDIMM, você deve localizá-lo no módulo do controlador usando o mapa da FRU na parte superior do duto de ar o mapa da FRU na parte superior do riser do slot 1.
