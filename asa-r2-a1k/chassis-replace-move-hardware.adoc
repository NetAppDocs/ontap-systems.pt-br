...
summary: Substitua o chassi do seu sistema ASA A1K quando uma falha de hardware exigir. O processo de substituição envolve a remoção do controlador, das placas de E/S, do módulo NVRAM12, do módulo de gerenciamento do sistema e das fontes de alimentação, a instalação do chassi de substituição e a reinstalação dos componentes do chassi. 
---
= Substitua o chassi no seu sistema ASA A1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
