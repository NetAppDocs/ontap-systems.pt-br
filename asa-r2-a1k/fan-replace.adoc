...
summary: Substitua um módulo de ventilador com defeito ou com defeito no seu sistema ASA A1K para manter o resfriamento adequado e evitar problemas de desempenho do sistema.  Os ventiladores podem ser trocados a quente e podem ser substituídos sem desligar o sistema. 
---
= Substitua uma ventoinha no seu sistema ASA A1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
