...
. Verifique a versão do firmware do TMP com o `sysconfig -v` comando.
+
** Se a versão for inferior a 5,63, contactar https://support.netapp.com["Suporte à NetApp"].
** Se a versão for superior a 5,63, saia para o prompt Loader: `halt`.
