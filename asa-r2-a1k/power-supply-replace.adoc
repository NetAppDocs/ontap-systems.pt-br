...
summary: Substitua a fonte de alimentação CA ou CC do seu sistema ASA A1K quando ela falhar ou apresentar defeito, garantindo que seu sistema continue recebendo a energia necessária para uma operação estável. O processo de substituição envolve desconectar a fonte de alimentação defeituosa da fonte de alimentação, desconectar o cabo de força, substituir a fonte de alimentação defeituosa e, em seguida, reconectá-la à fonte de alimentação. 
---
= Substitua a fonte de alimentação com substituição a quente no seu sistema ASA A1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Sobre esta tarefa
Este procedimento foi escrito para a substituição de uma PSU por vez. Utilize o procedimento apropriado para o seu tipo de PSU: AC ou DC.
