...
---
= Substitua o NVRAM no seu sistema ASA A1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Depois de substituir o componente, você deve reinicializar o módulo controlador conectando os cabos de alimentação novamente à PSU.
