...
---
= Substitua uma unidade no seu sistema ASA A20, ASA A30 ou ASA A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Você pode trocar um disco rígido sem interrupção enquanto as operações de E/S estão em andamento.
