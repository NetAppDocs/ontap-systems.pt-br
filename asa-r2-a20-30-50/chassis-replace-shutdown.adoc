...
summary: Desligue os controladores do sistema de storage ASA A20, ASA A30 ou ASA A50 para evitar a perda de dados e garantir a estabilidade do sistema ao substituir o chassi. 
---
= Desligue seus controladores ASA A20, ASA A30 ou ASA A50 para substituir o chassi
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Desligue os controladores do sistema de storage ASA A20, ASA A30 ou ASA A50 para evitar a perda de dados e garantir a estabilidade do sistema ao substituir o chassi.
