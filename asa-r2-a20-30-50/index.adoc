...
---
= Mantenha o hardware ASA A20, ASA A30 e ASA A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Para os sistemas de storage ASA A20, ASA A30 ou ASA A50, é possível executar procedimentos de manutenção nos seguintes componentes.
