...
summary: Substitua a fonte de alimentação CA ou CC do seu sistema de storage ASA A20, ASA A30 ou ASA A50 quando ela falhar ou apresentar defeito, garantindo que o sistema continue recebendo a energia necessária para uma operação estável. 
---
= Substitua a fonte de alimentação com substituição a quente no seu sistema ASA A20, ASA A30 ou ASA A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
