...
summary: Mova o painel frontal, as unidades e os módulos do controlador do chassi com deficiência para o novo chassi e troque o chassi com deficiência do rack de equipamentos ou do gabinete do sistema pelo novo chassi do mesmo modelo que o chassi com deficiência. 
---
