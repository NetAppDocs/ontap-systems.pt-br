...
summary: Devolva o controle dos recursos de storage ao controlador de substituição para que seu sistema de storage ASA A20, ASA A30 ou ASA A50 possa retomar a operação normal. O procedimento de devolução varia de acordo com o tipo de criptografia usado pelo seu sistema. 
---
= Devolva o controlador no seu sistema ASA A20, ASA A30 ou ASA A50 para retomar as operações normais
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Retorne o controle dos recursos de armazenamento ao controlador de substituição para que seu sistema de armazenamento ASA A20, ASA A30 ou ASA A50 possa retomar a operação normal.  O procedimento de devolução varia de acordo com o tipo de criptografia usado pelo seu sistema: sem criptografia, criptografia Onboard Key Manager (OKM) ou criptografia External Key Manager (EKM).
