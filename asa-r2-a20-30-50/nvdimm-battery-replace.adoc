...
summary: Substitua a bateria NV no sistema ASA A20, ASA A30 ou ASA A50 quando a bateria começar a perder carga ou falhar, pois é responsável pela preservação de dados críticos do sistema durante interrupções de energia. 
---
