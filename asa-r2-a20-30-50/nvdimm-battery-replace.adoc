...
summary: Substitua a bateria NV no seu sistema de armazenamento ASA A20, ASA A30 ou ASA A50 quando a bateria começar a perder carga ou falhar, pois ela é responsável por preservar dados críticos do sistema durante quedas de energia.  O processo de substituição envolve desligar o controlador danificado, remover o módulo do controlador, substituir a bateria NV, reinstalar o módulo do controlador e devolver a peça com defeito à NetApp. 
---
= Substitua a bateria NV em seu sistema ASA A20, ASA A30 ou ASA A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
