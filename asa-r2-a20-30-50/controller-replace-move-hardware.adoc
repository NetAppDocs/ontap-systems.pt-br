...
summary: Substitua o controlador no sistema ASA A20, ASA A30 ou ASA A50 quando for necessária uma falha de hardware. O processo de substituição envolve remover o controlador prejudicado, mover os componentes para o controlador de substituição, instalar o controlador de substituição e reinicializá-lo. 
---
...
[role="lead"]
Substitua o controlador no sistema ASA A20, ASA A30 ou ASA A50 quando for necessária uma falha de hardware. O processo de substituição envolve remover o controlador prejudicado, mover os componentes para o controlador de substituição, instalar o controlador de substituição e reinicializá-lo.
...
.O que se segue?
Depois de substituir o controlador ASA A20, ASA A30 ou ASA A50 com problemas, é necessário link:controller-replace-system-config-restore-and-verify.html["restaure a configuração do sistema"].
