...
summary: Substitua o controlador no seu sistema de armazenamento ASA A20, ASA A30 ou ASA A50 quando uma falha de hardware exigir isso.  O processo de substituição envolve remover o controlador danificado, mover os componentes para o controlador de substituição, instalar o controlador de substituição e reiniciá-lo. 
---
= Substitua o controlador no seu sistema ASA A20, ASA A30 ou ASA A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua o controlador no seu sistema de armazenamento ASA A20, ASA A30 ou ASA A50 quando uma falha de hardware exigir isso.  O processo de substituição envolve remover o controlador danificado, mover os componentes para o controlador de substituição, instalar o controlador de substituição e reiniciá-lo.
