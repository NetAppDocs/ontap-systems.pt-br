...
.. Vá para a etapa 6 para reativar a devolução automática, caso esteja desativada.
...
`key manager is configured.`
 a| 
A criptografia está instalada.  Vá para o passo 4 para restaurar o gerenciador de chaves.
...
+
Vá para a etapa 5 para reativar a devolução automática, caso esteja desativada.
