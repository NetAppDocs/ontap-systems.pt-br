...
[role="lead"]
Para substituir o suporte de arranque, tem de remover o controlador danificado, remover o suporte de arranque danificado e, em seguida, instalar o suporte de arranque de substituição no controlador afetado.
