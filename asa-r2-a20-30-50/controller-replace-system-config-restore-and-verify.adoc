...
.O que se segue?
Depois de restaurar e verificar a configuração do sistema para o sistema ASA A20, ASA A30 ou ASA A50, é necessário link:controller-replace-recable-reassign-disks.html["devolva o controlador"].
