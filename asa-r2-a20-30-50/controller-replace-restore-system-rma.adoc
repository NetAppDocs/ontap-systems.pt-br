...
summary: 'Restaure a configuração de criptografia de armazenamento NetApp (se necessário), instale licenças para o controlador de substituição, verifique se as interfaces lógicas (LIFs) estão relatando a porta inicial, execute uma verificação de integridade do cluster, Registre o número de série do controlador de substituição e, em seguida, devolva a peça com falha ao NetApp para concluir a etapa final no procedimento de substituição do controlador ASA A20, ASA A30 ou ASA A50.' 
---
...
[role="lead"]
Restaure a configuração de criptografia de armazenamento NetApp (se necessário), instale licenças para o controlador de substituição, verifique se as interfaces lógicas (LIFs) estão relatando a porta inicial, execute uma verificação de integridade do cluster, Registre o número de série do controlador de substituição e, em seguida, devolva a peça com falha ao NetApp para concluir a etapa final no procedimento de substituição do controlador ASA A20, ASA A30 ou ASA A50.
