...
Para substituir um ventilador, você deve remover o controlador, remover o ventilador defeituoso, instalar o ventilador de substituição e reinstalar o controlador.
