...
summary: Após verificar as variáveis de ambiente, você deve concluir as etapas específicas para sistemas que possuem Onboard Key Manager, NetApp Storage Encryption ou NetApp Volume Encryption ativados. 
---
= Restaure a criptografia na mídia de inicialização do seu sistema ASA A800 após o processo de recuperação manual de inicialização
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
