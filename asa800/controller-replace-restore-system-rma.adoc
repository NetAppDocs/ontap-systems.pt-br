...
summary: Para restaurar o funcionamento completo do seu sistema, você deve restaurar a configuração de NetApp Storage Encryption conforme necessário, instalar as licenças para o novo controlador e devolver a peça com defeito para a NetApp. 
---
= Conclua a substituição do controlador do seu sistema ASA A800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
