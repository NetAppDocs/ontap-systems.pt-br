...
summary: Substitua o NVDIMM no seu sistema ASA A800 quando o sistema registrar que a vida útil da memória flash está quase no fim ou que o NVDIMM identificado não está saudável em geral. A não realização dessa ação causa um pânico no sistema. 
---
= Substitua um NVDIMM no seu sistema ASA A800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua o NVDIMM no seu sistema ASA A800 quando o sistema detectar que a vida útil da memória flash está quase no fim ou que o NVDIMM identificado não está em boas condições; caso contrário, o sistema entrará em pânico.

.Antes de começar
* Certifique-se de que o módulo NVDIMM de substituição que você recebeu da NetApp é compatível com o seu sistema ASA A800 .
