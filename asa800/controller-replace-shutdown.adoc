...
---
= Desligue o controlador defeituoso do seu sistema ASA A800 antes de substituí-lo
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Desligue o controlador do seu sistema de armazenamento ASA A800 para evitar perda de dados e garantir a estabilidade do sistema ao substituir o controlador.
