...
---
= Concluir o processo de restauração e substituição - ASA A800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Reinicie os controladores, verifique a integridade do sistema e devolva a peça com defeito à NetApp para concluir a etapa final do procedimento de substituição do chassi do ASA A800 .
