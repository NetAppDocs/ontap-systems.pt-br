...
summary: 'Você pode substituir uma bateria de relógio em tempo real (RTC) com defeito, sem interrupções, em uma prateleira NX224 ligada, enquanto a E/S estiver em andamento.' 
---
