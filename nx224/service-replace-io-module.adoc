...
summary: Você pode substituir um módulo de E/S Ethernet com falha sem interrupções em um rack NX224 ligado enquanto a E/S estiver em andamento. 
---
= Substituir o módulo de E/S Ethernet - prateleiras NX224
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Você pode substituir um módulo de E/S Ethernet com falha sem interrupções em um rack NX224 ligado enquanto a E/S estiver em andamento.
...
. Verifique se os LEDs de atenção (âmbar) no NSM que contém o módulo de E/S com falha e o painel de exibição do operador da prateleira não estão mais acesos.
+
