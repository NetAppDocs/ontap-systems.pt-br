...
summary: 'Você pode substituir um módulo de prateleira NVMe (NSM) danificado sem interrupções em uma prateleira de unidade NX224 que esteja ligada e enquanto a E/S estiver em andamento.' 
---
...
CAUTION: Antes de fechar a tampa do NSM danificado, certifique-se de que as linguetas de ejeção em todos os slots DIMM vazios estejam totalmente encaixadas na posição travada.
