...
summary: Restaurar a configuração de criptografia na mídia de inicialização de substituição para um sistema FAS8200 . O sistema FAS8200 suporta apenas procedimentos manuais de recuperação de mídia de inicialização. A recuperação automática de mídia de inicialização não é suportada. 
---
= Restaurar encriptação - FAS8200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
