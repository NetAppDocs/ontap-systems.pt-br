...
[role="lead"]
Depois de concluir as tarefas NVE ou NSE, você precisa concluir o desligamento do controlador desativado. Depois de concluir as tarefas NVE ou NSE, você precisa concluir o desligamento do controlador desativado.
