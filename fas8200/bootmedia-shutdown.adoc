...
summary: Após concluir as verificações de criptografia, desligue o controlador com defeito em um sistema FAS8200 . O sistema FAS8200 suporta apenas procedimentos manuais de recuperação de mídia de inicialização. A recuperação automática de mídia de inicialização não é suportada. 
---
= Desligue o controlador desativado - FAS8200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Após concluir as verificações de criptografia, desligue o controlador com defeito em um sistema FAS8200 . Este procedimento inclui levar o controlador ao prompt LOADER, capturar as variáveis ​​de ambiente de inicialização para referência e preparar o controlador para a substituição da mídia de inicialização, com etapas específicas que variam dependendo da configuração do seu sistema.
