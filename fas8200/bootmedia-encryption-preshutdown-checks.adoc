...
summary: Verifique o suporte e o status da chave de criptografia antes de desligar o controlador com defeito em um sistema FAS8200 . O sistema FAS8200 suporta apenas procedimentos manuais de recuperação de mídia de inicialização. A recuperação automática de mídia de inicialização não é suportada. 
---
= Verifique o suporte e o status da chave de criptografia - FAS8200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
