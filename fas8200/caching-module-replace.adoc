...
summary: Você deve substituir o módulo de armazenamento em cache no módulo controlador quando o sistema registrar uma única mensagem AutoSupport indicando que o módulo ficou offline. A não realização dessa ação resulta em degradação do desempenho. 
---
