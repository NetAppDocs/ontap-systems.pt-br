...
summary: Para restaurar o funcionamento completo do seu sistema, você deve restaurar a configuração de NetApp Storage Encryption, instalar licenças para o novo controlador e devolver a peça com defeito para a NetApp, conforme descrito nas instruções de RMA fornecidas com o kit. 
---
= Restauração completa do sistema - FAS8200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
