...
summary: Inicialize a imagem de recuperação do ONTAP a partir da unidade USB em um sistema FAS8200 para restaurar a mídia de inicialização. O sistema FAS8200 suporta apenas procedimentos manuais de recuperação da mídia de inicialização. A recuperação automática de mídia de inicialização não é suportada. 
---
