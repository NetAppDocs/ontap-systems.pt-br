...
sidebar: sidebar 
keywords: FAS9500 
summary: 'Para substituir a quente um módulo de alimentação do controlador de desengate (DCPM), que contém a bateria NVRAM11, você deve localizar o módulo DCPM com defeito, removê-lo do chassi e instalar o módulo DCPM de substituição.' 
---
...
+
image::../media/drw_a900_remove_NV_battery.svg[Substituir a bateria NV (DCPM)]
