...
sidebar: sidebar 
keywords:  
summary: Para substituir o chassi, você deve remover as fontes de alimentação, ventoinhas, módulos controladores, módulos de E/S, módulos DCPM e o módulo LED USB do chassi com problema e instalá-los no chassi de substituição. 
---
