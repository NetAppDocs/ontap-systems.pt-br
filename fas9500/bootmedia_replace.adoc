...
+
image::../media/drw_9500_PCM_open_source.svg[Fonte aberta do PCM drw 9500]
...
+
image::../media/drw_9500_remove_boot_dev_source.svg[drw 9500 remove boot dev source]
...
NOTE: A porta de destino configurada é a porta de destino usada para se comunicar com o nó prejudicado do nó saudável durante a restauração do sistema de arquivos var com uma conexão de rede. Você também pode usar a porta e0M neste comando.
