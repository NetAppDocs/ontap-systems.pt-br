...
sidebar: sidebar 
keywords:  
summary: 'O módulo NVRAM consiste no NVRAM11 e DIMMs e até dois módulos flash Cache SSD NVMe (módulos flash Cache ou cache) por módulo NVRAM.' 
---
...
+
image::../media/drw_9500_move-remove_NVRAM_module.svg[drw 9500 Move remove módulo NVRAM]
...
+
image::../media/drw_9500_remove_NVRAM_module_contents.svg[drw 9500 remover o conteúdo do módulo NVRAM]
