...
* link:../fas2800/install-quick-guide.html["Passos rápidos"]
+
Um PDF imprimível de instruções passo a passo com links em direto para conteúdo adicional.

* link:../fas2800/install-videos.html["Passos de vídeo"]
+
Instruções passo a passo em vídeo.

* link:../fas2800/install-detailed-guide.html["Passos detalhados"]
+
