...
summary: Você deve substituir o módulo de armazenamento em cache no módulo controlador quando o sistema registrar uma única mensagem ASUP AutoSupport indicando que o módulo ficou offline. Se você não substituir o módulo com falha, seu sistema de storage sofrerá degradação de desempenho. 
---
