...
summary: Restaure a imagem ONTAP na mídia de inicialização de substituição no seu sistema fas2800.  O processo envolve iniciar o processo de recuperação de inicialização a partir do prompt do LOADER e monitorar o processo de recuperação até que ele seja concluído e o nó seja reinicializado. 
---
