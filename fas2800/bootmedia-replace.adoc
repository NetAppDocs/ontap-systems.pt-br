...
+
.. Use  https://kb.netapp.com/on-prem/ontap/DM/Encryption/Encryption-KBs/How_to_determine_if_the_running_ONTAP_version_supports_Data_At_Rest_Encryption["Como determinar se a sua versão do ONTAP suporta NetApp Volume Encryption (NVE)"^]para determinar se a criptografia de volume é atualmente suportada.
+
