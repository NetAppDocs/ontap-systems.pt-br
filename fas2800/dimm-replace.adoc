...
summary: Você deve substituir um módulo DIMM no controlador quando seu sistema de storage encontrar erros como erros ECC corrigíveis em excesso, com base em alertas do Health Monitor, ou erros ECC não corrigíveis que impeçam o sistema de storage de inicializar ONTAP. 
---
