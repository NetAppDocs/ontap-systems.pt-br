...
NOTE: Se o seu sistema não tiver prateleiras externas, consulte link:../sas3/install-cabling-worksheets-examples-fas2600.html#fas2820-platform-in-a-multipath-ha-configuration-with-no-external-shelves["Instruções de cabeamento para FAS2820 em uma configuração HA multipath sem prateleiras externas"].
