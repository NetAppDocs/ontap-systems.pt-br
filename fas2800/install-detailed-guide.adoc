...
+
image::../media/oie_cable_mini_sas_hd_to_mini_sas_hd.svg[Conetor mini SAS para mini SAS]
...
Imagem::../media/drw_2800_shelf-to-shelf_Cabling_IEOPS-895.svg[cabeamento de prateleira para prateleira]

E . Controlador de cabos A às gavetas de unidades. .. Controladora A porta 0a a IOM B porta 1 na primeira gaveta de unidades na stack. .. Controladora A porta 0b1 para IOM A porta 3 na última gaveta de unidades na stack.

Imagem::../media/oie_cable_mini_sas_HD_to_mini_sas_HD.svg[Mini SAS to mini SAS Connector]

*Cabos HD mini-SAS HD para mini-SAS HD*

Imagem::../media/dwr-2800_controller1-to shelves_IEOPS-896.svg[Controller A to shelf Connection]

E . Conecte o controlador B às gavetas de unidades. .. Controladora B porta 0a a IOM A porta 1 na primeira gaveta de unidades na stack. .. Porta 0B1 da controladora B para porta IOM B 3 na última gaveta de unidades na stack.

Imagem::../media/oie_cable_mini_sas_HD_to_mini_sas_HD.svg[Mini SAS to mini SAS Connector]

*Cabos HD mini-SAS HD para mini-SAS HD*

Imagem::../media/dwr-2800_controller2-to shelves_IEOPS-897.svg[Controller B to shelf Connection]
