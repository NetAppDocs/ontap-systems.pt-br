...
summary: Antes de substituir a mídia de inicialização no seu sistema FAS2800, certifique-se de atender aos requisitos necessários para uma substituição bem-sucedida. 
---
= Requisitos para recuperação automatizada de mídia de inicialização - FAS2800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
