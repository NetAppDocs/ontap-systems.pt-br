...
summary: Mantenha o hardware FAS2800 
---
= Mantenha o hardware FAS2800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Para o sistema de armazenamento FAS2800, pode executar procedimentos de manutenção nos seguintes componentes.
