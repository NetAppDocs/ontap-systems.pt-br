...
---
= Substitua o controlador no seu sistema AFF A70 ou AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.O que se segue?
Após substituir o controlador AFF A70 ou AFF A90 com defeito, você precisalink:controller-replace-system-config-restore-and-verify.html["restaure a configuração do sistema"] .
