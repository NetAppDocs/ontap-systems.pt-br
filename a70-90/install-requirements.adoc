...
---
= Verifique os requisitos para a instalação do seu AFF A70 ou AFF A90 sistema de storage
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image::../media/drw_a70-90_weight_icon_ieops-1730.svg[Ícone de aviso de peso AFF A90 AFF A70 e C80]
