...
summary: Substitua um DIMM no sistema AFF A70 ou AFF A90 quando forem detetados erros corrigíveis excessivos ou incorrigíveis. Esses problemas, muitas vezes causados por uma única falha de DIMM, podem impedir que o sistema de armazenamento inicialize o ONTAP. 
---
...
[role="lead"]
Substitua um DIMM no sistema AFF A70 ou AFF A90 quando forem detetados erros corrigíveis excessivos ou incorrigíveis. Esses problemas, muitas vezes causados por uma única falha de DIMM, podem impedir que o sistema de armazenamento inicialize o ONTAP.
