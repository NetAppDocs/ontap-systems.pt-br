...
summary: Substitua a bateria do relógio de tempo real, comumente conhecida como bateria tipo moeda, no seu sistema AFF A70 ou AFF A90 para garantir que os serviços e aplicativos que dependem da sincronização precisa de tempo permaneçam operacionais. 
---
= Substitua a bateria do relógio em tempo real no seu sistema AFF A70 ou AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua a bateria de relógio em tempo real (RTC), comumente conhecida como bateria de célula tipo moeda, em seu sistema AFF A70 ou AFF A90 para garantir que os serviços e aplicativos que dependem de sincronização precisa de tempo permaneçam operacionais.
