...
summary: Restaure a criptografia na Mídia de inicialização de substituição em seu sistema AFF A70 ou AFF A90 para garantir a proteção contínua dos dados. Esse processo envolve verificar a disponibilidade das chaves, reaplicar as configurações de criptografia e confirmar o acesso seguro aos seus dados. 
---
= Restaurar criptografia - AFF A70 e AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Restaure a criptografia na Mídia de inicialização de substituição em seu sistema AFF A70 ou AFF A90 para garantir a proteção contínua dos dados. Esse processo envolve verificar a disponibilidade das chaves, reaplicar as configurações de criptografia e confirmar o acesso seguro aos seus dados.
