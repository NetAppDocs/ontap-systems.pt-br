...
---
= Fluxo de trabalho de substituição dos controladores AFF A70 e AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua o controlador do seu sistema de armazenamento AFF A70 ou AFF A90 desligando o controlador com defeito, removendo e substituindo o controlador, restaurando a configuração do sistema e devolvendo o controle dos recursos de armazenamento ao controlador de substituição.
