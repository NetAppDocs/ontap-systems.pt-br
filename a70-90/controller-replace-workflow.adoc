...
summary: A substituição do controlador AFF A70 e AFF A90 inclui etapas para desligar o controlador, remover e substituir o controlador, reconfigurar as definições do sistema e verificar as operações do sistema. 
---
...
[role="lead"]
A substituição do controlador AFF A70 e AFF A90 inclui etapas para desligar o controlador, remover e substituir o controlador, reconfigurar as definições do sistema e verificar as operações do sistema.
