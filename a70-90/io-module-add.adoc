...
summary: Você pode adicionar um módulo de e/S ao seu sistema de armazenamento AFF A70 e AFF A90 quando houver slots vazios disponíveis ou quando todos os slots estiverem totalmente preenchidos. 
---
= Adicione um módulo de E/S ao seu AFF A70 ou AFF A90 para melhorar a conectividade de rede
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Adicione um módulo de e/S ao seu sistema AFF A70 ou AFF A90 para melhorar a conetividade de rede e expandir a capacidade do seu sistema de lidar com o tráfego de dados.

Você pode adicionar um módulo de e/S ao seu sistema quando houver slots vazios disponíveis ou quando todos os slots estiverem totalmente preenchidos.
