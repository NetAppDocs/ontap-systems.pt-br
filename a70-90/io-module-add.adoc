...
---
= Adicionar módulo de e/S - AFF A70 e AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Você pode adicionar um módulo de e/S ao seu sistema de armazenamento AFF A70 e AFF A90 quando houver slots vazios disponíveis ou quando todos os slots estiverem totalmente preenchidos.
...
. A partir do nó saudável, restaure o giveback automático se você o tiver desativado usando o seguinte comando:
+
`storage failover modify -node local -auto-giveback true`

. Se o AutoSupport estiver ativado, restaure a criação automática de casos usando o seguinte comando:
+
