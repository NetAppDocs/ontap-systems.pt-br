...
---
= Conecte seu hardware AFF A70 ou AFF A90 por cabo para conectividade de rede e armazenamento
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
--
Utilize o cabo 100 GbE para conectar as portas e1a e e7a dos Controladores A e B aos switches de rede do cluster A e B.
...
NOTE: Não utilize as portas e1b e e7b para conexões de rede do host. Use uma placa de host separada.
...
. Conecte suas placas de rede 10/25 GbE aos switches da sua rede host.
+
...
.Sobre esta tarefa
Os sistemas de storage AFF A70 e AFF A90 suportam gabinetes NS224 com o módulo NSM100 ou NSM100B. As principais diferenças entre os módulos são:
...
. Conecte a porta e11b do controlador A à porta e0b do NSM B.
+
...
.. Conecte a porta e11b à prateleira 2, porta e0b do NSM A.
+
...
====
.O que se segue?
Depois de conectar os cabos do hardware do seu AFF A70 ou AFF A90, você link:install-power-hardware.html["Ligue o sistema de storage AFF A70 ou AFF A90"].
