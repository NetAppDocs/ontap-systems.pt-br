...
summary: Comece a substituir o chassi no sistema de storage AFF A70 ou AFF A90, revisando os requisitos de substituição, desligando os controladores, removendo e substituindo o chassi e verificando as operações do sistema. 
---
...
[role="lead"]
Comece a substituir o chassi no sistema de storage AFF A70 ou AFF A90, revisando os requisitos de substituição, desligando os controladores, removendo e substituindo o chassi e verificando as operações do sistema.
