...
---
= Restaure e verifique a configuração do controlador no seu sistema AFF A70 ou AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.O que se segue?
Depois de restaurar e verificar a configuração do sistema para o seu sistema AFF A70 ou AFF A90, é necessário link:controller-replace-recable-reassign-disks.html["devolva o controlador"].
