...
summary: Depois de instalar o hardware de rack para seu sistema de storage AFF A70 ou AFF A90 e instalar os cabos das controladoras e gavetas de storage, ligue as controladoras e as gavetas de storage. 
---
= Ligue o sistema de armazenamento - AFF A70 e AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Depois de instalar o hardware de rack para seu sistema de storage AFF A70 ou AFF A90 e instalar os cabos das controladoras e gavetas de storage, ligue as controladoras e as gavetas de storage.
...
+
image::../media/drw_a1k_70-90_power_source_icon_ieops-1700.svg[Diagrama de ligação de alimentação AFF A1K AFF A70 ou AFF A90 ou FAS70 ou FAS90]
...
. Fixe os cabos de alimentação usando o dispositivo de fixação em cada fonte de alimentação. :a1k-a70-90!:


.O que se segue?
Depois de ligar o seu sistema de armazenamento AFF A70 ou AFF A90 , você https://docs.netapp.com/us-en/ontap/software_setup/workflow-summary.html["configure seu cluster"] .
