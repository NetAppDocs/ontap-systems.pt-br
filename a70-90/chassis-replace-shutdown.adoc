...
summary: Desligue os controladores do sistema de storage AFF A70 ou AFF A90 para evitar a perda de dados e garantir a estabilidade do sistema ao substituir o chassi. 
---
= Desligue seus controladores AFF A70 ou AFF A90 para substituir o chassi
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Desligue os controladores do sistema de storage AFF A70 ou AFF A90 para evitar a perda de dados e garantir a estabilidade do sistema ao substituir o chassi.
