...
summary: Desligue os controladores do seu sistema de storage AFF A70 ou AFF A90 quando precisar substituir o chassi. Antes de realizar a manutenção ou a substituição de componentes, é fundamental desligar o controlador de forma segura para evitar a perda de dados e garantir a estabilidade do sistema. 
---
= Desligue os controladores - AFF A70 e AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Desligue os controladores do seu sistema de storage AFF A70 ou AFF A90 quando precisar substituir o chassi. Antes de realizar a manutenção ou a substituição de componentes, é fundamental desligar o controlador de forma segura para evitar a perda de dados e garantir a estabilidade do sistema.
