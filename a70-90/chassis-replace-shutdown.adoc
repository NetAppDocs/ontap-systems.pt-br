...
summary: Desligue os controladores do seu sistema de storage AFF A70 ou AFF A90 quando precisar substituir o chassi. É fundamental desligar o controlador com segurança para evitar a perda de dados e garantir a estabilidade do sistema. 
---
...
[role="lead"]
Desligue os controladores do seu sistema de storage AFF A70 ou AFF A90 quando precisar substituir o chassi. É fundamental desligar os controladores com segurança para evitar a perda de dados e garantir a estabilidade do sistema.
