...
[role="lead"]
Desligue o controlador desativado no sistema de armazenamento AFF A70 ou AFF A90 para evitar a perda de dados e garantir a estabilidade do sistema ao substituir a Mídia de inicialização.
