...
[role="lead"]
Você precisa remover componentes específicos dos módulos do controlador antes de remover o chassi danificado, substituir o chassi, reinstalar os componentes nos módulos corretos do controlador e, em seguida, retornar os controladores à operação normal.
