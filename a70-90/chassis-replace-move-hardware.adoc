...
summary: Substitua o chassi do seu AFF A70 ou AFF A90 quando uma falha de hardware exigir. O processo de substituição envolve a remoção dos controladores e das fontes de alimentação, a remoção das unidades de disco, a instalação do chassi de substituição e a reinstalação dos componentes do chassi. 
---
= Substitua o chassi do seu sistema AFF A70 ou AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
