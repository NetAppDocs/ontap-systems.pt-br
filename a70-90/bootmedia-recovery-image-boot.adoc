...
summary: Depois de instalar o novo dispositivo multimédia de arranque no seu sistema AFF A70 ou AFF A90, pode iniciar a imagem de recuperação a partir de uma unidade USB e restaurar a configuração a partir do nó do parceiro. 
---
...
[role="lead"]
Depois de instalar o novo dispositivo multimédia de arranque no seu sistema AFF A70 ou AFF A90, pode iniciar a imagem de recuperação a partir de uma unidade USB e restaurar a configuração a partir do nó do parceiro.
