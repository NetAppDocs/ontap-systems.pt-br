...
summary: Se a Mídia de inicialização no sistema AFF A70 ou AFF A90 estiver corrompida, você poderá inicializar a imagem de recuperação de uma unidade USB e restaurar a configuração do nó do parceiro. 
---
...
[role="lead"]
Se a Mídia de inicialização no sistema AFF A70 ou AFF A90 estiver corrompida, você poderá inicializar a imagem de recuperação de uma unidade USB e restaurar a configuração do nó do parceiro.
