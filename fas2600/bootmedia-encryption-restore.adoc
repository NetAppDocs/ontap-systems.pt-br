...
summary: Restaurar a configuração de criptografia na mídia de inicialização de substituição para um sistema FAS2600. Este procedimento inclui a conclusão das etapas pós-substituição para sistemas com Onboard Key Manager, NetApp Storage Encryption ou NetApp Volume Encryption ativados, a fim de garantir o acesso seguro aos dados e o funcionamento adequado do sistema. 
---
