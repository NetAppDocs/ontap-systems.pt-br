...
summary: Substitua a mídia de inicialização com falha em um módulo controlador FAS2600. O sistema FAS2600 suporta apenas procedimentos manuais de recuperação de mídia de inicialização. A recuperação automática de mídia de inicialização não é suportada. 
---
= Substitua o suporte de arranque - FAS2600
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
