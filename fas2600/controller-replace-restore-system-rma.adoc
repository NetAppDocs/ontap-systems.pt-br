...
summary: Para restaurar o funcionamento completo do seu sistema, você deve restaurar a configuração de NetApp Storage Encryption, se necessário, instalar as licenças para o novo controlador e devolver a peça com defeito à NetApp, conforme descrito nas instruções de RMA fornecidas com o kit. 
---
