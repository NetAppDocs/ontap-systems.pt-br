...
summary: Inicialize a imagem de recuperação do ONTAP a partir da unidade USB em um sistema FAS2600 para restaurar a mídia de inicialização. O sistema FAS2600 suporta apenas procedimentos manuais de recuperação de mídia de inicialização. A recuperação automática de mídia de inicialização não é suportada. 
---
= Inicie a imagem de recuperação - FAS2600
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
