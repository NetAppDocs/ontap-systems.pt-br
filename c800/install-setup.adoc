...
---
= Instale e configure seu sistema de storage AFF C800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* link:../c800/install-quick-guide.html["Passos rápidos"]
+
Um PDF imprimível de instruções passo a passo com links em direto para conteúdo adicional.

* link:../c800/install-videos.html["Passos de vídeo"]
+
Instruções passo a passo em vídeo.

* link:../c800/install-detailed-guide.html["Passos detalhados"]
+
