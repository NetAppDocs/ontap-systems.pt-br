...
summary: Substitua a bateria do relógio de tempo real, comumente conhecida como bateria tipo moeda, no seu sistema AFF C800 para garantir que os serviços e aplicativos que dependem da sincronização precisa do tempo permaneçam operacionais. 
---
= Substitua a bateria do relógio em tempo real do seu AFF C800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua a bateria do relógio de tempo real (RTC), geralmente conhecida como bateria tipo moeda, em seu sistema AFF C800 para garantir que os serviços e aplicativos que dependem da sincronização precisa do tempo permaneçam operacionais.
