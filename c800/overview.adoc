...
sidebar: sidebar 
summary: Especificações principais para o grupo de plataformas C800 
---
...
[role="lead"]
A seguir estão especificações selecionadas para o sistema de armazenamento AFF C800 em um único par de alta disponibilidade.  Visite o NetApp Hardware Universe (HWU) para obter as especificações completas deste sistema de armazenamento.
...
* Tipo: NAS; Pares HA: 12; Capacidade bruta: 88,4 PB / 78,5 PiB; Memória máxima: 15360 GB
