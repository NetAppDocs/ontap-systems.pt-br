...
summary: Substitua um DIMM no seu sistema AFF C800 se forem detectados erros de memória excessivos, corrigíveis ou não corrigíveis. Esses erros podem impedir que o sistema de storage inicialize o ONTAP. 
---
= Substitua um DIMM no seu AFF C800 para corrigir erros de memória
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
