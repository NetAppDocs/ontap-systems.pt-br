...
---
= Substitua uma ventoinha no seu sistema AFF C800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua o módulo de ventoinha do seu sistema AFF C800 quando uma ventoinha falhar ou não estiver a funcionar de forma eficiente, uma vez que isto pode afetar o arrefecimento do sistema e o seu desempenho geral.  O processo de substituição envolve desligar o controlador com defeito, removê-lo, substituir o módulo do ventilador, reinstalar o controlador e, em seguida, devolver a peça com defeito à NetApp.
...
Remova o módulo controlador do chassi ao substituir o módulo controlador ou substituir um componente interno do módulo controlador.
