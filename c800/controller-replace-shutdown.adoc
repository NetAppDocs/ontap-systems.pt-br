...
---
= Desligue o controlador defeituoso do seu sistema AFF C800 antes de substituí-lo
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Desligue o controlador do seu sistema de armazenamento AFF C800 para evitar perda de dados e garantir a estabilidade do sistema ao substituir o controlador.
