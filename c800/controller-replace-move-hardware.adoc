...
---
= Substitua o hardware do módulo do controlador - AFF C800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua o controlador do seu sistema AFF C800 quando uma falha de hardware assim o exigir. O processo de substituição envolve remover o controlador danificado, mover os componentes para o controlador de substituição, instalar o controlador de substituição e reiniciá-lo.
...
Transfira os módulos de ventoinha para o módulo controlador de substituição.
...
Remova os cabos riser PCIe do módulo controlador com defeito.
...
Transfira os módulos DIMM do sistema para o módulo controlador de substituição.
...
Transfira o NVDIMMS para o módulo controlador de substituição.
...
Instale os cabos de extensão no módulo controlador de substituição.
...
.O que se segue?
Após substituir o controlador AFF C800 defeituoso, você precisalink:controller-replace-system-config-restore-and-verify.html["restaure a configuração do sistema"]
