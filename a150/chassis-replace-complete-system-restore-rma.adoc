...
---
= Conclua a substituição do chassi do seu AFF A150
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Verifique o estado de HA do chassi, reverta os agregados, e devolva a peça com falha para NetApp para concluir a substituição do chassi do seu sistema AFF A150.
