...
---
= Escolha como instalar seu sistema de storage AFF A150
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Escolha o formato que preferir para instalar seu sistema de storage AFF A150: instruções detalhadas passo a passo, guia gráfico rápido ou instruções em vídeo.

* link:../a150/install-quick-guide.html["Passos rápidos"]
+
Um PDF imprimível de instruções passo a passo com links em direto para conteúdo adicional.

* link:../a150/install-videos.html["Passos de vídeo"]
+
Instruções passo a passo em vídeo.

* link:../a150/install-detailed-guide.html["Passos detalhados"]
+
