...
summary: Você substitui um chassi com problema por um novo chassi do mesmo modelo que o chassi com problema. 
---
= Analise os requisitos para a substituição do chassi no seu sistema AFF A150
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Antes de substituir o chassi no seu sistema AFF A150, certifique-se de que atende aos requisitos necessários para uma substituição bem-sucedida. Isso inclui verificar se todos os outros componentes do sistema estão funcionando corretamente e entender que o procedimento é disruptivo e requer o desligamento de ambos os controladores.
