...
---
= Reinstale os cabos do sistema e reatribua os discos no seu sistema AFF A150
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Reconecte o armazenamento, confirme a reatribuição do disco e restaure a NetApp Storage Encryption para que seu sistema AFF A150 volte a funcionar normalmente.
