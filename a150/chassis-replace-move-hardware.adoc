...
---
= Substitua o chassi do seu sistema AFF A150
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua o chassi do seu sistema AFF A150 quando uma falha de hardware exigir. O processo de substituição envolve mover as fontes de alimentação, unidades e módulos controladores do chassi com problema para o chassi de substituição.
