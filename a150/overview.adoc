...
* Profundidade: 19,0” (24,1” com suporte para gerenciamento de cabos)
...
* Ruído acústico: Potência sonora declarada (LwAd): 6,9; Pressão sonora (LpAm) (posições de observador): 51,0 dB
