...
---
= Instale seu sistema AFF A150 usando instruções em vídeo
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Instale e conecte os cabos do seu sistema de storage AFF A150 seguindo as instruções passo a passo em vídeo.
