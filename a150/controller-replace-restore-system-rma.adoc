...
---
= Conclua a substituição do controlador do seu sistema AFF A150
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Para concluir a substituição do controlador do seu sistema AFF A150, restaure a configuração de criptografia de storage NetApp (se necessário), confirme se as interfaces lógicas (LIFs) estão reportando às suas portas de origem, execute uma verificação de integridade do cluster e devolva a unidade com falha para a NetApp.
