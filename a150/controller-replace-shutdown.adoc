...
---
= Desligue o controlador do seu sistema AFF A150 antes de substituir o controlador
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Desligue o controlador com defeito no seu sistema de storage AFF A150 para evitar perda de dados e garantir a estabilidade do sistema ao substituir o controlador.
