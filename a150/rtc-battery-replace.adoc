...
---
= Substitua a bateria do relógio em tempo real do seu sistema AFF A150
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua a bateria do relógio de tempo real (RTC) do seu AFF A150 para garantir que os serviços e aplicativos que dependem da sincronização precisa do tempo continuem funcionando.
