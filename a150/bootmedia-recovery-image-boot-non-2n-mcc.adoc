...
---
= Inicialize a imagem de recuperação no seu sistema AFF A150 usando o processo de recuperação de inicialização manual
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Após instalar a nova mídia de inicialização no seu sistema AFF A150, inicialize a imagem de recuperação do ONTAP a partir de uma unidade USB para restaurar o sistema de arquivos e verificar as variáveis de ambiente.
