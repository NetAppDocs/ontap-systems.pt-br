...
---
= Substitua a fonte de alimentação com o sistema AFF A300 em funcionamento.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua a fonte de alimentação do seu AFF A300 em funcionamento desligando, desconectando e removendo a unidade com defeito e, em seguida, instalando e reconectando a unidade de substituição.
