...
---
= Desligue seus controladores AFF A300 para substituir o chassi
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
== Opção 1: Desligar o controlador
...
== Opção 2: Os controladores estão em uma configuração de MetroCluster de dois nós
