...
summary: Para substituir o chassi, você deve desligar o controlador. Este procedimento é disruptivo. Para um cluster de dois nós, você terá uma interrupção de serviço completa e uma interrupção parcial em um cluster de vários nós. 
---
...
[role="lead"]
Você deve desligar os controladores antes de substituir o chassi.
...
== Opção 2: Os controladores estão em um MetroCluster de dois nós
