...
---
= Substitua o chassi no seu sistema AFF A300
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua o chassi do seu sistema AFF A300 transferindo as fontes de alimentação, ventoinhas e módulos de controle do chassi com problema para o chassi de substituição.
