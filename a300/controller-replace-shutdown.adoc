...
---
= Desligue o controlador defeituoso do seu sistema AFF A300 antes de substituí-lo
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Desligue o controlador com defeito no seu sistema AFF A300 antes de substituí-lo, utilizando o procedimento adequado para sua configuração.
