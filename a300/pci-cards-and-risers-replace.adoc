...
---
= Substitua uma placa PCIe no seu sistema AFF A300
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua uma placa PCIe no seu AFF A300 desconectando os cabos, removendo a placa, instalando a substituição e reconectando os cabos.
