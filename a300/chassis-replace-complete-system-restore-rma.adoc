...
---
= Conclua a substituição do chassi do seu sistema AFF A300
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Conclua a substituição do chassi do seu sistema AFF A300 verificando o estado de HA do chassi, revertendo os agregados se necessário e devolvendo o componente com falha para a NetApp.
