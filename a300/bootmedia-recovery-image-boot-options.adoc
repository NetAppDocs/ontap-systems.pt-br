...
summary: O procedimento para inicializar o controlador com defeito a partir da imagem de recuperação depende de o sistema estar em uma configuração MetroCluster de dois nós. O sistema AFF A300 suporta apenas procedimentos manuais de recuperação de mídia de inicialização. 
---
= Inicialize a imagem de recuperação no seu sistema AFF A300
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
O procedimento para inicializar o controlador com defeito a partir da imagem de recuperação depende de o sistema estar em uma configuração MetroCluster com dois controladores. O sistema AFF A300 suporta apenas procedimentos manuais de recuperação de mídia de inicialização. A recuperação automática de mídia de inicialização não é suportada.
