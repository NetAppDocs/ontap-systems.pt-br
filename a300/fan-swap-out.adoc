...
---
= Troque a ventoinha do seu sistema AFF A300 com o sistema em funcionamento.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua o módulo de ventoinha do seu sistema AFF A300 sem interromper o funcionamento, para manter o fluxo de ar e o resfriamento adequados do sistema.
