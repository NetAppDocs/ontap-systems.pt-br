...
summary: Restaure a criptografia na mídia de inicialização de substituição. Conclua as etapas específicas para sistemas que têm o Onboard Key Manager, NetApp Storage Encryption ou NetApp Volume Encryption ativados. O sistema AFF A300 suporta apenas procedimentos manuais de recuperação da mídia de inicialização. 
---
= Restaure a criptografia na mídia de inicialização do seu sistema AFF A300
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Restaure a criptografia na mídia de inicialização de substituição. O sistema AFF A300 suporta apenas procedimentos manuais de recuperação de mídia de inicialização. A recuperação automática de mídia de inicialização não é suportada.
