...
summary: 'Para restaurar o sistema para a operação completa, você deve restaurar a configuração de criptografia de armazenamento NetApp (se necessário), instalar licenças para a nova controladora e devolver a peça com falha ao NetApp, conforme descrito nas instruções de RMA fornecidas com o kit.' 
---
