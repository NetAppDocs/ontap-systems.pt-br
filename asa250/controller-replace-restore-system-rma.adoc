...
summary: Para restaurar o funcionamento completo do seu sistema, restaure a configuração de NetApp Storage Encryption, se necessário, instale as licenças para o novo controlador e devolva a peça com defeito para a NetApp. 
---
= Conclua a substituição do controlador do seu sistema ASA A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Para concluir a substituição do controlador do seu sistema ASA A250 e garantir o pleno funcionamento, você deve restaurar a configuração de NetApp Storage Encryption (se necessário), instalar as licenças para o novo controlador e devolver a peça com defeito para a NetApp, conforme descrito nas instruções de RMA fornecidas com o kit.
