...
summary: Comece a substituir o controlador no seu sistema de storage ASA A250 desligando o controlador com defeito, removendo e substituindo o controlador, reconfigurando as configurações do sistema e verificando as operações do sistema. 
---
= Fluxo de trabalho de substituição do controlador - ASA A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua o controlador no seu sistema de storage ASA A250 desligando o controlador com defeito, removendo e substituindo o controlador, restaurando a configuração do sistema e devolvendo o controle dos recursos de storage ao controlador de substituição.
