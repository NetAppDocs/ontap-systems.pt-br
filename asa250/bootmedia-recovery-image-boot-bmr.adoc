...
summary: Após instalar o novo dispositivo de mídia de inicialização no seu sistema ASA A250, você pode iniciar o processo automatizado de recuperação da mídia de inicialização para restaurar a configuração do nó parceiro. 
---
= Restaure a imagem de inicialização no seu sistema ASA A250 usando o processo automatizado de recuperação de inicialização
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Após instalar o novo dispositivo de mídia de inicialização no seu sistema ASA A250, você pode iniciar o processo automatizado de recuperação da mídia de inicialização para restaurar a configuração do nó parceiro. Durante o processo de recuperação, o sistema verifica se a criptografia está habilitada e determina o tipo de criptografia de chave em uso. Se a criptografia de chave estiver habilitada, o sistema o guiará pelos passos apropriados para restaurá-la.
...
. [[restore-key-manager]] Restaure o gerenciador de chaves usando o procedimento apropriado para sua configuração:
+
[role="tabbed-block"]
====
...
. [[reenable-auto-giveback]]Se o giveback automático foi desativado, reative-o:
+
