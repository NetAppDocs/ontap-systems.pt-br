...
* É necessário desligar o ciclo de energia de uma prateleira (desligue o interrutor de alimentação na parte traseira da prateleira SAS, aguarde o período de tempo adequado e, em seguida, ligue novamente a alimentação) para que a ID da prateleira entre em vigor.
