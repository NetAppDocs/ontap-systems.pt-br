...
sidebar: sidebar 
keywords: ASA A900 
summary: 'Para realizar a substituição a quente de um módulo de alimentação do controlador de desestágio (DCPM), que contém a bateria NVRAM11, você deve localizar o módulo DCPM com defeito, removê-lo do chassi e instalar o módulo DCPM de substituição.' 
---
= Substitua o DCPM que contém a bateria NVRAM11 no seu sistema ASA A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
