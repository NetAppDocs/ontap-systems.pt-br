...
* Profundidade: 28,8” (36,8” com suporte para gerenciamento de cabos)
...
* Ruído acústico: Potência sonora declarada (LwAd): 7,4; Pressão sonora (LpAm) (posições de observador): 65,0 dB
