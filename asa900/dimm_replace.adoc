...
sidebar: sidebar 
keywords:  
summary: 'Você deve substituir um módulo DIMM no controlador quando o sistema registrar um número crescente de códigos de correção de erros corrigíveis (ECC). Caso contrário, o sistema entrará em pânico.' 
---
