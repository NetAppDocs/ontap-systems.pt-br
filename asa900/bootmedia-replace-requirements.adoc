...
.O que se segue?
Depois de revisar os requisitos para substituir a mídia de inicialização, você precisalink:bootmedia_encryption_preshutdown_checks.html["verifique o suporte e o status da chave de criptografia na mídia de inicialização"] .
