...
summary: 'Você substitui a bateria do relógio de tempo real (RTC) no módulo controlador para que os serviços e aplicativos do seu sistema que dependem da sincronização precisa do tempo continuem funcionando.' 
---
= Substitua a bateria do relógio em tempo real do seu ASA A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
