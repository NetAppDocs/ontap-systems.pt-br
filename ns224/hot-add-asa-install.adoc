...
summary: Instale a prateleira NS224 em um gabinete ou rack de telecomunicações, conecte os cabos de alimentação e defina o ID da prateleira para o seu sistema ASA. 
---
= Instale uma prateleira NS224 no seu sistema ASA
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Instale a prateleira NS224 em um gabinete ou rack de telecomunicações, conecte os cabos de alimentação e defina o ID da prateleira para o seu sistema ASA.
...
.O que se segue?
Após instalar sua prateleira, link:hot-add-asa-cable-overview.html["Conecte o cabo na sua shelf"].
