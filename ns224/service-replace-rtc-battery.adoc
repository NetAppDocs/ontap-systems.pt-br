...
summary: 'Você pode substituir uma bateria de relógio em tempo real (RTC) com falha sem interrupções em um compartimento de unidade de NS224 TB que esteja ligado e enquanto e/S estiver em andamento.' 
---
= Substitua a bateria do relógio de tempo real NS224
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
