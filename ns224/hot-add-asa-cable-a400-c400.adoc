...
summary: Conecte o seu shelf NS224 ao seu sistema ASA A400 ou ASA C400 de forma que cada shelf tenha duas conexões com cada controlador no par de HA. 
---
= Conecte uma prateleira NS224 ao seu sistema ASA A400 ou ASA C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Conecte o seu shelf NS224 ao seu sistema ASA A400 ou ASA C400 de forma que cada shelf tenha duas conexões com cada controlador no par de HA.
...
.O que vem a seguir
Se você desativou a atribuição automática de unidades como parte da preparação para este procedimento, será necessário atribuir manualmente a propriedade da unidade e, em seguida, reativar a atribuição automática de unidades, se necessário. Acesse link:hot-add-asa-complete.html["Complete o hot-add"].
