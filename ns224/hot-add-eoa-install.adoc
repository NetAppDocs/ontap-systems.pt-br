...
summary: Instale a prateleira NS224 em um gabinete ou rack, conecte os cabos de alimentação e defina o ID da prateleira para o seu sistema em fim de disponibilidade. 
---
= Instale uma prateleira NS224 no seu sistema em fim de disponibilidade
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Instale a prateleira NS224 em um gabinete ou rack, conecte os cabos de alimentação e defina o ID da prateleira para o seu sistema em fim de disponibilidade.

.Antes de começar
* Certifique-se de ter um clipe de papel com uma das extremidades retas ou uma caneta esferográfica de ponta fina.
+
...
.O que se segue?
Após instalar sua prateleira, link:hot-add-eoa-cable-overview.html["Conecte o cabo na sua shelf"].
