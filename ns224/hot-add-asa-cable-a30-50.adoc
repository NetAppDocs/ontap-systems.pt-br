...
summary: Conecte o seu shelf NS224 ao seu sistema ASA A30 ou ASA A50 de forma que cada shelf tenha duas conexões com cada controlador no par de HA. 
---
= Conecte uma prateleira NS224 ao seu sistema ASA A30 ou ASA A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Conecte o seu shelf NS224 ao seu sistema ASA A30 ou ASA A50 de forma que cada shelf tenha duas conexões com cada controlador no par de HA.

É possível adicionar até duas gavetas NS224 a um par de HA ASA A30 ou ASA A50 quando for necessário armazenamento adicional (para a gaveta interna).
