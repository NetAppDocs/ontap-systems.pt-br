...
summary: Conecte sua shelf NS224 ao seu sistema AFF A700 de forma que cada shelf tenha duas conexões com cada controlador no par de HA. 
---
= Conecte uma shelf NS224 ao seu sistema AFF A700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Conecte sua shelf NS224 ao seu sistema AFF A700 de forma que cada shelf tenha duas conexões com cada controlador no par de HA.
