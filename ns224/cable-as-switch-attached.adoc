...
summary: 'Se você tiver um sistema no qual os NS224 compartimentos de unidades precisem ser cabeados como storage conectado ao switch (não storage com conexão direta), use as informações fornecidas.' 
---
= Conecte as prateleiras NS224 como armazenamento conectado ao switch
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
