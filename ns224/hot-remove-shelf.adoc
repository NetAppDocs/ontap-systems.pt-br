...
summary: 'É possível remover a quente um compartimento de unidade de NS224 TB que teve os agregados removidos das unidades, em um par de HA ativo e fornecendo dados (e/S em andamento).' 
---
= Remover uma prateleira NS224 com o equipamento em funcionamento
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
