...
summary: Se você desativou a atribuição automática de unidades, atribua manualmente a propriedade da unidade e reative a atribuição automática de unidades para o seu sistema AFF. 
---
= Conclua a adição a quente da shelf NS224 para o seu sistema AFF
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
