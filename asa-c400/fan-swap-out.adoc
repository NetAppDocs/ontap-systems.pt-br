...
---
= Troque a ventoinha do seu sistema ASA C400 com o sistema em funcionamento.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua o módulo de ventoinha com falha no seu sistema ASA C400 sem interromper o funcionamento, para manter o fluxo de ar adequado e o resfriamento do sistema.
