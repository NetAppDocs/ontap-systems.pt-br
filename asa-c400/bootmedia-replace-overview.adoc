...
summary: A Mídia de inicialização armazena um conjunto primário e secundário de arquivos de imagem de inicialização que o sistema usa quando ele é inicializado. 
---
= Saiba mais sobre a substituição da mídia de inicialização no seu sistema ASA C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
