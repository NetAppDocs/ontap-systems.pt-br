...
summary: Substitua uma fonte de alimentação no seu sistema ASA C400 desconectando a fonte de alimentação da fonte de energia, desligando o cabo de força, removendo a fonte antiga, instalando a fonte de reposição e, em seguida, reconectando-a à fonte de energia. 
---
= Substitua a fonte de alimentação com o sistema ASA C400 em funcionamento.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
