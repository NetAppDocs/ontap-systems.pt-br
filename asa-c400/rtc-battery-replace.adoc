...
summary: Substitua a bateria do relógio em tempo real no módulo controlador do seu ASA C400 para garantir que os serviços e aplicativos que dependem da sincronização precisa do tempo continuem funcionando. 
---
= Substitua a bateria do relógio em tempo real do seu ASA C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
