...
summary: Para restaurar o funcionamento completo do seu sistema ASA C400, restaure a configuração de criptografia de armazenamento NetApp, se necessário, instale as licenças para o novo controlador e devolva a peça com defeito para a NetApp. 
---
= Restauração completa do sistema - ASA C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
