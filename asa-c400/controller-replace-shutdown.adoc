...
summary: Desligue o controlador no seu sistema de storage ASA C400 para evitar perda de dados e garantir a estabilidade do sistema ao substituir o controlador. 
---
= Desligue o controlador defeituoso do seu sistema ASA C400 antes de substituí-lo
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Desligue o controlador no seu sistema de storage ASA C400 para evitar perda de dados e garantir a estabilidade do sistema ao substituir o controlador.
...
====
.O que se segue?
Após desligar o controlador ASA C400, você precisa link:controller-replace-move-hardware.html["substitua o controlador"].
