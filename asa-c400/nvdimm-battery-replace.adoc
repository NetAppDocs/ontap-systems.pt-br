...
---
= Substitua a bateria NVDIMM no seu sistema ASA C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua a bateria NVDIMM no seu sistema ASA C400 removendo o módulo controlador, substituindo a bateria e reinstalando o módulo controlador.
