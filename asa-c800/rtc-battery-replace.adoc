...
summary: Substitua a bateria do relógio de tempo real, comumente conhecida como bateria tipo moeda, em seu sistema ASA C800 para garantir que os serviços e aplicativos que dependem da sincronização precisa de tempo permaneçam operacionais. 
---
= Substitua a bateria do relógio em tempo real do seu ASA C800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua a bateria do relógio de tempo real (RTC), comumente conhecida como bateria tipo moeda, em seu sistema ASA C800 para garantir que os serviços e aplicativos que dependem da sincronização precisa de tempo permaneçam operacionais.
