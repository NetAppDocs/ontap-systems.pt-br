...
---
= Substitua o chassi no seu sistema ASA C800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.O que se segue?
Após substituir o chassi ASA C800 danificado e reinstalar os componentes, você precisa...link:chassis-replace-complete-system-restore-rma.html["complete a substituição do chassis"]
