...
summary: Para começar a substituir o controlador do seu sistema de armazenamento ASA C800, desligue o controlador com defeito, remova e substitua o controlador, reconfigure as definições do sistema e verifique o funcionamento do sistema. 
---
= Fluxo de trabalho de substituição do controlador - ASA C800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua o controlador do seu sistema de armazenamento ASA C800 desligando o controlador com defeito, removendo e substituindo o controlador, restaurando a configuração do sistema e devolvendo o controle dos recursos de armazenamento ao controlador de substituição.
