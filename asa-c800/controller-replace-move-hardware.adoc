...
---
= Substitua o controlador no seu sistema ASA C800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua o controlador do seu sistema ASA C800 quando uma falha de hardware assim o exigir. O processo de substituição envolve remover o controlador danificado, mover os componentes para o controlador de substituição, instalar o controlador de substituição e reiniciá-lo.
...
.O que se segue?
Após substituir o controlador ASA C800 com defeito, você precisa...link:controller-replace-system-config-restore-and-verify.html["restaure a configuração do sistema"]
