...
---
= Substitua a fonte de alimentação com substituição a quente no seu sistema AFF A800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua a fonte de alimentação do seu AFF A800 quando ela falhar ou apresentar defeito. As fontes de alimentação são redundantes e com substituição a quente, portanto, você não precisa desligar o controlador para realizar essa substituição.
