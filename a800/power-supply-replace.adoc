...
---
= Troca a quente de uma fonte de alimentação - AFF A800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua a fonte de alimentação CA ou CC (PSU) do seu sistema AFF A800 quando ela falhar ou apresentar defeito, garantindo que o sistema continue recebendo a energia necessária para uma operação estável.  O processo de substituição envolve desconectar a fonte de alimentação defeituosa da tomada, desconectar o cabo de alimentação, substituir a fonte de alimentação defeituosa e, em seguida, reconectá-la à tomada.
