...
summary: Substitua o NVDIMM no módulo controlador AFF A800 quando o sistema detectar que a vida útil da memória flash está quase no fim ou que o NVDIMM identificado não está saudável. A não substituição de um NVDIMM defeituoso pode causar um pânico no sistema. 
---
= Substitua o NVDIMM no seu sistema AFF A800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua o NVDIMM no seu sistema AFF A800 quando o sistema detectar que a vida útil da memória flash está quase no fim ou que o NVDIMM identificado não está em boas condições; caso contrário, o sistema entrará em pânico.

.Antes de começar
* Certifique-se de que o módulo NVDIMM de substituição que você recebeu da NetApp é compatível com o seu sistema AFF A800 .
* Certifique-se de que todos os outros componentes do sistema de armazenamento estejam funcionando corretamente; caso contrário, entre em contato com o Suporte da NetApp .
...
Localize o NVDIMM no módulo controlador usando a etiqueta do mapa NVDIMM na parte superior do duto de ar e, em seguida, substitua-o.
