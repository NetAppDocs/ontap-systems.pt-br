...
[role="lead"]
Substitua o módulo de ventoinha do seu sistema AFF A800 quando uma ventoinha falhar ou não estiver a funcionar de forma eficiente, pois isso pode afetar o arrefecimento do sistema e o desempenho geral.  O processo de substituição envolve desligar o controlador com defeito, removê-lo, substituir o módulo do ventilador, reinstalar o controlador e, em seguida, devolver a peça com defeito à NetApp.
