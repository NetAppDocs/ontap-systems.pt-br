...
---
= Substitua uma ventoinha no seu sistema AFF A800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua o módulo de ventoinha do seu AFF A800 quando uma ventoinha falhar ou não estiver funcionando de forma eficiente, para manter o resfriamento adequado e evitar problemas de desempenho do sistema.
