...
---
= Substitua uma placa PCIe no seu sistema AFF A800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua uma placa PCIe no seu sistema AFF A800 quando a placa apresentar falha ou precisar de uma atualização. O processo de substituição envolve desconectar os cabos e os módulos SFP ou QSFP, substituir a placa e reconectar os cabos.
