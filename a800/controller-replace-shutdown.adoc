...
---
= Desligue o controlador com problema no seu sistema AFF A800 antes de substituí-lo
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Desligue o controlador do seu sistema de armazenamento AFF A800 para evitar perda de dados e garantir a estabilidade do sistema ao substituir o controlador.
