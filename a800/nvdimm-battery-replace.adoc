...
---
= Substitua a bateria NVDIMM no seu sistema AFF A800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua a bateria NV do seu AFF A800 quando ela começar a perder carga ou falhar, pois ela preserva dados críticos do sistema durante quedas de energia. O processo de substituição envolve a remoção do módulo controlador, a troca da bateria e a reinstalação do módulo controlador.
