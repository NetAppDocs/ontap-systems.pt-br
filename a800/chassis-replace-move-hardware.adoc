...
---
= Substitua o chassi do seu sistema AFF A800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.O que se segue?
Após substituir o chassi AFF A800 danificado e reinstalar os componentes, você precisalink:chassis-replace-complete-system-restore-rma.html["complete a substituição do chassis"]
