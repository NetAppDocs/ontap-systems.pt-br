...
---
= Escolha como instalar seu sistema de storage AFF A800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Escolha o formato que preferir para instalar seu sistema de storage AFF A800: instruções detalhadas passo a passo, guia gráfico rápido ou instruções em vídeo.
