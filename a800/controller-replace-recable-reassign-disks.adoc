...
---
= Reinstale os cabos do sistema e reatribua os discos no seu AFF A800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Devolva o controle dos recursos de armazenamento ao controlador de substituição para que seu sistema AFF A800 possa retomar a operação normal.  O procedimento de devolução varia de acordo com o tipo de criptografia usado pelo seu sistema: sem criptografia ou com criptografia Onboard Key Manager (OKM).
