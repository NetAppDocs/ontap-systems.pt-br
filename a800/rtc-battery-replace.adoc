...
summary: Substitua a bateria do relógio em tempo real no módulo do controlador AFF A800 para garantir que os serviços e aplicativos que dependem da sincronização precisa do tempo continuem funcionando. 
---
= Substitua a bateria do relógio em tempo real do seu sistema AFF A800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua a bateria do relógio de tempo real (RTC) do seu sistema AFF A800 para garantir que os serviços e aplicativos que dependem da sincronização precisa do tempo continuem funcionando.
