...
summary: Comece a substituir o chassi do seu sistema de armazenamento AFX 1K revisando os requisitos de substituição, desligando o controlador, substituindo o chassi e verificando as operações do sistema. 
---
= Fluxo de trabalho de substituição de chassi - AFX 1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Comece a substituir o chassi do seu sistema de armazenamento AFX 1K revisando os requisitos de substituição, desligando o controlador, substituindo o chassi e verificando as operações do sistema.
