...
summary: Substitua o chassi do seu sistema de storage AFX 1K quando uma falha de hardware exigir. O processo de substituição envolve remover o controlador da parte frontal do chassi, remover as fontes de alimentação, NVRAM12, módulos de I/O e tampas, e o módulo de gerenciamento do sistema, e então instalar o chassi de substituição e reinstalar os componentes do chassi. 
---
= Substitua o chassi do seu sistema de storage AFX 1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.O que se segue?
Após substituir o chassi AFX 1K com defeito e reinstalar seus componentes, conclua o link:chassis-replace-complete-system-restore-rma.html["substituição do chassi"].
