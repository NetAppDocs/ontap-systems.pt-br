...
.O que se segue?
Após a substituição do chassi AFF A1K danificado e a reinstalação dos seus componentes, conclua olink:chassis-replace-complete-system-restore-rma.html["substituição do chassi"] .
