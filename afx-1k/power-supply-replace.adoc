...
summary: Substitua a unidade de fonte de alimentação CA no seu sistema de storage AFX 1K quando ela falhar ou apresentar defeito, garantindo que o sistema continue recebendo a energia necessária para uma operação estável. O processo de substituição envolve desconectar a PSU alvo, desconectar o cabo de alimentação, remover a PSU defeituosa e instalar a PSU de substituição, e então reconectá-la à fonte de alimentação. 
---
= Substitua a fonte de alimentação com troca a quente no seu sistema de storage AFX 1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
