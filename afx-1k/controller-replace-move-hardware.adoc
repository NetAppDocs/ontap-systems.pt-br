...
summary: Substitua o controlador no seu sistema de armazenamento AFX 1K quando uma falha de hardware exigir isso. O processo de substituição envolve remover o controlador danificado, mover os componentes para o controlador de substituição, instalar o controlador de substituição e reiniciá-lo. 
---
= Substitua o controlador no seu sistema de storage AFX 1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua o controlador no seu sistema de armazenamento AFX 1K quando uma falha de hardware exigir isso. O processo de substituição envolve remover o controlador danificado, mover os componentes para o controlador de substituição, instalar o controlador de substituição e reiniciá-lo.
...
.O que se segue?
Após a substituição do controlador AFX 1K danificado,link:controller-replace-system-config-restore-and-verify.html["restaurar as configurações do sistema"] .
