...
summary: Prepare-se para substituir o chassi danificado no seu sistema de armazenamento AFX 1K identificando o chassi danificado, verificando os componentes de substituição e etiquetando os cabos e módulos do controlador. 
---
= Prepare-se para substituir seu chassi AFX 1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Prepare-se para substituir o chassi danificado no seu sistema de armazenamento AFX 1K identificando o chassi danificado, verificando os componentes de substituição e etiquetando os cabos e o módulo do controlador.
...
.O que se segue?
Depois de se preparar para substituir o hardware do chassi AFX 1K, você precisalink:chassis-replace-shutdown.html["desligue o controlador"] .
