...
summary: Substitua a bateria do relógio em tempo real do seu sistema de storage AFX 1K para garantir que os serviços e aplicativos que dependem da sincronização precisa do tempo permaneçam operacionais. 
---
= Substitua a bateria do relógio em tempo real do seu sistema de storage AFX 1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
