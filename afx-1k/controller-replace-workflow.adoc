...
summary: Comece substituindo o controlador no seu sistema de armazenamento AFX 1K desligando o controlador danificado, removendo e substituindo o controlador, reconfigurando as configurações do sistema e verificando as operações do sistema. 
---
= Fluxo de trabalho de substituição de controlador - AFX 1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Comece substituindo o controlador no seu sistema de armazenamento AFX 1K desligando o controlador danificado, removendo e substituindo o controlador, restaurando a configuração do sistema e verificando as operações do sistema.
...
[role="quick-margin-para"]
Substitua o controlador removendo o controlador danificado, movendo os componentes da FRU para o módulo de substituição e instalando o módulo de substituição no gabinete.
...
[role="quick-margin-para"]
Verifique a configuração de baixo nível do sistema do controlador de substituição e atualize as configurações do sistema, se necessário.
...
[role="quick-margin-para"]
Verifique as interfaces lógicas (LIFs), verifique a integridade do cluster e retorne a parte com falha para a NetApp.
