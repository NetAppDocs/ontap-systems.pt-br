...
---
= Substitua o módulo de gerenciamento do sistema no seu sistema de storage AFX 1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
O módulo de gerenciamento do sistema, localizado na parte traseira do controlador, à esquerda do slot 8, contém componentes integrados para gerenciamento do sistema, bem como portas para gerenciamento externo. O controlador em questão deve ser desligado e desenergizado para substituir um módulo de gerenciamento do sistema com defeito ou substituir a mídia de boot.
