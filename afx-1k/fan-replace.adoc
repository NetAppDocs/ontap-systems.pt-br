...
summary: Substitua um módulo de ventilador com defeito ou com defeito no seu sistema AFX 1K para manter o resfriamento adequado e evitar problemas de desempenho do sistema.  Os ventiladores podem ser trocados a quente e podem ser substituídos sem desligar o sistema. 
---
= Troque a ventoinha do seu sistema de storage AFX 1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
