...
[role="lead"]
Substitua um módulo de E/S no seu sistema de armazenamento AFX 1K quando o módulo falhar. O processo de substituição envolve desligar o controlador, substituir o módulo de E/S com falha, reinicializar o controlador e devolver a peça com falha à NetApp.
