...
summary: Antes de substituir a mídia de inicialização no seu FAS500f, certifique-se de que atende aos requisitos necessários para uma substituição bem-sucedida. 
---
= Requisitos para recuperação automatizada de mídia de inicialização - FAS500f
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
