...
[role="lead"]
Substitua o chassi no seu sistema FAS500f quando uma falha de hardware exigir. O processo de substituição envolve remover os controladores e as unidades de fonte de alimentação (PSUs), remover as unidades de disco, instalar o chassi de substituição e reinstalar os componentes do chassi.
...
.O que se segue?
Após substituir o chassi FAS500f e reinstalar os componentes, você precisa link:chassis-replace-complete-system-restore-rma.html["complete a substituição do chassis"]
