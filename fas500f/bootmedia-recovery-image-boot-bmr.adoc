...
summary: Após instalar o novo dispositivo de mídia de inicialização no seu FAS500f, você pode iniciar o processo automatizado de recuperação da mídia de inicialização para restaurar a configuração do nó parceiro. 
---
= Recuperação automatizada da mídia de inicialização do nó parceiro - FAS500f
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
