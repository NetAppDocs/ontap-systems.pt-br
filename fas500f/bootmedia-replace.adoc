...
---
= Substitua a mídia de inicialização e prepare-se para a recuperação manual de boot - FAS500f
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
