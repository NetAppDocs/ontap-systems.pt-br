...
---
= Recable o sistema e reatribuir discos - FAS500f
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Após concluir a restauração e verificar a configuração do sistema FAS500f, você precisa reconectar o sistema e reatribuir os discos.
