...
summary: Comece a substituir a mídia de inicialização no seu sistema de storage FAS500f revisando os requisitos de substituição, desligando o controlador, substituindo a mídia de inicialização, restaurando a imagem na mídia de inicialização e verificando a funcionalidade do sistema. 
---
= Fluxo de trabalho de recuperação automatizada de boot media - FAS500f
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
