...
---
= Restaure e verifique a configuração do sistema - FAS500f
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Após concluir a substituição do hardware e inicializar o seu sistema FAS500f no modo de manutenção, você precisa verificar a configuração de baixo nível do controlador de substituição e reconfigurar as definições do sistema conforme necessário.
