...
summary: Comece a substituir a mídia de inicialização do seu sistema de storage FAS500f revisando os requisitos de substituição, verificando o status da criptografia, desligando o controlador, substituindo a mídia de inicialização, inicializando a imagem de recuperação, restaurando a criptografia e verificando a funcionalidade do sistema. 
---
= Fluxo de trabalho de recuperação manual da boot media - FAS500f
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
