...
summary: Para concluir a substituição do controlador do seu sistema FAS500f, restaure a configuração de criptografia de armazenamento NetApp, se necessário, instale as licenças para o novo controlador e devolva a peça com defeito para a NetApp. 
---
