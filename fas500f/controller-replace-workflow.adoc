...
summary: Siga estes passos do fluxo de trabalho para substituir o controlador no seu sistema de storage FAS500f. 
---
= Fluxo de trabalho de substituição do controlador - FAS500f
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Siga estes passos do fluxo de trabalho para substituir o controlador no seu sistema de storage FAS500f.
