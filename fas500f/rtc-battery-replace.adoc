...
Pode utilizar o seguinte vídeo ou os passos tabulados para substituir a bateria RTC:
...
+
image::../media/drw_a250_remove_rtc_batt.png[Como remover a bateria do RTC]
...
|===
 ...
 a| 
image:../media/icon_round_1.png["Legenda número 1"]
| Puxe cuidadosamente a patilha para fora do compartimento da bateria. Nota: Puxando-o de forma agressiva pode deslocar a aba. 
...
NOTE: Anote a polaridade da bateria.
...
+
image::../media/drw_a250_install_rtc_batt.png[Instalar a bateria do RTC]
