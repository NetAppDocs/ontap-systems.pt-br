...
summary: Você deve substituir um módulo DIMM no controlador quando o sistema registrar um número crescente de códigos de correção de erro corrigíveis. A falha em fazer isso causa um pânico no sistema. 
---
