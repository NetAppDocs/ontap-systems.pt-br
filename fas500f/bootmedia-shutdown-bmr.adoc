...
summary: Desligue o controlador com defeito no seu sistema de storage FAS500f para evitar perda de dados e garantir a estabilidade do sistema ao substituir a mídia de inicialização. 
---
= Desligue o controlador para recuperação automática da mídia de boot - FAS500f
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Desligue o controlador com defeito no seu sistema de storage FAS500f para evitar perda de dados e manter a estabilidade do sistema durante o processo automatizado de recuperação da mídia de boot.
