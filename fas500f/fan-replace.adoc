...
---
= Substitua um ventilador - FAS500f
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substituir uma ventoinha por um novo módulo da ventoinha quando esta falha.
...
Você pode usar o vídeo a seguir ou as etapas tabuladas para substituir um ventilador:
