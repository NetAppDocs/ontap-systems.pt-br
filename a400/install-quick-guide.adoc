...
---
= Instale seu sistema AFF A400 usando instruções gráficas rápidas
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Instale e conecte os cabos do seu sistema de storage AFF A400 usando as instruções gráficas rápidas.
