...
summary: Substitua a fonte de alimentação no seu sistema AFF A400 desconectando a fonte de alimentação da fonte de energia, retirando o cabo de força, removendo a fonte antiga, instalando a fonte de reposição e, em seguida, reconectando-a à fonte de energia. 
---
= Substitua a fonte de alimentação com substituição a quente no seu sistema AFF A400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua a fonte de alimentação do seu AFF A400 quando ela falhar ou apresentar defeito. As fontes de alimentação são redundantes e com substituição a quente, portanto, não é necessário desligar o controlador para realizar esta substituição.
