...
summary: A mídia de inicialização armazena um conjunto primário e um conjunto secundário de arquivos de sistema que o sistema utiliza ao inicializar. 
---
= Verifique os requisitos para substituir a mídia de inicialização no seu sistema AFF A400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
