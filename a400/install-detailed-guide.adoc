...
---
= Instale seu sistema AFF A400 usando instruções detalhadas passo a passo
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Instale seu sistema de storage AFF A400 seguindo estas instruções detalhadas passo a passo, desde a preparação do local até a inicialização do cluster ONTAP.
