...
---
= Substitua uma placa PCIe ou mezzanine em seu sistema AFF A400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua uma placa PCIe ou mezzanine em seu sistema AFF A400 quando a placa apresentar defeito ou precisar de uma atualização. O processo de substituição envolve desconectar os cabos e os módulos SFP ou QSFP, substituir a placa e reconectar os cabos.
