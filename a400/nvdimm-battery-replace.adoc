...
---
= Substitua a bateria NVDIMM no seu sistema AFF A400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua a bateria NVDIMM do seu sistema AFF A400 quando ela começar a perder carga ou apresentar defeito. O processo de substituição envolve a remoção do módulo controlador, a troca da bateria e a reinstalação do módulo controlador.
