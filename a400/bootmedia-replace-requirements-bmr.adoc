...
summary: Antes de substituir a mídia de inicialização no seu sistema AFF A400, certifique-se de atender aos requisitos necessários para uma substituição bem-sucedida. 
---
= Analise os requisitos para recuperação automática da mídia de inicialização no seu AFF A400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
