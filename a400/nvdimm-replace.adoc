...
summary: Substitua o NVDIMM no módulo controlador AFF A400 quando o sistema detectar que a vida útil da memória flash está quase no fim ou que o NVDIMM identificado não está em boas condições. A não substituição de um NVDIMM defeituoso pode causar um pânico no sistema. 
---
= Substitua o NVDIMM no seu sistema AFF A400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua o NVDIMM do seu AFF A400 quando o sistema registrar que a vida útil da memória flash está quase no fim ou que o NVDIMM não está saudável. Se você não substituí-lo, pode causar um pânico no sistema.
