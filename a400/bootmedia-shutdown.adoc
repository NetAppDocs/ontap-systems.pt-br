...
---
= Desligue o controlador do seu sistema AFF A400 durante o processo de recuperação de inicialização manual
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Desligue o controlador com defeito no seu sistema de storage AFF A400 para evitar perda de dados e manter a estabilidade do sistema durante o processo de recuperação de inicialização manual.
