...
---
= Desligue seus controladores AFF A400 para substituir o chassi
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Desligue os controladores do seu sistema de storage AFF A400 para evitar perda de dados e garantir a estabilidade do sistema ao substituir o chassi.



[[option-1-shut-down-the-controllers-when-replacing-a-chassis]]
== Opção 1: Desligue os controladores ao substituir um chassi
...
== Opção 2: Encerre um controlador em uma configuração de MetroCluster de dois nós
