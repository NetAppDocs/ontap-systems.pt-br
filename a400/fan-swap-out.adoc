...
---
= Substitua o módulo de ventoinha com substituição a quente no seu sistema AFF A400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua a quente um módulo de ventoinha no seu sistema AFF A400 para manter o resfriamento adequado. O módulo de ventoinha deve ser substituído em até dois minutos após a remoção para evitar superaquecimento.
