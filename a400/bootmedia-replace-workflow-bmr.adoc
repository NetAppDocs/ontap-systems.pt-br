...
---
= Fluxo de trabalho de substituição da mídia de inicialização do AFF A400 usando o processo automatizado de recuperação de inicialização
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
