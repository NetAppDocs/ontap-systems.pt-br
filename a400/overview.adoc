...
* Profundidade: 32,6” (34,7” com suporte para gerenciamento de cabos)
...
* Ruído acústico: Potência sonora declarada (LwAd): 8,5; Pressão sonora (LpAm) (posições de observador): 67,2 dB
...
Controlador de gerenciamento de placa-mãe (BMC) baseado em Ethernet e interface de gerenciamento ONTAP ; Controladores redundantes hot-swappable; * Fontes de alimentação redundantes hot-swappable; * Gerenciamento SAS em banda sobre conexões SAS
