...
summary: Devolva o controle dos recursos de storage ao controlador de substituição para que seu sistema AFF A400 possa retomar a operação normal. 
---
= Reconecte os cabos do sistema e reatribua os discos no seu AFF A400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Devolva o controle dos recursos de storage ao controlador de substituição para que seu sistema AFF A400 possa retomar a operação normal.
