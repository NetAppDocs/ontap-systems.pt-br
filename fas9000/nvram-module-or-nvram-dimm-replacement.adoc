...
summary: O módulo NVRAM consiste no NVRAM10, nos DIMMs e em até dois módulos Flash Cache SSD NVMe, Flash Cache ou módulos de armazenamento em cache, por módulo NVRAM. 
---
