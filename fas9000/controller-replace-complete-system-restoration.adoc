...
summary: Para concluir o procedimento de substituição e restaurar o funcionamento completo do sistema, você deve reconectar o armazenamento, restaurar a configuração de criptografia de armazenamento NetApp, se necessário, e instalar as licenças para o novo controlador. 
---
= Restauração completa do sistema - FAS9000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
