...
summary: Antes de desligar o nó com problemas e verificar o status das chaves de criptografia integradas, você deve verificar o status do nó com problemas, desativar a devolução automática e verificar qual versão do ONTAP o sistema está executando. O sistema FAS9000 suporta apenas procedimentos manuais de recuperação de mídia de inicialização. 
---
