...
summary: 'Para realizar a substituição a quente de um módulo de alimentação do controlador de desestágio (DCPM), que contém a bateria NVRAM10, você deve localizar o módulo DCPM com defeito, removê-lo do chassi e instalar o módulo DCPM de substituição.' 
---
