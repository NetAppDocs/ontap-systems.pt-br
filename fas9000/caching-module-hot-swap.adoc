...
summary: 'Os módulos NVMe SSD FlashCache (módulos FlashCache ou cache) estão localizados na parte frontal do módulo NVRAM10 apenas no slot 6 de sistemas FAS9000. A partir do ONTAP 9.4, você pode trocar o módulo de armazenamento em cache com a mesma capacidade do mesmo ou de outro fornecedor suportado.' 
---
...
[role="lead"]
Os módulos NVMe SSD FlashCache (módulos FlashCache ou cache) estão localizados na parte frontal do módulo NVRAM10 apenas no slot 6 de sistemas FAS9000. A partir do ONTAP 9.4, você pode trocar o módulo de armazenamento em cache com a mesma capacidade do mesmo ou de outro fornecedor suportado.
