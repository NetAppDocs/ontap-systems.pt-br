...
summary: O procedimento para inicializar o nó com problemas a partir da imagem de recuperação depende de o sistema estar em uma configuração MetroCluster de dois nós. O sistema FAS9000 suporta apenas procedimentos manuais de recuperação de mídia de inicialização. 
---
= Inicie a imagem de recuperação - FAS9000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
O procedimento para inicializar o nó com problemas a partir da imagem de recuperação depende de o sistema estar em uma configuração MetroCluster de dois nós. O sistema FAS9000 suporta apenas procedimentos manuais de recuperação de mídia de inicialização. A recuperação automática de mídia de inicialização não é suportada.
