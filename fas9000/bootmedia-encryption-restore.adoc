...
summary: Após verificar as variáveis de ambiente, você deve concluir as etapas específicas para sistemas que possuem Onboard Key Manager OKM, NetApp Storage Encryption NSE ou NetApp Volume Encryption NVE ativados. O sistema FAS9000 suporta apenas procedimentos manuais de recuperação da mídia de inicialização. 
---
