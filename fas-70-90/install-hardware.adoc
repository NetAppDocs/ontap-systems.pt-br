...
summary: Instale seu sistema de storage em um armário ou rack. 
---
...
+
.O que se segue?
Após instalar o hardware do seu sistema de storage FAS70 ou FAS90, você link:install-cable.html["Conecte os cabos de hardware para o seu sistema de storage FAS70 ou FAS90"].
