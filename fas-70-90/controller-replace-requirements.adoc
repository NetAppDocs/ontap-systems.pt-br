...
.O que se segue?
Depois de analisar os requisitos para substituir o controlador FAS70 ou FAS90, é necessário link:controller-replace-shutdown.html["desligue o controlador desativado"].
