...
[role="lead"]
Antes de substituir o controlador no seu sistema FAS70 ou FAS90, certifique-se de que cumpre os requisitos necessários para uma substituição bem-sucedida. Isso inclui ter o controlador de substituição correto, um backup da configuração do sistema e acesso a todas as ferramentas e firmware necessários.
...
.O que se segue?
Depois de analisar os requisitos para substituir o controlador FAS70 ou FAS90, é necessário link:controller-replace-shutdown.html["desligue os controladores"].
