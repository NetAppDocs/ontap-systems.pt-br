...
summary: 'Substitua a bateria do relógio de tempo real (RTC), geralmente conhecida como bateria tipo moeda, em seu sistema FAS70 ou FAS90 para garantir que os serviços e aplicativos que dependem da sincronização precisa do tempo permaneçam operacionais.' 
---
