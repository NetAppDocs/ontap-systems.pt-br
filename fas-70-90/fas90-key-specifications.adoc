...
summary: Especificações principais para FAS90 
---
= Especificações principais para FAS90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
A seguir estão especificações selecionadas para o sistema de armazenamento FAS90 em um único par de alta disponibilidade.  Visite o NetApp Hardware Universe (HWU) para obter as especificações completas deste sistema de armazenamento.



== Especificações FAS90 em resumo

* Configuração da plataforma: Par de chassi duplo FAS90 HA
* Capacidade Máxima de Bruto: 15.0000 PB
* Memória: 1024.0000 GB
* Fator de forma: chassi 2U com 1 controlador HA
* Versão ONTAP : ONTAP: 9.16.1P2
* Slots de expansão PCIe: 18
* Versão mínima do ONTAP : ONTAP 9.15.1
...
* Tipo: NAS; Pares HA: 12; Capacidade bruta: 180,0 PB / 159,9 PiB; Memória máxima: 12288 GB
* Tipo: SAN; Pares HA: 6; Capacidade bruta: 90,0 PB / 79,9 PiB; Memória máxima: 6144 GB
* Tipo: Par HA; Capacidade bruta: 15,0 PB / 13,3 PiB; Memória máxima: 1024.0000
...
* Potência típica: 3392 BTU/h
* Pior cenário de potência: 5136 BTU/h
* Peso: 59,5 lb, 27,0 kg
* Altura: 2U
* Largura: 19" (44,9 cm), compatível com o padrão de rack IEC.
...
* Ruído acústico: Potência sonora declarada (LwAd): 8,5; Pressão sonora (LpAm) (posições de observador): 67,7 dB
