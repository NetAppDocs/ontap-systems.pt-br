...
summary: 'Verifique se as interfaces lógicas (LIFs) estão reportando à sua porta inicial, execute uma verificação de integridade e, em seguida, retorne a parte com falha para NetApp para concluir a etapa final do procedimento de substituição do controlador FAS70 ou FAS90.' 
---
