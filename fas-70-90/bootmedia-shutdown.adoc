...
[role="lead"]
Desligue o controlador desativado no seu sistema de armazenamento FAS70 ou FAS90 para evitar a perda de dados e garantir a estabilidade do sistema ao substituir o suporte de arranque.
