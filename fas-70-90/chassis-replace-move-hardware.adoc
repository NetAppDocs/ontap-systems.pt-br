...
.O que se segue?
Depois de substituir o chassi FAS70 e FAS90 danificado e reinstalar os componentes nele, você precisalink:chassis-replace-complete-system-restore-rma.html["complete a substituição do chassis"] .
