...
summary: Você pode realizar a substituição a quente de um módulo de E/S Ethernet em seu sistema de storage FAS 70 ou FAS 90 caso um módulo apresente falha e seu sistema de storage atenda a todos os requisitos de versão do ONTAP. 
---
= Substituição a quente de um módulo de I/O - FAS 70 e FAS 90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Você pode realizar a substituição a quente de um módulo de E/S Ethernet em seu sistema de storage FAS 70 ou FAS 90 caso um módulo apresente falha e seu sistema de storage atenda a todos os requisitos de versão do ONTAP.
