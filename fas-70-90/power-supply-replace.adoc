...
summary: 'Substitua a fonte de alimentação CA ou CC (PSU) do seu sistema FAS70 ou FAS90 quando ela falhar ou apresentar defeito, garantindo que o sistema continue recebendo a energia necessária para uma operação estável. O processo de substituição envolve desconectar a PSU defeituosa da fonte de alimentação, desconectar o cabo de força, substituir a PSU defeituosa e, em seguida, reconectá-la à fonte de alimentação.' 
---
= Troca a quente de uma fonte de alimentação - FAS70 e FAS90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
