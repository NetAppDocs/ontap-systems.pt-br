...
summary: Restaure a criptografia na Mídia de inicialização de substituição em seu sistema FAS70 ou FAS90 para garantir a proteção contínua dos dados. O processo de substituição envolve verificar a disponibilidade das chaves, reaplicar as configurações de criptografia e confirmar o acesso seguro aos seus dados. 
---
= Restaurar chaves de criptografia após recuperação de inicialização manual - FAS70 e FAS90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Restaure a criptografia na Mídia de inicialização de substituição em seu sistema FAS70 ou FAS90 para garantir a proteção contínua dos dados. O processo de substituição envolve verificar a disponibilidade das chaves, reaplicar as configurações de criptografia e confirmar o acesso seguro aos seus dados.
