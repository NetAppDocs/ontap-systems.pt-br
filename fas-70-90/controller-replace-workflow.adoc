...
---
= Início rápido para substituição do controlador - FAS70 e FAS90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Comece a substituir o controlador no sistema de armazenamento FAS70 ou FAS90 desligando o controlador desativado, removendo e substituindo o controlador, restaurando a configuração do sistema e verificando as operações do sistema.
