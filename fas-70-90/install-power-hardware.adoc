...
[role="lead"]
Após instalar o hardware do rack para o seu sistema de storage FAS70 ou FAS90 e conectar os cabos dos controladores e das prateleiras de armazenamento, você deve ligar as prateleiras de armazenamento e os controladores.
