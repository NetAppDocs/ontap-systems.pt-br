...
image::../media/drw_ns224_lifting_weight_2_ieops-2960.svg[NS224 NSM100 precaução de elevação]

Uma estante DS460C pode pesar até 260,4 lbs (118,1 kg). Para levantar a estante de storage, você pode precisar de até cinco pessoas ou de um elevador hidráulico. Mantenha todos os componentes na estante de storage (tanto na parte frontal quanto na traseira) para evitar o desbalanceamento do peso da estante.
