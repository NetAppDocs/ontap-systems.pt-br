...
summary: Substitua o controlador no seu sistema FAS70 ou FAS90 quando uma falha de hardware o exigir. O processo de substituição envolve remover o controlador prejudicado, mover os componentes para o controlador de substituição, instalar o controlador de substituição e reinicializá-lo. 
---
= Substitua o controlador - FAS70 e FAS90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua o controlador no seu sistema FAS70 ou FAS90 quando uma falha de hardware o exigir. O processo de substituição envolve remover o controlador prejudicado, mover os componentes para o controlador de substituição, instalar o controlador de substituição e reinicializá-lo.
...
.O que se segue?
Depois de substituir o controlador FAS70 ou FAS90 com problemas, é link:controller-replace-system-config-restore-and-verify.html["restaure a configuração do sistema"]necessário .
