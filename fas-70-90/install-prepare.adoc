...
.O que se segue?
Depois de se preparar para instalar o seu hardware FAS70 ou FAS90, você link:install-hardware.html["Instale o hardware do sistema de armazenamento FAS70 ou FAS90"].
