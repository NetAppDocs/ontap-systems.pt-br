...
Os procedimentos de manutenção pressupõem que o sistema de armazenamento FAS70 ou FAS90 já tenha sido implantado como um nó de armazenamento no ambiente ONTAP .
