...
---
= Desligue seus controladores AFF A220 para substituir o chassi
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Desligue seus controladores AFF A220 para substituir o chassi utilizando o procedimento adequado à sua configuração.
