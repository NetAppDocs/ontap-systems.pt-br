...
summary: Mantenha o hardware AFF A220 
---
= Saiba mais sobre a manutenção do seu sistema de storage AFF A220
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Para o sistema de armazenamento AFF A220, pode executar procedimentos de manutenção nos seguintes componentes.
