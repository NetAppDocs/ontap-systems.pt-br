...
summary: Restaure a criptografia na mídia de inicialização de substituição do seu sistema de storage AFF A220. O AFF A220 suporta apenas procedimentos manuais de recuperação de mídia de inicialização. 
---
= Restaure a criptografia na mídia de inicialização do seu sistema AFF A220
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
