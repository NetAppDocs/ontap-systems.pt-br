...
---
= Substitua o chassi no seu sistema AFF A220
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua o chassi do seu sistema AFF A220 transferindo as fontes de alimentação, os discos rígidos e os módulos controladores do chassi com problema para o chassi de substituição.
