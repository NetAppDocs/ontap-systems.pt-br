...
---
= Substitua o controlador no seu sistema AFF A220
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua o controlador do seu sistema AFF A220 removendo o controlador com problema, transferindo os componentes FRU para o módulo do controlador de substituição, instalando-o no chassi e inicializando no modo de manutenção.
