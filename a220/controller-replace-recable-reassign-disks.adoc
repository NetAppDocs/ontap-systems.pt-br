...
---
= Reconecte os cabos do sistema e reatribua os discos no seu AFF A220
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Conclua a substituição do controlador do seu AFF A220 reconectando os cabos de armazenamento e confirmando a reatribuição dos discos.
