...
---
= Substitua a bateria NVMEM no seu sistema AFF A220
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua a bateria NVMEM do seu sistema AFF A220 removendo o módulo controlador, substituindo a bateria e reinstalando o módulo controlador.
