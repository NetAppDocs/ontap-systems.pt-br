...
---
= Substitua o chassi no seu sistema AFF A320
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua o chassi do seu sistema AFF A320 transferindo as ventoinhas, os discos rígidos e os módulos de controle do chassi com problema para o chassi de substituição.
