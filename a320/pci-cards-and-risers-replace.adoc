...
---
= Substitua uma placa PCIe no seu sistema AFF A320
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua uma placa PCIe no seu sistema AFF A320 desconectando os cabos e os módulos SFP/QSFP, removendo a placa riser, substituindo a placa e reconectando os cabos.
