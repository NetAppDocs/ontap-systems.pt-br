...
---
= Desligue o controlador defeituoso do seu sistema AFF A320 antes de substituí-lo
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Desligue o controlador com defeito no seu sistema AFF A320 antes da substituição, assumindo o controle e interrompendo-o até o prompt LOADER.
