...
summary: Depois de concluir as tarefas NVE ou NSE, você precisa concluir o desligamento do nó afetado. 
---
...
[role="lead"]
Depois de concluir as tarefas NVE ou NSE, você precisa concluir o desligamento do nó afetado. Encerre ou assuma o controlador afetado utilizando o procedimento adequado para a sua configuração.
