...
---
= Reconecte os cabos do sistema e reatribua os discos no seu AFF A320
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Conclua a substituição do controlador do seu AFF A320 reconectando os cabos do storage e confirmando a reatribuição dos discos.
