...
---
= Conclua a substituição do chassi do seu sistema AFF A320
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Conclua a substituição do chassi do seu sistema AFF A320 verificando o estado de HA do chassi e devolvendo o componente com falha para a NetApp.
