...
---
= Instale seu sistema de storage AFF A320 usando passos detalhados
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Instale seu sistema de storage AFF A320 seguindo instruções detalhadas passo a passo, desde a montagem no rack e a instalação dos cabos até a inicialização do sistema.
