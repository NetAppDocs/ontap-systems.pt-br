...
summary: Substitua o NVDIMM no módulo controlador AFF A320 quando o sistema registrar que a vida útil da memória flash está quase no fim ou que o NVDIMM identificado não está saudável. A não substituição de um NVDIMM defeituoso pode causar um pânico no sistema. 
---
= Substitua um NVDIMM no seu sistema AFF A320
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua um NVDIMM no seu AFF A320 quando o sistema registrar que a vida útil da flash está quase no fim ou que o NVDIMM identificado não está saudável. Se você não substituir um NVDIMM com defeito, pode ocorrer um pânico no sistema.
