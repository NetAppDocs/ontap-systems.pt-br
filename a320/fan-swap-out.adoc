...
---
= Troque a ventoinha do seu sistema AFF A320 com o sistema em funcionamento.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua o módulo de ventoinha do seu sistema AFF A320 sem interromper o serviço para manter o fluxo de ar e o resfriamento adequados do sistema.
