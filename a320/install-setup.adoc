...
---
= Instale e configure seu sistema de storage AFF A320
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Instale e configure seu sistema de storage AFF A320, escolhendo entre diferentes formatos de conteúdo de acordo com sua preferência.
