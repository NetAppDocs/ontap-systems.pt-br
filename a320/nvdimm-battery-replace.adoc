...
---
= Substitua a bateria NVDIMM no seu sistema AFF A320
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua a bateria NVDIMM no seu AFF A320 removendo o módulo controlador, substituindo a bateria e reinstalando o módulo controlador.
