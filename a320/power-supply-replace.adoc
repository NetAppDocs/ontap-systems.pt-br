...
summary: Substitua a fonte de alimentação no seu sistema AFF A320 desconectando a PSU alvo da fonte de energia, desligando o cabo de alimentação, removendo a PSU antiga, instalando a PSU de substituição e, em seguida, reconectando a PSU de substituição à fonte de energia. 
---
= Substitua a fonte de alimentação com o sistema AFF A320 em funcionamento.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua a fonte de alimentação do seu sistema AFF A320 com o sistema em funcionamento, desconectando, removendo e substituindo a unidade com defeito e, em seguida, reconectando-a para restaurar a energia.
