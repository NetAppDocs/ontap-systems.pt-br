...
---
= Substitua a mídia de inicialização no seu sistema AFF A250 usando o processo manual de recuperação de inicialização
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
