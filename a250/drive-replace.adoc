...
---
= Substitua uma unidade no seu sistema AFF A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua uma unidade com falha no seu sistema AFF A250 sem interrupção, enquanto as operações de E/S estiverem em andamento, para restaurar a capacidade de storage e o desempenho.
