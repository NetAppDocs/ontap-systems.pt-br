...
---
= Restaure e verifique a configuração do controlador no seu sistema AFF A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Após concluir a substituição do hardware e inicializar no modo de manutenção, verifique a configuração de baixo nível do sistema do controlador de substituição e reconfigure as configurações do sistema conforme necessário.
