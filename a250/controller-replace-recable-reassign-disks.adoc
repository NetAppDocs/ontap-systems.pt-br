...
---
= Reinstale os cabos do sistema e reatribua os discos no seu sistema AFF A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Reconecte o storage, confirme a reatribuição do disco e restaure a NetApp Storage Encryption para que seu sistema AFF A250 volte a operar normalmente.
