...
---
= Instale seu sistema AFF A250 usando instruções gráficas rápidas
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Instale e conecte os cabos do seu sistema de storage AFF A250 seguindo as instruções gráficas rápidas.
