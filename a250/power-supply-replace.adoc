...
summary: Substitua a fonte de alimentação no seu sistema AFF A250 desconectando a fonte de alimentação de energia da fonte de alimentação, retirando o cabo de força, removendo a fonte antiga, instalando a fonte de alimentação de substituição e, em seguida, reconectando-a à fonte de alimentação. 
---
= Substitua a fonte de alimentação com substituição a quente no seu sistema AFF A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua a fonte de alimentação do seu AFF A250 quando ela falhar ou apresentar defeito. As fontes de alimentação são redundantes e com substituição a quente, portanto, não é necessário desligar o controlador para realizar essa substituição.
...
--
Para substituir uma fonte de alimentação CA com o equipamento ligado, conclua as seguintes etapas.
