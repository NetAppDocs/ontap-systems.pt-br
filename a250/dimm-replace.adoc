...
summary: Substitua um módulo DIMM no seu AFF A250 quando o sistema apresentar erros CECC excessivos com base em alertas do Health Monitor, ou erros ECC incorrigíveis que impeçam o sistema de storage de inicializar o ONTAP. 
---
= Substitua um DIMM no seu sistema AFF A250 para corrigir erros de memória
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua um DIMM no seu sistema AFF A250 quando o sistema de storage encontrar erros de memória corrigíveis (CECC) ou incorrigíveis em excesso. Esses erros podem impedir que o sistema de storage inicialize o ONTAP.
