...
---
= Desligue seus controladores AFF A250 para substituir o chassi
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Desligue os controladores no seu sistema de storage AFF A250 para evitar perda de dados e garantir a estabilidade do sistema ao substituir o chassi.
