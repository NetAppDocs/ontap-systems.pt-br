...
---
= Substitua ou instale uma placa mezzanine no seu sistema AFF A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua uma placa mezzanine com falha no seu AFF A250 ou instale uma nova para expandir as opções de conectividade. O processo de substituição envolve remover os cabos e os módulos SFP ou QSFP, substituir a placa e recabear.
