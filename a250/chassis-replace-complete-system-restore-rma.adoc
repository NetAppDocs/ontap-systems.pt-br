...
---
= Conclua a substituição do chassi do seu sistema AFF A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Reinicie os controladores, verifique a integridade do sistema e devolva a peça com defeito para NetApp para concluir a etapa final do procedimento de substituição do chassi AFF A250.
