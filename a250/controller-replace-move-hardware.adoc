...
---
= Substitua o controlador no seu sistema AFF A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua o controlador no seu sistema AFF A250 quando uma falha de hardware exigir. O processo de substituição envolve remover o controlador com problema, mover os componentes para o controlador de substituição, instalar o controlador de substituição e reiniciá-lo.
...
.O que se segue?
Após substituir o controlador A250 defeituoso, você precisa link:controller-replace-system-config-restore-and-verify.html["restaure e verifique a configuração do sistema"].
