...
---
= Troque a ventoinha do seu sistema AFF A250 com o sistema em funcionamento.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua o módulo de ventoinha com falha no seu AFF A250 para manter o resfriamento adequado e evitar problemas de desempenho. Os módulos de ventoinha são com substituição a quente e podem ser trocados sem desligar o sistema.
