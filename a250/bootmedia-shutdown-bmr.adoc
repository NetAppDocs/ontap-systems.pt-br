...
summary: Desligue o controlador com defeito no seu sistema de storage AFF A250 para evitar perda de dados e garantir a estabilidade do sistema ao substituir a mídia de inicialização. 
---
= Desligue o controlador do seu sistema AFF A250 durante o processo de recuperação automática de inicialização
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
