...
---
= Substitua a bateria NV no seu sistema AFF A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua a bateria NVMEM do seu AFF A250 quando ela começar a perder carga ou falhar, pois ela preserva dados críticos do sistema durante quedas de energia. O processo de substituição envolve remover o módulo controlador, trocar a bateria e reinstalar o módulo controlador.
