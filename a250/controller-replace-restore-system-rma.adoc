...
summary: Para concluir a substituição do controlador do seu AFF A250, restaure a configuração de criptografia de armazenamento NetApp, se necessário, instale as licenças para o novo controlador e devolva a peça com defeito à NetApp. 
---
= Conclua a substituição do controlador do seu sistema AFF A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Para concluir a substituição do controlador do seu sistema AFF A250, restaure a configuração de criptografia de armazenamento NetApp (se necessário), confirme se as interfaces lógicas (LIFs) estão relatando para suas portas de origem, execute uma verificação de integridade do cluster e devolva a unidade com falha para a NetApp.
