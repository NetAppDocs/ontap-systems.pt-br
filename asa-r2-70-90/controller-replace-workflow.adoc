...
summary: Comece a substituir o controlador no sistema de armazenamento ASA A70 ou ASA A90 desligando o controlador desativado, removendo e substituindo o controlador, restaurando a configuração do sistema e verificando as operações do sistema. 
---
...
[role="lead"]
Comece a substituir o controlador no sistema de armazenamento ASA A70 ou ASA A90 desligando o controlador desativado, removendo e substituindo o controlador, restaurando a configuração do sistema e verificando as operações do sistema.
