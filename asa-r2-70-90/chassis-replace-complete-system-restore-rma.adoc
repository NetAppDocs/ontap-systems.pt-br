...
[role="lead"]
Reinicie os controladores, verifique a integridade do sistema e devolva a peça com falha ao NetApp para concluir a etapa final no fluxo de trabalho de substituição do chassi do ASA A70 e do ASA A90.
