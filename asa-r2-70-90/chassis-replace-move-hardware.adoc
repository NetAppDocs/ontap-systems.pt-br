...
summary: Substitua o chassi do sistema ASA A70 ou ASA A90 quando uma falha ou atualização de hardware exigir isso. Esse processo envolve desligar o sistema, remover o chassi existente, instalar o novo e reconfigurar os componentes para garantir o funcionamento correto do sistema. 
---
...
[role="lead"]
Substitua o chassi do sistema ASA A70 ou ASA A90 quando uma falha ou atualização de hardware exigir isso. Esse processo envolve desligar o sistema, remover o chassi existente, instalar o novo e reconfigurar os componentes para garantir o funcionamento correto do sistema.
