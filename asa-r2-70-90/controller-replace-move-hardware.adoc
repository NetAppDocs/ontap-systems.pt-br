...
summary: Substitua o controlador no seu sistema ASA A70 ou ASA A90 quando uma falha de hardware o exigir. Este processo envolve remover o controlador prejudicado, mover os componentes para o controlador de substituição, instalar o controlador de substituição e reiniciar o sistema. 
---
= Substitua o controlador no seu sistema ASA A70 ou ASA A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua o controlador no seu sistema ASA A70 ou ASA A90 quando uma falha de hardware o exigir. Este processo envolve remover o controlador prejudicado, mover os componentes para o controlador de substituição, instalar o controlador de substituição e reiniciar o sistema.
...
.O que se segue?
Após substituir o controlador ASA A70 ou ASA A90 com defeito, você precisalink:controller-replace-system-config-restore-and-verify.html["restaure a configuração do sistema"] .
