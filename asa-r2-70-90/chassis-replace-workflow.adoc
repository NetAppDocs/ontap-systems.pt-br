...
summary: Comece a substituir o chassi no sistema de storage ASA A70 ou ASA A90, desligando os controladores, removendo e substituindo o chassi e verificando as operações do sistema. 
---
...
[role="lead"]
Comece a substituir o chassi no sistema de storage ASA A70 ou ASA A90, desligando os controladores, removendo e substituindo o chassi e verificando as operações do sistema.
