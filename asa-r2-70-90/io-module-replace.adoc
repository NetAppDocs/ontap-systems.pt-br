...
---
= Substitua um módulo de E/S no seu sistema ASA A70 ou ASA A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Você pode usar este procedimento com todas as versões do ONTAP suportadas pelo seu sistema de armazenamento.
