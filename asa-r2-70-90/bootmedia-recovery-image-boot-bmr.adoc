...
summary: Se a Mídia de inicialização no sistema ASA A70 ou ASA A90 estiver corrompida, você poderá inicializar a imagem de recuperação, restaurar a configuração do nó do parceiro e verificar as variáveis de ambiente. 
---
= Restaure a imagem ONTAP - ASA A70 e ASA A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Se a Mídia de inicialização no sistema ASA A70 ou ASA A90 estiver corrompida, você poderá inicializar a imagem de recuperação e restaurar a configuração do nó do parceiro.
