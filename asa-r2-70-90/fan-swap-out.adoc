...
summary: Substitua um módulo de ventilador no sistema ASA A70 ou ASA A90 quando um ventilador falhar ou não estiver funcionando de forma eficiente, o que pode afetar o resfriamento do sistema e o desempenho geral. 
---
...
[role="lead"]
Substitua um módulo de ventilador no sistema ASA A70 ou ASA A90 quando um ventilador falhar ou não estiver funcionando de forma eficiente, o que pode afetar o resfriamento do sistema e o desempenho geral.
