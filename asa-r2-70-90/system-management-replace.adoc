...
summary: Substitua o módulo de gerenciamento do sistema no sistema ASA A70 ou ASA A90 quando ele ficar com defeito ou o firmware estiver corrompido. O processo de substituição envolve desligar o controlador, substituir o módulo de gestão do sistema com falha, reiniciar o controlador, atualizar as chaves de licença e devolver a peça com falha ao NetApp. 
---
= Substitua o módulo de gerenciamento do sistema no seu ASA A70 ou ASA A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua o módulo de gerenciamento do sistema no sistema ASA A70 ou ASA A90 quando ele ficar com defeito ou o firmware estiver corrompido. O processo de substituição envolve desligar o controlador, substituir o módulo de gestão do sistema com falha, reiniciar o controlador, atualizar as chaves de licença e devolver a peça com falha ao NetApp.
...
== Etapa 2: substituir o módulo de gerenciamento do sistema

Substitua o módulo de gestão do sistema afetado.


WARNING: O módulo de gerenciamento do sistema não é com substituição a quente. Antes de substituí-lo, reinstale as unidades de disco, desligue o nó, desconecte a alimentação do controlador e puxe o controlador alguns centímetros para fora do chassi.
