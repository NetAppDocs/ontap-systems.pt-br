...
summary: Desligue os controladores do seu sistema de storage ASA A70 ou ASA A90 quando precisar substituir o chassi. É fundamental desligar os controladores com segurança para evitar a perda de dados e garantir a estabilidade do sistema. 
---
= Desligue os controladores - ASA A70 e ASA A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Desligue os controladores do seu sistema de storage ASA A70 ou ASA A90 quando precisar substituir o chassi. É fundamental desligar os controladores com segurança para evitar a perda de dados e garantir a estabilidade do sistema.
