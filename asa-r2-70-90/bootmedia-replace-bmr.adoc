...
[role="lead"]
Substitua o suporte de arranque removendo o módulo de gestão do sistema da parte de trás do sistema, removendo o suporte de arranque danificado, instalando o suporte de arranque de substituição no módulo de gestão do sistema e, em seguida, reinstalando o módulo de gestão do sistema.
