...
Você pode adicionar um módulo de e/S ao seu sistema de armazenamento ASA A70 e ASA A90 quando houver slots vazios disponíveis ou quando todos os slots estiverem totalmente preenchidos. .Sobre esta tarefa
