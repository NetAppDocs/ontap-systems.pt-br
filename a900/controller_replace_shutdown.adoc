...
---
= Desligue o controlador defeituoso do seu sistema AFF A900 antes de substituí-lo
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Desligue o controlador com defeito no seu sistema de storage AFF A900 para evitar perda de dados e garantir a estabilidade do sistema ao substituir o controlador.
