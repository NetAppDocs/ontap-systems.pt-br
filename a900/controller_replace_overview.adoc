...
---
= Fluxo de trabalho de substituição do controlador AFF A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Comece a substituir o controlador do seu sistema AFF A900 revisando os pré-requisitos, desligando o controlador com defeito, transferindo o hardware para o controlador de substituição e restaurando a configuração do sistema.
