...
summary: Continue o procedimento de substituição refazendo a fiação das configurações de storage e rede. 
---
= Reconecte os cabos do sistema e reatribua os discos no seu AFF A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Recableie as configurações de armazenamento e rede e restaure NetApp Storage Encryption para que seu sistema AFF A900 volte a funcionar plenamente.
