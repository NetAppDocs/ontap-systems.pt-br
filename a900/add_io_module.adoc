...
---
= Adicione um módulo de E/S ao seu sistema AFF A900 para melhorar a conectividade de rede
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Você pode adicionar um módulo de e/S ao seu sistema de armazenamento AFF A900 quando houver slots vazios disponíveis ou quando todos os slots estiverem totalmente preenchidos.
