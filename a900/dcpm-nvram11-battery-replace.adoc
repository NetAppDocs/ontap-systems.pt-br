...
sidebar: sidebar 
keywords: AFF A900 
summary: Para substituir com o equipamento em funcionamento o módulo de alimentação do controlador de desestage, que contém a bateria NVRAM11, localize o módulo DCPM com defeito, remova-o do chassi e instale o módulo DCPM de substituição. 
---
= Substitua o módulo DCPM que contém a bateria NVRAM11 no seu sistema AFF A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua o módulo de alimentação do controlador de destage (DCPM) no seu AFF A900 quando ele apresentar defeito. O DCPM contém a bateria NVRAM11 e deve ser substituído em até cinco minutos após a remoção para evitar a perda da proteção de dados.
...
+
image::../media/drw_a900_remove_NV_battery.svg[Retire a bateria NV]
