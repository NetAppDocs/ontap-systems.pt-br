...
summary: Você substitui a bateria do relógio de tempo real no módulo controlador para que os serviços e aplicativos do seu sistema que dependem da sincronização precisa do tempo continuem funcionando. 
---
= Substitua a bateria do relógio em tempo real do seu AFF A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua a bateria do relógio de tempo real (RTC) do seu sistema AFF A900 para garantir que os serviços e aplicativos que dependem da sincronização precisa do tempo continuem funcionando.
...
+
image::../media/drw_a900_remove_PCM.svg[Solte o controlador]
...
image::../media/drw_a900_PCM_open.svg[Levante a tampa do módulo do controlador]
...
+
image::../media/drw_a900_remove_RTC_battery.svg[Retire e instale a bateria do RTC]
...
. Volte a colocar o controlador em funcionamento normal, devolvendo o respetivo armazenamento: `storage failover giveback -ofnode impaired_node_name`
