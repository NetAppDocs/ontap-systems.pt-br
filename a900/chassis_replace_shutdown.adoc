...
---
= Desligue seus controladores AFF A900 para substituir o chassi
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Desligue os controladores do seu sistema de storage AFF A900 para evitar perda de dados e garantir a estabilidade do sistema ao substituir o chassi.
