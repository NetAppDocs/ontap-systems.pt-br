...
---
= Substitua o controlador no seu sistema AFF A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua o controlador no seu sistema AFF A900 quando uma falha de hardware exigir. O processo de substituição envolve remover o módulo controlador com problema, transferir os componentes FRU para o controlador de substituição, instalar o módulo controlador de substituição no chassi e inicializar o sistema no modo de manutenção.
...
+
image::../media/drw_a900_remove_boot_dev.svg[Retire o suporte de arranque]
