...
---
= Verifique os requisitos para substituir a mídia de inicialização no seu sistema AFF A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
