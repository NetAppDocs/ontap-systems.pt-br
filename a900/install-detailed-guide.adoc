...
---
= Instale seu sistema AFF A900 usando instruções detalhadas passo a passo
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Instale seu AFF A900 sistema de storage seguindo estas instruções detalhadas passo a passo, desde a preparação do local até a inicialização do cluster ONTAP.
