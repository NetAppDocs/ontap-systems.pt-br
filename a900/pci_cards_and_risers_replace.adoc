...
---
= Substitua um módulo de E/S no seu sistema AFF A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua um módulo de E/S no seu sistema AFF A900 quando ele apresentar defeito ou precisar de atualização. O processo de substituição requer uma sequência específica de tarefas para evitar interrupção no serviço.
