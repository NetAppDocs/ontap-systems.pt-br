...
---
= Fluxo de trabalho de substituição do chassi AFF A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Comece substituindo o chassi do seu sistema AFF A900. O procedimento requer a remoção e reinstalação das fontes de alimentação, ventoinhas, módulos controladores, módulos de E/S, módulos DCPM e módulo LED USB. Todos os outros componentes do sistema devem estar funcionando corretamente.
