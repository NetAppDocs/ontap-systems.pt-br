...
summary: O módulo NVRAM consiste no NVRAM11 e nos DIMMs e em até dois módulos Flash Cache SSD NVMe por módulo NVRAM. 
---
= Substitua o módulo NVRAM ou os DIMMs NVRAM no seu sistema AFF A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua o módulo NVRAM ou os DIMMs NVRAM do seu sistema AFF A900 quando o módulo falhar ou um DIMM apresentar defeito. O processo de substituição envolve remover o módulo NVRAM do chassi, substituir o componente com defeito e reinstalar o módulo.
...
+
image::../media/drw_a900_move-remove_NVRAM_module.svg[Remova o módulo NVRAM]
...
+
image::../media/drw_a900_remove_NVRAM_module_contents.svg[Remova o conteúdo do módulo NVRAM]
