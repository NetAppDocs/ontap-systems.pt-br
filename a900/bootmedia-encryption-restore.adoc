...
---
= Restaure a criptografia na mídia de inicialização do seu sistema AFF A900 após o processo de recuperação manual de inicialização
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Restaure a criptografia na mídia de inicialização de substituição do seu AFF A900 para garantir a proteção contínua dos dados. O processo de substituição envolve verificar a disponibilidade da chave, reaplicar as configurações de criptografia e confirmar o acesso seguro aos seus dados.
