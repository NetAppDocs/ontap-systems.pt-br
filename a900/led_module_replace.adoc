...
---
= Substitua o módulo USB LED no seu sistema AFF A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua o módulo USB LED do seu sistema AFF A900 para restaurar a conectividade com as portas do console e o status do sistema. A substituição não requer ferramentas e não interrompe o serviço.
