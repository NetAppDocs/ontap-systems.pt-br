...
---
= Substitua a fonte de alimentação com substituição a quente no seu sistema AFF A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua a fonte de alimentação do seu AFF A900 quando ela falhar ou apresentar defeito. As fontes de alimentação são redundantes e com substituição a quente, então você não precisa desligar o controlador para realizar essa substituição.
...
+
Ao remover uma fonte de alimentação, utilize sempre duas mãos para suportar o seu peso.
