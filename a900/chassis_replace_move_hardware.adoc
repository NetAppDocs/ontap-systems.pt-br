...
summary: Todos os outros componentes do sistema devem estar funcionando corretamente. Caso contrário, entre em contato com o suporte técnico. 
---
= Substitua o chassi no seu sistema AFF A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua o chassi do seu AFF A900 quando uma falha de hardware exigir. O processo de substituição envolve remover as fontes de alimentação, ventoinhas, módulos controladores e módulos de E/S do chassi com problema e instalá-los no chassi de substituição.
...
+
image::../media/drw_a900_remove_install_PSU_module.svg[Remova ou instale um módulo da PSU]
...
+
image::../media/drw_a900_remove_install_fan.svg[Remova ou instale a ventoinha]
...
+
image::../media/drw_a900_remove_PCM.svg[Retire o controlador]
...
+
image:../media/drw_a900_remove_PCIe_module.svg["Remova um módulo PCIe"]
...
+
image::../media/drw_a900_remove_NV_battery.svg[Retire uma bateria NV]
...
image::../media/drw_a900_remove_replace_LED_mod.svg[Remova ou substitua um módulo LED USB]
