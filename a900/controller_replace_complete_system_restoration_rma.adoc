...
---
= Restauração completa do sistema - AFF A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Para concluir o procedimento de substituição e restaurar o sistema para o funcionamento completo, restaure a configuração de encriptação de armazenamento NetApp (se necessário) e instale licenças para o novo controlador.
