...
---
= Desligue o controlador do seu sistema AFF A900 durante o processo de recuperação de inicialização manual
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Desligue o controlador com defeito no seu sistema de storage AFF A900 para evitar perda de dados e manter a estabilidade do sistema durante o processo de recuperação de inicialização manual.
...
Se o seu sistema de armazenamento estiver executando o ONTAP 9.17.1 ou posterior, use o procedimento de recuperação de inicialização automatizada.  Se o seu sistema estiver executando uma versão anterior do ONTAP, você deverá usar o processo de recuperação de inicialização manual.
...
--
.O controlador está em um MetroCluster
--
Depois de concluir as tarefas NVE ou NSE, você precisa concluir o desligamento do controlador desativado.
