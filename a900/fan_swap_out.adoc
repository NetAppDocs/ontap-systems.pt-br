...
---
= Substitua o módulo de ventoinha com substituição a quente no seu sistema AFF A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua a quente um módulo de ventoinha no seu sistema AFF A900 para manter o resfriamento adequado. Os módulos de ventoinha devem ser substituídos sem interromper o serviço, realizando uma sequência específica de tarefas.
...
+
image::../media/drw_a900_remove_install_fan.svg[Remover ou instalar a ventoinha]
