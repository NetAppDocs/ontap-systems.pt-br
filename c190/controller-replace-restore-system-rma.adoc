...
summary: Para restaurar o funcionamento completo do seu sistema, você deve restaurar a configuração de NetApp Storage Encryption, instalar as licenças para o novo controlador e devolver a peça com defeito para a NetApp, conforme descrito nas instruções de RMA fornecidas com o kit. 
---
= Conclua a substituição do controlador do seu sistema AFF C190
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Conclua a substituição do controlador do seu sistema AFF C190 restaurando a configuração de criptografia de armazenamento NetApp (se necessário), instalando as licenças para o novo controlador e devolvendo a peça com falha para a NetApp.



[[step-1-installing-licenses-for-the-replacement-controller-in-ontap]]
== Passo 1: Instalando licenças para o controlador _replacement_ no ONTAP
