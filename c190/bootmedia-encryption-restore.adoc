...
summary: Restaurar a configuração de criptografia na mídia de inicialização de substituição para um sistema AFF C190 . O sistema AFF C190 suporta apenas procedimentos manuais de recuperação de mídia de inicialização. A recuperação automática de mídia de inicialização não é suportada. 
---
= Restaure a criptografia na mídia de inicialização do seu sistema AFF C190
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
