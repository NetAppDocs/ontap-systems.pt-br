...
---
= Substitua a bateria NVMEM no seu sistema AFF C190
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua a bateria NVMEM do seu sistema AFF C190 removendo o módulo controlador, abrindo-o, substituindo a bateria e reinstalando o módulo controlador.
