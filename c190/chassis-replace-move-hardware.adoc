...
---
= Substitua o chassi no seu sistema AFF C190
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Depois de instalar o módulo do controlador e quaisquer outros componentes no novo chassi, você precisa iniciá-lo.
