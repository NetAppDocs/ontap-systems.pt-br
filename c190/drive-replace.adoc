...
---
= Substitua uma unidade de disco no seu sistema AFF C190
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Substitua uma unidade com falha no seu sistema AFF C190 sem interromper as operações de E/S. O AFF C190 é compatível com unidades SSD e HDDs, cada uma com um procedimento de substituição específico.
