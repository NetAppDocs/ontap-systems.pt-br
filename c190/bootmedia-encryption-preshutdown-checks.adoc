...
summary: Verifique o suporte e o status da chave de criptografia antes de desligar o controlador com defeito em um sistema AFF C190 . O sistema AFF C190 suporta apenas procedimentos manuais de recuperação de mídia de inicialização. A recuperação automática de mídia de inicialização não é suportada. 
---
= Verifique o suporte à criptografia na sua mídia de inicialização AFF C190
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
